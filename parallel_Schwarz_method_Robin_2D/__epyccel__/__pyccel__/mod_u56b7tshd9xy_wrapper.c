...
#define MOD_U56B7TSHD9XY_WRAPPER

#include "mod_u56b7tshd9xy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u56b7tshd9xy_methods[] = {
    {
...
static struct PyModuleDef mod_u56b7tshd9xy_module = {
    ...
    0,
    mod_u56b7tshd9xy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u56b7tshd9xy(void)
{
    PyObject* mod;
    static void* Pymod_u56b7tshd9xy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u56b7tshd9xy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u56b7tshd9xy_API, "mod_u56b7tshd9xy._C_API", NULL);
