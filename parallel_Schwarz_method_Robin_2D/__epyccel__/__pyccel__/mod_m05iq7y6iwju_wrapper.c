...
#define MOD_M05IQ7Y6IWJU_WRAPPER

#include "mod_m05iq7y6iwju_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m05iq7y6iwju_methods[] = {
    {
...
static struct PyModuleDef mod_m05iq7y6iwju_module = {
    ...
    0,
    mod_m05iq7y6iwju_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m05iq7y6iwju(void)
{
    PyObject* mod;
    static void* Pymod_m05iq7y6iwju_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m05iq7y6iwju_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m05iq7y6iwju_API, "mod_m05iq7y6iwju._C_API", NULL);
