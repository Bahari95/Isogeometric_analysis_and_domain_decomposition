...
#define MOD_BMYFBTJZL1U4_WRAPPER

#include "mod_bmyfbtjzl1u4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bmyfbtjzl1u4_methods[] = {
    {
...
static struct PyModuleDef mod_bmyfbtjzl1u4_module = {
    ...
    0,
    mod_bmyfbtjzl1u4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bmyfbtjzl1u4(void)
{
    PyObject* mod;
    static void* Pymod_bmyfbtjzl1u4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bmyfbtjzl1u4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bmyfbtjzl1u4_API, "mod_bmyfbtjzl1u4._C_API", NULL);
