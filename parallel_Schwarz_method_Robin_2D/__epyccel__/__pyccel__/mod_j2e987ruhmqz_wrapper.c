...
#define MOD_J2E987RUHMQZ_WRAPPER

#include "mod_j2e987ruhmqz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_j2e987ruhmqz_methods[] = {
    {
...
static struct PyModuleDef mod_j2e987ruhmqz_module = {
    ...
    0,
    mod_j2e987ruhmqz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_j2e987ruhmqz(void)
{
    PyObject* mod;
    static void* Pymod_j2e987ruhmqz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_j2e987ruhmqz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_j2e987ruhmqz_API, "mod_j2e987ruhmqz._C_API", NULL);
