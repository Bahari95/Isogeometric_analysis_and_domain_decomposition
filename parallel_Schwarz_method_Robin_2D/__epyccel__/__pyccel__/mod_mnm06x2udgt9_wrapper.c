...
#define MOD_MNM06X2UDGT9_WRAPPER

#include "mod_mnm06x2udgt9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mnm06x2udgt9_methods[] = {
    {
...
static struct PyModuleDef mod_mnm06x2udgt9_module = {
    ...
    0,
    mod_mnm06x2udgt9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mnm06x2udgt9(void)
{
    PyObject* mod;
    static void* Pymod_mnm06x2udgt9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mnm06x2udgt9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mnm06x2udgt9_API, "mod_mnm06x2udgt9._C_API", NULL);
