...
#define MOD_17FN7VVKQIRZ_WRAPPER

#include "mod_17fn7vvkqirz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_17fn7vvkqirz_methods[] = {
    {
...
static struct PyModuleDef mod_17fn7vvkqirz_module = {
    ...
    0,
    mod_17fn7vvkqirz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_17fn7vvkqirz(void)
{
    PyObject* mod;
    static void* Pymod_17fn7vvkqirz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_17fn7vvkqirz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_17fn7vvkqirz_API, "mod_17fn7vvkqirz._C_API", NULL);
