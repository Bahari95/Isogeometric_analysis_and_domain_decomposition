...
#define MOD_QU2S3NIEHKXK_WRAPPER

#include "mod_qu2s3niehkxk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qu2s3niehkxk_methods[] = {
    {
...
static struct PyModuleDef mod_qu2s3niehkxk_module = {
    ...
    0,
    mod_qu2s3niehkxk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qu2s3niehkxk(void)
{
    PyObject* mod;
    static void* Pymod_qu2s3niehkxk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qu2s3niehkxk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qu2s3niehkxk_API, "mod_qu2s3niehkxk._C_API", NULL);
