...
#define MOD_0D57LK2CFA96_WRAPPER

#include "mod_0d57lk2cfa96_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0d57lk2cfa96_methods[] = {
    {
...
static struct PyModuleDef mod_0d57lk2cfa96_module = {
    ...
    0,
    mod_0d57lk2cfa96_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0d57lk2cfa96(void)
{
    PyObject* mod;
    static void* Pymod_0d57lk2cfa96_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0d57lk2cfa96_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0d57lk2cfa96_API, "mod_0d57lk2cfa96._C_API", NULL);
