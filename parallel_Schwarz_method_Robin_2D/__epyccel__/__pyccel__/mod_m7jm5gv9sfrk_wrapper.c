...
#define MOD_M7JM5GV9SFRK_WRAPPER

#include "mod_m7jm5gv9sfrk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m7jm5gv9sfrk_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_m7jm5gv9sfrk_module = {
    ...
    0,
    mod_m7jm5gv9sfrk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m7jm5gv9sfrk(void)
{
    PyObject* mod;
    static void* Pymod_m7jm5gv9sfrk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m7jm5gv9sfrk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m7jm5gv9sfrk_API, "mod_m7jm5gv9sfrk._C_API", NULL);
