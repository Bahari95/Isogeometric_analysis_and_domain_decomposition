...
#define MOD_APJCDMSWC0H0_WRAPPER

#include "mod_apjcdmswc0h0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
/*........................................*/
static PyObject* bind_c_assemble_vector_un_ex01_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    PyObject* ne1_obj;
    PyObject* ne2_obj;
    PyObject* ne3_obj;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO", kwlist, &ne1_obj, &ne2_obj, &ne3_obj, &ne4_obj, &p1_obj, &p2_obj, &p3_obj, &p4_obj, &spans_1_obj, &spans_2_obj, &spans_3_obj, &spans_4_obj, &basis_1_obj, &basis_2_obj, &basis_3_obj, &basis_4_obj, &weights_1_obj, &weights_2_obj, &weights_3_obj, &weights_4_obj, &points_1_obj, &points_2_obj, &points_3_obj, &points_4_obj, &domain_nb_obj, &S_DDM_obj, &ovlp_value_obj, &knots_1_obj, &knots_2_obj, &knots_3_obj, &knots_4_obj, &vector_m1_obj, &vector_m2_obj, &vector_d_obj, &rhs_obj))
    {
        return NULL;
    }
...
static PyMethodDef mod_apjcdmswc0h0_methods[] = {
    {
        "assemble_vector_un_ex01",
        (PyCFunction)bind_c_assemble_vector_un_ex01_wrapper,
...
static struct PyModuleDef mod_apjcdmswc0h0_module = {
    ...
    0,
    mod_apjcdmswc0h0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_apjcdmswc0h0(void)
{
    PyObject* mod;
    static void* Pymod_apjcdmswc0h0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_apjcdmswc0h0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_apjcdmswc0h0_API, "mod_apjcdmswc0h0._C_API", NULL);
