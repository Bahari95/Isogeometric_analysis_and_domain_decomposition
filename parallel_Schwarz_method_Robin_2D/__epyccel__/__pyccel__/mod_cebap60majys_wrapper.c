...
#define MOD_CEBAP60MAJYS_WRAPPER

#include "mod_cebap60majys_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cebap60majys_methods[] = {
    {
...
static struct PyModuleDef mod_cebap60majys_module = {
    ...
    0,
    mod_cebap60majys_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cebap60majys(void)
{
    PyObject* mod;
    static void* Pymod_cebap60majys_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cebap60majys_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cebap60majys_API, "mod_cebap60majys._C_API", NULL);
