...
#define MOD_I3YXCKXTDAL3_WRAPPER

#include "mod_i3yxckxtdal3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i3yxckxtdal3_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i3yxckxtdal3_module = {
    ...
    0,
    mod_i3yxckxtdal3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i3yxckxtdal3(void)
{
    PyObject* mod;
    static void* Pymod_i3yxckxtdal3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i3yxckxtdal3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i3yxckxtdal3_API, "mod_i3yxckxtdal3._C_API", NULL);
