...
#define MOD_LLUALMHJ0H2S_WRAPPER

#include "mod_llualmhj0h2s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_llualmhj0h2s_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_llualmhj0h2s_module = {
    ...
    0,
    mod_llualmhj0h2s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_llualmhj0h2s(void)
{
    PyObject* mod;
    static void* Pymod_llualmhj0h2s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_llualmhj0h2s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_llualmhj0h2s_API, "mod_llualmhj0h2s._C_API", NULL);
