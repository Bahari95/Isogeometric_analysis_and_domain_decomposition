...
#define MOD_TVGLCH0OE1KM_WRAPPER

#include "mod_tvglch0oe1km_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tvglch0oe1km_methods[] = {
    {
...
static struct PyModuleDef mod_tvglch0oe1km_module = {
    ...
    0,
    mod_tvglch0oe1km_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tvglch0oe1km(void)
{
    PyObject* mod;
    static void* Pymod_tvglch0oe1km_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tvglch0oe1km_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tvglch0oe1km_API, "mod_tvglch0oe1km._C_API", NULL);
