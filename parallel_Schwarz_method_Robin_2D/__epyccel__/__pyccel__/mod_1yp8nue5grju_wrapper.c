...
#define MOD_1YP8NUE5GRJU_WRAPPER

#include "mod_1yp8nue5grju_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1yp8nue5grju_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1yp8nue5grju_module = {
    ...
    0,
    mod_1yp8nue5grju_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1yp8nue5grju(void)
{
    PyObject* mod;
    static void* Pymod_1yp8nue5grju_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1yp8nue5grju_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1yp8nue5grju_API, "mod_1yp8nue5grju._C_API", NULL);
