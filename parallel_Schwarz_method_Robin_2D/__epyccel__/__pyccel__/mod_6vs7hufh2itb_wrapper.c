...
#define MOD_6VS7HUFH2ITB_WRAPPER

#include "mod_6vs7hufh2itb_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6vs7hufh2itb_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_6vs7hufh2itb_module = {
    ...
    0,
    mod_6vs7hufh2itb_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6vs7hufh2itb(void)
{
    PyObject* mod;
    static void* Pymod_6vs7hufh2itb_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6vs7hufh2itb_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6vs7hufh2itb_API, "mod_6vs7hufh2itb._C_API", NULL);
