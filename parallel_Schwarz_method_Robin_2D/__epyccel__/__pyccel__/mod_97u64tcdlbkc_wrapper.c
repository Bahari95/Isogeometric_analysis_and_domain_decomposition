...
#define MOD_97U64TCDLBKC_WRAPPER

#include "mod_97u64tcdlbkc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_97u64tcdlbkc_methods[] = {
    {
...
static struct PyModuleDef mod_97u64tcdlbkc_module = {
    ...
    0,
    mod_97u64tcdlbkc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_97u64tcdlbkc(void)
{
    PyObject* mod;
    static void* Pymod_97u64tcdlbkc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_97u64tcdlbkc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_97u64tcdlbkc_API, "mod_97u64tcdlbkc._C_API", NULL);
