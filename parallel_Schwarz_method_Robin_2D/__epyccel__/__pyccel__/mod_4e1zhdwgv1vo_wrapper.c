...
#define MOD_4E1ZHDWGV1VO_WRAPPER

#include "mod_4e1zhdwgv1vo_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4e1zhdwgv1vo_methods[] = {
    {
...
static struct PyModuleDef mod_4e1zhdwgv1vo_module = {
    ...
    0,
    mod_4e1zhdwgv1vo_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4e1zhdwgv1vo(void)
{
    PyObject* mod;
    static void* Pymod_4e1zhdwgv1vo_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4e1zhdwgv1vo_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4e1zhdwgv1vo_API, "mod_4e1zhdwgv1vo._C_API", NULL);
