...
#define MOD_1H0Y39KC7BNR_WRAPPER

#include "mod_1h0y39kc7bnr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1h0y39kc7bnr_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1h0y39kc7bnr_module = {
    ...
    0,
    mod_1h0y39kc7bnr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1h0y39kc7bnr(void)
{
    PyObject* mod;
    static void* Pymod_1h0y39kc7bnr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1h0y39kc7bnr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1h0y39kc7bnr_API, "mod_1h0y39kc7bnr._C_API", NULL);
