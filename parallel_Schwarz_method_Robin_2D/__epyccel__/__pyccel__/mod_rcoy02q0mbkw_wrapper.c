...
#define MOD_RCOY02Q0MBKW_WRAPPER

#include "mod_rcoy02q0mbkw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rcoy02q0mbkw_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_rcoy02q0mbkw_module = {
    ...
    0,
    mod_rcoy02q0mbkw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rcoy02q0mbkw(void)
{
    PyObject* mod;
    static void* Pymod_rcoy02q0mbkw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rcoy02q0mbkw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rcoy02q0mbkw_API, "mod_rcoy02q0mbkw._C_API", NULL);
