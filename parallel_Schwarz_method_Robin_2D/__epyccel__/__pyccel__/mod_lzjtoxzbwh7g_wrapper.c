...
#define MOD_LZJTOXZBWH7G_WRAPPER

#include "mod_lzjtoxzbwh7g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lzjtoxzbwh7g_methods[] = {
    {
...
static struct PyModuleDef mod_lzjtoxzbwh7g_module = {
    ...
    0,
    mod_lzjtoxzbwh7g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lzjtoxzbwh7g(void)
{
    PyObject* mod;
    static void* Pymod_lzjtoxzbwh7g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lzjtoxzbwh7g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lzjtoxzbwh7g_API, "mod_lzjtoxzbwh7g._C_API", NULL);
