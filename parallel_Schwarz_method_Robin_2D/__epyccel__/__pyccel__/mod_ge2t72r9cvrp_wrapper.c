...
#define MOD_GE2T72R9CVRP_WRAPPER

#include "mod_ge2t72r9cvrp_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ge2t72r9cvrp_methods[] = {
    {
...
static struct PyModuleDef mod_ge2t72r9cvrp_module = {
    ...
    0,
    mod_ge2t72r9cvrp_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ge2t72r9cvrp(void)
{
    PyObject* mod;
    static void* Pymod_ge2t72r9cvrp_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ge2t72r9cvrp_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ge2t72r9cvrp_API, "mod_ge2t72r9cvrp._C_API", NULL);
