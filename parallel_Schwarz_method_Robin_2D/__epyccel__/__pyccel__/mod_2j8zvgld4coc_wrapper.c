...
#define MOD_2J8ZVGLD4COC_WRAPPER

#include "mod_2j8zvgld4coc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_2j8zvgld4coc_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_2j8zvgld4coc_module = {
    ...
    0,
    mod_2j8zvgld4coc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_2j8zvgld4coc(void)
{
    PyObject* mod;
    static void* Pymod_2j8zvgld4coc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_2j8zvgld4coc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_2j8zvgld4coc_API, "mod_2j8zvgld4coc._C_API", NULL);
