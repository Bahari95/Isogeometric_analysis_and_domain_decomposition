...
#define MOD_LWLHYAYQONRK_WRAPPER

#include "mod_lwlhyayqonrk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lwlhyayqonrk_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lwlhyayqonrk_module = {
    ...
    0,
    mod_lwlhyayqonrk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lwlhyayqonrk(void)
{
    PyObject* mod;
    static void* Pymod_lwlhyayqonrk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lwlhyayqonrk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lwlhyayqonrk_API, "mod_lwlhyayqonrk._C_API", NULL);
