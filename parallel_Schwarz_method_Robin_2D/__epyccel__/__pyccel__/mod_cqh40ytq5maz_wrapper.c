...
#define MOD_CQH40YTQ5MAZ_WRAPPER

#include "mod_cqh40ytq5maz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cqh40ytq5maz_methods[] = {
    {
...
static struct PyModuleDef mod_cqh40ytq5maz_module = {
    ...
    0,
    mod_cqh40ytq5maz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cqh40ytq5maz(void)
{
    PyObject* mod;
    static void* Pymod_cqh40ytq5maz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cqh40ytq5maz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cqh40ytq5maz_API, "mod_cqh40ytq5maz._C_API", NULL);
