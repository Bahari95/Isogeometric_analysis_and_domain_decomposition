...
#define MOD_5CDRUWUR6KES_WRAPPER

#include "mod_5cdruwur6kes_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5cdruwur6kes_methods[] = {
    {
...
static struct PyModuleDef mod_5cdruwur6kes_module = {
    ...
    0,
    mod_5cdruwur6kes_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5cdruwur6kes(void)
{
    PyObject* mod;
    static void* Pymod_5cdruwur6kes_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5cdruwur6kes_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5cdruwur6kes_API, "mod_5cdruwur6kes._C_API", NULL);
