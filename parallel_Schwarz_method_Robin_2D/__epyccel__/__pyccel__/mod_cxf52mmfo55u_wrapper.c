...
#define MOD_CXF52MMFO55U_WRAPPER

#include "mod_cxf52mmfo55u_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cxf52mmfo55u_methods[] = {
    {
...
static struct PyModuleDef mod_cxf52mmfo55u_module = {
    ...
    0,
    mod_cxf52mmfo55u_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cxf52mmfo55u(void)
{
    PyObject* mod;
    static void* Pymod_cxf52mmfo55u_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cxf52mmfo55u_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cxf52mmfo55u_API, "mod_cxf52mmfo55u._C_API", NULL);
