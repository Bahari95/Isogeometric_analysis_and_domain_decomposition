...
#define MOD_W5WF4Y0Y1ZQZ_WRAPPER

#include "mod_w5wf4y0y1zqz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_w5wf4y0y1zqz_methods[] = {
    {
...
static struct PyModuleDef mod_w5wf4y0y1zqz_module = {
    ...
    0,
    mod_w5wf4y0y1zqz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_w5wf4y0y1zqz(void)
{
    PyObject* mod;
    static void* Pymod_w5wf4y0y1zqz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_w5wf4y0y1zqz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_w5wf4y0y1zqz_API, "mod_w5wf4y0y1zqz._C_API", NULL);
