...
#define MOD_ZGK7T5IHVPAE_WRAPPER

#include "mod_zgk7t5ihvpae_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zgk7t5ihvpae_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_zgk7t5ihvpae_module = {
    ...
    0,
    mod_zgk7t5ihvpae_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zgk7t5ihvpae(void)
{
    PyObject* mod;
    static void* Pymod_zgk7t5ihvpae_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zgk7t5ihvpae_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zgk7t5ihvpae_API, "mod_zgk7t5ihvpae._C_API", NULL);
