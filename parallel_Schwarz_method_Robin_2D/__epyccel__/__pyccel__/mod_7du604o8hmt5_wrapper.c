...
#define MOD_7DU604O8HMT5_WRAPPER

#include "mod_7du604o8hmt5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7du604o8hmt5_methods[] = {
    {
...
static struct PyModuleDef mod_7du604o8hmt5_module = {
    ...
    0,
    mod_7du604o8hmt5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7du604o8hmt5(void)
{
    PyObject* mod;
    static void* Pymod_7du604o8hmt5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7du604o8hmt5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7du604o8hmt5_API, "mod_7du604o8hmt5._C_API", NULL);
