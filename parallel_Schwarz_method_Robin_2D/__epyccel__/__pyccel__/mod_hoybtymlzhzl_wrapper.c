...
#define MOD_HOYBTYMLZHZL_WRAPPER

#include "mod_hoybtymlzhzl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hoybtymlzhzl_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hoybtymlzhzl_module = {
    ...
    0,
    mod_hoybtymlzhzl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hoybtymlzhzl(void)
{
    PyObject* mod;
    static void* Pymod_hoybtymlzhzl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hoybtymlzhzl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hoybtymlzhzl_API, "mod_hoybtymlzhzl._C_API", NULL);
