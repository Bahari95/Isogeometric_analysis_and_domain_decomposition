...
#define MOD_EA8DCEXW6ZTB_WRAPPER

#include "mod_ea8dcexw6ztb_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ea8dcexw6ztb_methods[] = {
    {
...
static struct PyModuleDef mod_ea8dcexw6ztb_module = {
    ...
    0,
    mod_ea8dcexw6ztb_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ea8dcexw6ztb(void)
{
    PyObject* mod;
    static void* Pymod_ea8dcexw6ztb_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ea8dcexw6ztb_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ea8dcexw6ztb_API, "mod_ea8dcexw6ztb._C_API", NULL);
