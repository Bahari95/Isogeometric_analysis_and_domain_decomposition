...
#define MOD_9Y69SR95PNUC_WRAPPER

#include "mod_9y69sr95pnuc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9y69sr95pnuc_methods[] = {
    {
...
static struct PyModuleDef mod_9y69sr95pnuc_module = {
    ...
    0,
    mod_9y69sr95pnuc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9y69sr95pnuc(void)
{
    PyObject* mod;
    static void* Pymod_9y69sr95pnuc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9y69sr95pnuc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9y69sr95pnuc_API, "mod_9y69sr95pnuc._C_API", NULL);
