...
#define MOD_R1920HNV8RYI_WRAPPER

#include "mod_r1920hnv8ryi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_r1920hnv8ryi_methods[] = {
    {
...
static struct PyModuleDef mod_r1920hnv8ryi_module = {
    ...
    0,
    mod_r1920hnv8ryi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_r1920hnv8ryi(void)
{
    PyObject* mod;
    static void* Pymod_r1920hnv8ryi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_r1920hnv8ryi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_r1920hnv8ryi_API, "mod_r1920hnv8ryi._C_API", NULL);
