...
#define MOD_QEHWXA9DD90Y_WRAPPER

#include "mod_qehwxa9dd90y_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qehwxa9dd90y_methods[] = {
    {
...
static struct PyModuleDef mod_qehwxa9dd90y_module = {
    ...
    0,
    mod_qehwxa9dd90y_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qehwxa9dd90y(void)
{
    PyObject* mod;
    static void* Pymod_qehwxa9dd90y_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qehwxa9dd90y_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qehwxa9dd90y_API, "mod_qehwxa9dd90y._C_API", NULL);
