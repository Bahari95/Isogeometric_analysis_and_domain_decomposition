...
#define MOD_SAKSIMLVPNX4_WRAPPER

#include "mod_saksimlvpnx4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_saksimlvpnx4_methods[] = {
    {
...
static struct PyModuleDef mod_saksimlvpnx4_module = {
    ...
    0,
    mod_saksimlvpnx4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_saksimlvpnx4(void)
{
    PyObject* mod;
    static void* Pymod_saksimlvpnx4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_saksimlvpnx4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_saksimlvpnx4_API, "mod_saksimlvpnx4._C_API", NULL);
