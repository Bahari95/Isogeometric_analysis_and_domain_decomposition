...
#define MOD_GBTGSI7ICSDN_WRAPPER

#include "mod_gbtgsi7icsdn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gbtgsi7icsdn_methods[] = {
    {
...
static struct PyModuleDef mod_gbtgsi7icsdn_module = {
    ...
    0,
    mod_gbtgsi7icsdn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gbtgsi7icsdn(void)
{
    PyObject* mod;
    static void* Pymod_gbtgsi7icsdn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gbtgsi7icsdn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gbtgsi7icsdn_API, "mod_gbtgsi7icsdn._C_API", NULL);
