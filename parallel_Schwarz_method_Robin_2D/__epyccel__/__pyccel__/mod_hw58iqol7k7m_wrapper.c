...
#define MOD_HW58IQOL7K7M_WRAPPER

#include "mod_hw58iqol7k7m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hw58iqol7k7m_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hw58iqol7k7m_module = {
    ...
    0,
    mod_hw58iqol7k7m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hw58iqol7k7m(void)
{
    PyObject* mod;
    static void* Pymod_hw58iqol7k7m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hw58iqol7k7m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hw58iqol7k7m_API, "mod_hw58iqol7k7m._C_API", NULL);
