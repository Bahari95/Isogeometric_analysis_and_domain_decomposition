...
#define MOD_EZ0UV6KQYYYK_WRAPPER

#include "mod_ez0uv6kqyyyk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ez0uv6kqyyyk_methods[] = {
    {
...
static struct PyModuleDef mod_ez0uv6kqyyyk_module = {
    ...
    0,
    mod_ez0uv6kqyyyk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ez0uv6kqyyyk(void)
{
    PyObject* mod;
    static void* Pymod_ez0uv6kqyyyk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ez0uv6kqyyyk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ez0uv6kqyyyk_API, "mod_ez0uv6kqyyyk._C_API", NULL);
