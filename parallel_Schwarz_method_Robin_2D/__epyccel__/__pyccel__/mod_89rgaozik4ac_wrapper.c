...
#define MOD_89RGAOZIK4AC_WRAPPER

#include "mod_89rgaozik4ac_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_89rgaozik4ac_methods[] = {
    {
...
static struct PyModuleDef mod_89rgaozik4ac_module = {
    ...
    0,
    mod_89rgaozik4ac_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_89rgaozik4ac(void)
{
    PyObject* mod;
    static void* Pymod_89rgaozik4ac_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_89rgaozik4ac_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_89rgaozik4ac_API, "mod_89rgaozik4ac._C_API", NULL);
