...
#define MOD_LOBXPJASXSGD_WRAPPER

#include "mod_lobxpjasxsgd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lobxpjasxsgd_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lobxpjasxsgd_module = {
    ...
    0,
    mod_lobxpjasxsgd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lobxpjasxsgd(void)
{
    PyObject* mod;
    static void* Pymod_lobxpjasxsgd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lobxpjasxsgd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lobxpjasxsgd_API, "mod_lobxpjasxsgd._C_API", NULL);
