...
#define MOD_ADL8IA85REG9_WRAPPER

#include "mod_adl8ia85reg9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_adl8ia85reg9_methods[] = {
    {
...
static struct PyModuleDef mod_adl8ia85reg9_module = {
    ...
    0,
    mod_adl8ia85reg9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_adl8ia85reg9(void)
{
    PyObject* mod;
    static void* Pymod_adl8ia85reg9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_adl8ia85reg9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_adl8ia85reg9_API, "mod_adl8ia85reg9._C_API", NULL);
