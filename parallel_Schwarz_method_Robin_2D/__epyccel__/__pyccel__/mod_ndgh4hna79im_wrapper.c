...
#define MOD_NDGH4HNA79IM_WRAPPER

#include "mod_ndgh4hna79im_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ndgh4hna79im_methods[] = {
    {
...
static struct PyModuleDef mod_ndgh4hna79im_module = {
    ...
    0,
    mod_ndgh4hna79im_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ndgh4hna79im(void)
{
    PyObject* mod;
    static void* Pymod_ndgh4hna79im_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ndgh4hna79im_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ndgh4hna79im_API, "mod_ndgh4hna79im._C_API", NULL);
