...
#define MOD_D74ERSU4047Y_WRAPPER

#include "mod_d74ersu4047y_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d74ersu4047y_methods[] = {
    {
...
static struct PyModuleDef mod_d74ersu4047y_module = {
    ...
    0,
    mod_d74ersu4047y_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d74ersu4047y(void)
{
    PyObject* mod;
    static void* Pymod_d74ersu4047y_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d74ersu4047y_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d74ersu4047y_API, "mod_d74ersu4047y._C_API", NULL);
