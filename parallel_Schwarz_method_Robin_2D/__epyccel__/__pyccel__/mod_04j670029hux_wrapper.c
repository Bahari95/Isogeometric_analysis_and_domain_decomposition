...
#define MOD_04J670029HUX_WRAPPER

#include "mod_04j670029hux_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_04j670029hux_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_04j670029hux_module = {
    ...
    0,
    mod_04j670029hux_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_04j670029hux(void)
{
    PyObject* mod;
    static void* Pymod_04j670029hux_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_04j670029hux_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_04j670029hux_API, "mod_04j670029hux._C_API", NULL);
