...
#define MOD_UVTX4WNYBIBN_WRAPPER

#include "mod_uvtx4wnybibn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_uvtx4wnybibn_methods[] = {
    {
...
static struct PyModuleDef mod_uvtx4wnybibn_module = {
    ...
    0,
    mod_uvtx4wnybibn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uvtx4wnybibn(void)
{
    PyObject* mod;
    static void* Pymod_uvtx4wnybibn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_uvtx4wnybibn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_uvtx4wnybibn_API, "mod_uvtx4wnybibn._C_API", NULL);
