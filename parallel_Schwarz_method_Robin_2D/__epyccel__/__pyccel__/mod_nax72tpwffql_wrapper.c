...
#define MOD_NAX72TPWFFQL_WRAPPER

#include "mod_nax72tpwffql_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nax72tpwffql_methods[] = {
    {
...
static struct PyModuleDef mod_nax72tpwffql_module = {
    ...
    0,
    mod_nax72tpwffql_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nax72tpwffql(void)
{
    PyObject* mod;
    static void* Pymod_nax72tpwffql_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nax72tpwffql_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nax72tpwffql_API, "mod_nax72tpwffql._C_API", NULL);
