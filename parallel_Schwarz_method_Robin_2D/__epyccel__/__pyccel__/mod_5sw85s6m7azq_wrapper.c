...
#define MOD_5SW85S6M7AZQ_WRAPPER

#include "mod_5sw85s6m7azq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5sw85s6m7azq_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_5sw85s6m7azq_module = {
    ...
    0,
    mod_5sw85s6m7azq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5sw85s6m7azq(void)
{
    PyObject* mod;
    static void* Pymod_5sw85s6m7azq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5sw85s6m7azq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5sw85s6m7azq_API, "mod_5sw85s6m7azq._C_API", NULL);
