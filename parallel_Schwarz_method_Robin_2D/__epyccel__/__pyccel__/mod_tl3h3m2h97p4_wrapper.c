...
#define MOD_TL3H3M2H97P4_WRAPPER

#include "mod_tl3h3m2h97p4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tl3h3m2h97p4_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_tl3h3m2h97p4_module = {
    ...
    0,
    mod_tl3h3m2h97p4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tl3h3m2h97p4(void)
{
    PyObject* mod;
    static void* Pymod_tl3h3m2h97p4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tl3h3m2h97p4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tl3h3m2h97p4_API, "mod_tl3h3m2h97p4._C_API", NULL);
