...
#define MOD_JC6E50R3OLTZ_WRAPPER

#include "mod_jc6e50r3oltz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jc6e50r3oltz_methods[] = {
    {
...
static struct PyModuleDef mod_jc6e50r3oltz_module = {
    ...
    0,
    mod_jc6e50r3oltz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jc6e50r3oltz(void)
{
    PyObject* mod;
    static void* Pymod_jc6e50r3oltz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jc6e50r3oltz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jc6e50r3oltz_API, "mod_jc6e50r3oltz._C_API", NULL);
