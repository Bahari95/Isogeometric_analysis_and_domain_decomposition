...
#define MOD_9WX58KUJWA6T_WRAPPER

#include "mod_9wx58kujwa6t_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9wx58kujwa6t_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9wx58kujwa6t_module = {
    ...
    0,
    mod_9wx58kujwa6t_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9wx58kujwa6t(void)
{
    PyObject* mod;
    static void* Pymod_9wx58kujwa6t_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9wx58kujwa6t_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9wx58kujwa6t_API, "mod_9wx58kujwa6t._C_API", NULL);
