...
#define MOD_IYUCKB8K3MRT_WRAPPER

#include "mod_iyuckb8k3mrt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iyuckb8k3mrt_methods[] = {
    {
...
static struct PyModuleDef mod_iyuckb8k3mrt_module = {
    ...
    0,
    mod_iyuckb8k3mrt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iyuckb8k3mrt(void)
{
    PyObject* mod;
    static void* Pymod_iyuckb8k3mrt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iyuckb8k3mrt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iyuckb8k3mrt_API, "mod_iyuckb8k3mrt._C_API", NULL);
