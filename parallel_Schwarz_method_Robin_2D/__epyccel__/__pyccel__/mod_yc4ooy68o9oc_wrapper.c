...
#define MOD_YC4OOY68O9OC_WRAPPER

#include "mod_yc4ooy68o9oc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yc4ooy68o9oc_methods[] = {
    {
...
static struct PyModuleDef mod_yc4ooy68o9oc_module = {
    ...
    0,
    mod_yc4ooy68o9oc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yc4ooy68o9oc(void)
{
    PyObject* mod;
    static void* Pymod_yc4ooy68o9oc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yc4ooy68o9oc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yc4ooy68o9oc_API, "mod_yc4ooy68o9oc._C_API", NULL);
