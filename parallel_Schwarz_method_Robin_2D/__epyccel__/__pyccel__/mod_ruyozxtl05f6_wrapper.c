...
#define MOD_RUYOZXTL05F6_WRAPPER

#include "mod_ruyozxtl05f6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ruyozxtl05f6_methods[] = {
    {
...
static struct PyModuleDef mod_ruyozxtl05f6_module = {
    ...
    0,
    mod_ruyozxtl05f6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ruyozxtl05f6(void)
{
    PyObject* mod;
    static void* Pymod_ruyozxtl05f6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ruyozxtl05f6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ruyozxtl05f6_API, "mod_ruyozxtl05f6._C_API", NULL);
