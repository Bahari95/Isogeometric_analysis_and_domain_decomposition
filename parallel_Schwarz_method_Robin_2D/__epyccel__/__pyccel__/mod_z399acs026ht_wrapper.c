...
#define MOD_Z399ACS026HT_WRAPPER

#include "mod_z399acs026ht_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_z399acs026ht_methods[] = {
    {
...
static struct PyModuleDef mod_z399acs026ht_module = {
    ...
    0,
    mod_z399acs026ht_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_z399acs026ht(void)
{
    PyObject* mod;
    static void* Pymod_z399acs026ht_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_z399acs026ht_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_z399acs026ht_API, "mod_z399acs026ht._C_API", NULL);
