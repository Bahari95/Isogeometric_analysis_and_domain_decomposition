...
#define MOD_KW6ZYD5FQZ8U_WRAPPER

#include "mod_kw6zyd5fqz8u_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kw6zyd5fqz8u_methods[] = {
    {
...
static struct PyModuleDef mod_kw6zyd5fqz8u_module = {
    ...
    0,
    mod_kw6zyd5fqz8u_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kw6zyd5fqz8u(void)
{
    PyObject* mod;
    static void* Pymod_kw6zyd5fqz8u_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kw6zyd5fqz8u_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kw6zyd5fqz8u_API, "mod_kw6zyd5fqz8u._C_API", NULL);
