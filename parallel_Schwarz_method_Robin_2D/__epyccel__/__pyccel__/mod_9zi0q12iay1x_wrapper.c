...
#define MOD_9ZI0Q12IAY1X_WRAPPER

#include "mod_9zi0q12iay1x_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9zi0q12iay1x_methods[] = {
    {
...
static struct PyModuleDef mod_9zi0q12iay1x_module = {
    ...
    0,
    mod_9zi0q12iay1x_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9zi0q12iay1x(void)
{
    PyObject* mod;
    static void* Pymod_9zi0q12iay1x_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9zi0q12iay1x_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9zi0q12iay1x_API, "mod_9zi0q12iay1x._C_API", NULL);
