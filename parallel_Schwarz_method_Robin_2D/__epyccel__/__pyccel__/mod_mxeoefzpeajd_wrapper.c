...
#define MOD_MXEOEFZPEAJD_WRAPPER

#include "mod_mxeoefzpeajd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mxeoefzpeajd_methods[] = {
    {
...
static struct PyModuleDef mod_mxeoefzpeajd_module = {
    ...
    0,
    mod_mxeoefzpeajd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mxeoefzpeajd(void)
{
    PyObject* mod;
    static void* Pymod_mxeoefzpeajd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mxeoefzpeajd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mxeoefzpeajd_API, "mod_mxeoefzpeajd._C_API", NULL);
