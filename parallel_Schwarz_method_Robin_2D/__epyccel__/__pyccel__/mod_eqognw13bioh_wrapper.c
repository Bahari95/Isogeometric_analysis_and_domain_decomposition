...
#define MOD_EQOGNW13BIOH_WRAPPER

#include "mod_eqognw13bioh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eqognw13bioh_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_eqognw13bioh_module = {
    ...
    0,
    mod_eqognw13bioh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eqognw13bioh(void)
{
    PyObject* mod;
    static void* Pymod_eqognw13bioh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eqognw13bioh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eqognw13bioh_API, "mod_eqognw13bioh._C_API", NULL);
