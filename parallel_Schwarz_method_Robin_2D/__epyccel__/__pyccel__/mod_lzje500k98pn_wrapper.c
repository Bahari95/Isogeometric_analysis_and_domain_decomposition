...
#define MOD_LZJE500K98PN_WRAPPER

#include "mod_lzje500k98pn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lzje500k98pn_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lzje500k98pn_module = {
    ...
    0,
    mod_lzje500k98pn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lzje500k98pn(void)
{
    PyObject* mod;
    static void* Pymod_lzje500k98pn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lzje500k98pn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lzje500k98pn_API, "mod_lzje500k98pn._C_API", NULL);
