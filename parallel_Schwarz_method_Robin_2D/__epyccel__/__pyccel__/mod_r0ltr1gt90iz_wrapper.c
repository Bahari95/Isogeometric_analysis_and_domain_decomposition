...
#define MOD_R0LTR1GT90IZ_WRAPPER

#include "mod_r0ltr1gt90iz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_r0ltr1gt90iz_methods[] = {
    {
...
static struct PyModuleDef mod_r0ltr1gt90iz_module = {
    ...
    0,
    mod_r0ltr1gt90iz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_r0ltr1gt90iz(void)
{
    PyObject* mod;
    static void* Pymod_r0ltr1gt90iz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_r0ltr1gt90iz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_r0ltr1gt90iz_API, "mod_r0ltr1gt90iz._C_API", NULL);
