...
#define MOD_DNQBR2T5P4V2_WRAPPER

#include "mod_dnqbr2t5p4v2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dnqbr2t5p4v2_methods[] = {
    {
...
static struct PyModuleDef mod_dnqbr2t5p4v2_module = {
    ...
    0,
    mod_dnqbr2t5p4v2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dnqbr2t5p4v2(void)
{
    PyObject* mod;
    static void* Pymod_dnqbr2t5p4v2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dnqbr2t5p4v2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dnqbr2t5p4v2_API, "mod_dnqbr2t5p4v2._C_API", NULL);
