...
#define MOD_8SZQDS5M6RQI_WRAPPER

#include "mod_8szqds5m6rqi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8szqds5m6rqi_methods[] = {
    {
...
static struct PyModuleDef mod_8szqds5m6rqi_module = {
    ...
    0,
    mod_8szqds5m6rqi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8szqds5m6rqi(void)
{
    PyObject* mod;
    static void* Pymod_8szqds5m6rqi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8szqds5m6rqi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8szqds5m6rqi_API, "mod_8szqds5m6rqi._C_API", NULL);
