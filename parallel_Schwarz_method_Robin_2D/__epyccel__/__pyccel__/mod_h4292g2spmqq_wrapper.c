...
#define MOD_H4292G2SPMQQ_WRAPPER

#include "mod_h4292g2spmqq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_h4292g2spmqq_methods[] = {
    {
...
static struct PyModuleDef mod_h4292g2spmqq_module = {
    ...
    0,
    mod_h4292g2spmqq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_h4292g2spmqq(void)
{
    PyObject* mod;
    static void* Pymod_h4292g2spmqq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_h4292g2spmqq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_h4292g2spmqq_API, "mod_h4292g2spmqq._C_API", NULL);
