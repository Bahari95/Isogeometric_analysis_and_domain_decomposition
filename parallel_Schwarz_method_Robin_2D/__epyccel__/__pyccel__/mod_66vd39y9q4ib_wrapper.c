...
#define MOD_66VD39Y9Q4IB_WRAPPER

#include "mod_66vd39y9q4ib_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_66vd39y9q4ib_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_66vd39y9q4ib_module = {
    ...
    0,
    mod_66vd39y9q4ib_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_66vd39y9q4ib(void)
{
    PyObject* mod;
    static void* Pymod_66vd39y9q4ib_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_66vd39y9q4ib_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_66vd39y9q4ib_API, "mod_66vd39y9q4ib._C_API", NULL);
