...
#define MOD_IP8FT9Y3GSNF_WRAPPER

#include "mod_ip8ft9y3gsnf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ip8ft9y3gsnf_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ip8ft9y3gsnf_module = {
    ...
    0,
    mod_ip8ft9y3gsnf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ip8ft9y3gsnf(void)
{
    PyObject* mod;
    static void* Pymod_ip8ft9y3gsnf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ip8ft9y3gsnf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ip8ft9y3gsnf_API, "mod_ip8ft9y3gsnf._C_API", NULL);
