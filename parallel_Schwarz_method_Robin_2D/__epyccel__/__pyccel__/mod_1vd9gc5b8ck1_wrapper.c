...
#define MOD_1VD9GC5B8CK1_WRAPPER

#include "mod_1vd9gc5b8ck1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1vd9gc5b8ck1_methods[] = {
    {
...
static struct PyModuleDef mod_1vd9gc5b8ck1_module = {
    ...
    0,
    mod_1vd9gc5b8ck1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1vd9gc5b8ck1(void)
{
    PyObject* mod;
    static void* Pymod_1vd9gc5b8ck1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1vd9gc5b8ck1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1vd9gc5b8ck1_API, "mod_1vd9gc5b8ck1._C_API", NULL);
