...
#define MOD_NJ2C57O22SUG_WRAPPER

#include "mod_nj2c57o22sug_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nj2c57o22sug_methods[] = {
    {
...
static struct PyModuleDef mod_nj2c57o22sug_module = {
    ...
    0,
    mod_nj2c57o22sug_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nj2c57o22sug(void)
{
    PyObject* mod;
    static void* Pymod_nj2c57o22sug_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nj2c57o22sug_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nj2c57o22sug_API, "mod_nj2c57o22sug._C_API", NULL);
