...
#define MOD_2O8ZSLR20C4L_WRAPPER

#include "mod_2o8zslr20c4l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_2o8zslr20c4l_methods[] = {
    {
...
static struct PyModuleDef mod_2o8zslr20c4l_module = {
    ...
    0,
    mod_2o8zslr20c4l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_2o8zslr20c4l(void)
{
    PyObject* mod;
    static void* Pymod_2o8zslr20c4l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_2o8zslr20c4l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_2o8zslr20c4l_API, "mod_2o8zslr20c4l._C_API", NULL);
