...
#define MOD_9EDFDG6IC2TH_WRAPPER

#include "mod_9edfdg6ic2th_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9edfdg6ic2th_methods[] = {
    {
...
static struct PyModuleDef mod_9edfdg6ic2th_module = {
    ...
    0,
    mod_9edfdg6ic2th_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9edfdg6ic2th(void)
{
    PyObject* mod;
    static void* Pymod_9edfdg6ic2th_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9edfdg6ic2th_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9edfdg6ic2th_API, "mod_9edfdg6ic2th._C_API", NULL);
