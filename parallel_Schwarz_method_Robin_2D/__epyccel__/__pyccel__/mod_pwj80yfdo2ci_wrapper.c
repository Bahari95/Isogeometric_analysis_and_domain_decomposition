...
#define MOD_PWJ80YFDO2CI_WRAPPER

#include "mod_pwj80yfdo2ci_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pwj80yfdo2ci_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_pwj80yfdo2ci_module = {
    ...
    0,
    mod_pwj80yfdo2ci_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pwj80yfdo2ci(void)
{
    PyObject* mod;
    static void* Pymod_pwj80yfdo2ci_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pwj80yfdo2ci_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pwj80yfdo2ci_API, "mod_pwj80yfdo2ci._C_API", NULL);
