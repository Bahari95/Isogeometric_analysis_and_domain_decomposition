...
#define MOD_RM81JVV1ECW5_WRAPPER

#include "mod_rm81jvv1ecw5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rm81jvv1ecw5_methods[] = {
    {
...
static struct PyModuleDef mod_rm81jvv1ecw5_module = {
    ...
    0,
    mod_rm81jvv1ecw5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rm81jvv1ecw5(void)
{
    PyObject* mod;
    static void* Pymod_rm81jvv1ecw5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rm81jvv1ecw5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rm81jvv1ecw5_API, "mod_rm81jvv1ecw5._C_API", NULL);
