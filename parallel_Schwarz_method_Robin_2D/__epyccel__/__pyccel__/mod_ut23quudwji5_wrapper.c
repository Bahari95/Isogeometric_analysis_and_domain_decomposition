...
#define MOD_UT23QUUDWJI5_WRAPPER

#include "mod_ut23quudwji5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ut23quudwji5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ut23quudwji5_module = {
    ...
    0,
    mod_ut23quudwji5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ut23quudwji5(void)
{
    PyObject* mod;
    static void* Pymod_ut23quudwji5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ut23quudwji5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ut23quudwji5_API, "mod_ut23quudwji5._C_API", NULL);
