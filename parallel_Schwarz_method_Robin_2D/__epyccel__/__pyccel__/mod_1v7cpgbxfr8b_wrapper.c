...
#define MOD_1V7CPGBXFR8B_WRAPPER

#include "mod_1v7cpgbxfr8b_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1v7cpgbxfr8b_methods[] = {
    {
...
static struct PyModuleDef mod_1v7cpgbxfr8b_module = {
    ...
    0,
    mod_1v7cpgbxfr8b_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1v7cpgbxfr8b(void)
{
    PyObject* mod;
    static void* Pymod_1v7cpgbxfr8b_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1v7cpgbxfr8b_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1v7cpgbxfr8b_API, "mod_1v7cpgbxfr8b._C_API", NULL);
