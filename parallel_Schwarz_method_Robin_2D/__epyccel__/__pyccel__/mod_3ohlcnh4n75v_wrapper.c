...
#define MOD_3OHLCNH4N75V_WRAPPER

#include "mod_3ohlcnh4n75v_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3ohlcnh4n75v_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_3ohlcnh4n75v_module = {
    ...
    0,
    mod_3ohlcnh4n75v_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3ohlcnh4n75v(void)
{
    PyObject* mod;
    static void* Pymod_3ohlcnh4n75v_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3ohlcnh4n75v_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3ohlcnh4n75v_API, "mod_3ohlcnh4n75v._C_API", NULL);
