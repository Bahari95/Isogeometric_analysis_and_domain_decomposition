...
#define MOD_7VG2YJMC7A9H_WRAPPER

#include "mod_7vg2yjmc7a9h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7vg2yjmc7a9h_methods[] = {
    {
...
static struct PyModuleDef mod_7vg2yjmc7a9h_module = {
    ...
    0,
    mod_7vg2yjmc7a9h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7vg2yjmc7a9h(void)
{
    PyObject* mod;
    static void* Pymod_7vg2yjmc7a9h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7vg2yjmc7a9h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7vg2yjmc7a9h_API, "mod_7vg2yjmc7a9h._C_API", NULL);
