...
#define MOD_KH6VE3B22P2U_WRAPPER

#include "mod_kh6ve3b22p2u_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kh6ve3b22p2u_methods[] = {
    {
...
static struct PyModuleDef mod_kh6ve3b22p2u_module = {
    ...
    0,
    mod_kh6ve3b22p2u_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kh6ve3b22p2u(void)
{
    PyObject* mod;
    static void* Pymod_kh6ve3b22p2u_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kh6ve3b22p2u_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kh6ve3b22p2u_API, "mod_kh6ve3b22p2u._C_API", NULL);
