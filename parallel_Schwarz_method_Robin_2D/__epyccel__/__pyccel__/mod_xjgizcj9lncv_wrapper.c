...
#define MOD_XJGIZCJ9LNCV_WRAPPER

#include "mod_xjgizcj9lncv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xjgizcj9lncv_methods[] = {
    {
...
static struct PyModuleDef mod_xjgizcj9lncv_module = {
    ...
    0,
    mod_xjgizcj9lncv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xjgizcj9lncv(void)
{
    PyObject* mod;
    static void* Pymod_xjgizcj9lncv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xjgizcj9lncv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xjgizcj9lncv_API, "mod_xjgizcj9lncv._C_API", NULL);
