...
#define MOD_H250CC84WYLA_WRAPPER

#include "mod_h250cc84wyla_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_h250cc84wyla_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_h250cc84wyla_module = {
    ...
    0,
    mod_h250cc84wyla_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_h250cc84wyla(void)
{
    PyObject* mod;
    static void* Pymod_h250cc84wyla_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_h250cc84wyla_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_h250cc84wyla_API, "mod_h250cc84wyla._C_API", NULL);
