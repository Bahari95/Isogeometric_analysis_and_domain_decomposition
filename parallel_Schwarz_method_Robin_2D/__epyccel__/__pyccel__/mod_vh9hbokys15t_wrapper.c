...
#define MOD_VH9HBOKYS15T_WRAPPER

#include "mod_vh9hbokys15t_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vh9hbokys15t_methods[] = {
    {
...
static struct PyModuleDef mod_vh9hbokys15t_module = {
    ...
    0,
    mod_vh9hbokys15t_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vh9hbokys15t(void)
{
    PyObject* mod;
    static void* Pymod_vh9hbokys15t_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vh9hbokys15t_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vh9hbokys15t_API, "mod_vh9hbokys15t._C_API", NULL);
