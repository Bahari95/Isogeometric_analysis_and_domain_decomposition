...
#define MOD_U00TEZ1DRZ9Y_WRAPPER

#include "mod_u00tez1drz9y_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u00tez1drz9y_methods[] = {
    {
...
static struct PyModuleDef mod_u00tez1drz9y_module = {
    ...
    0,
    mod_u00tez1drz9y_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u00tez1drz9y(void)
{
    PyObject* mod;
    static void* Pymod_u00tez1drz9y_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u00tez1drz9y_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u00tez1drz9y_API, "mod_u00tez1drz9y._C_API", NULL);
