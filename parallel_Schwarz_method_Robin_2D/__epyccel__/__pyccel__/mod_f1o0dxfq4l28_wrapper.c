...
#define MOD_F1O0DXFQ4L28_WRAPPER

#include "mod_f1o0dxfq4l28_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_f1o0dxfq4l28_methods[] = {
    {
...
static struct PyModuleDef mod_f1o0dxfq4l28_module = {
    ...
    0,
    mod_f1o0dxfq4l28_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_f1o0dxfq4l28(void)
{
    PyObject* mod;
    static void* Pymod_f1o0dxfq4l28_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_f1o0dxfq4l28_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_f1o0dxfq4l28_API, "mod_f1o0dxfq4l28._C_API", NULL);
