...
#define MOD_0Q2V4HA6AWLW_WRAPPER

#include "mod_0q2v4ha6awlw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0q2v4ha6awlw_methods[] = {
    {
...
static struct PyModuleDef mod_0q2v4ha6awlw_module = {
    ...
    0,
    mod_0q2v4ha6awlw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0q2v4ha6awlw(void)
{
    PyObject* mod;
    static void* Pymod_0q2v4ha6awlw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0q2v4ha6awlw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0q2v4ha6awlw_API, "mod_0q2v4ha6awlw._C_API", NULL);
