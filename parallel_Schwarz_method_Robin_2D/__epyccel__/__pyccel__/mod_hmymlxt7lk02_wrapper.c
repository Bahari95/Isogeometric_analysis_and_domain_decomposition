...
#define MOD_HMYMLXT7LK02_WRAPPER

#include "mod_hmymlxt7lk02_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hmymlxt7lk02_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hmymlxt7lk02_module = {
    ...
    0,
    mod_hmymlxt7lk02_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hmymlxt7lk02(void)
{
    PyObject* mod;
    static void* Pymod_hmymlxt7lk02_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hmymlxt7lk02_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hmymlxt7lk02_API, "mod_hmymlxt7lk02._C_API", NULL);
