...
#define MOD_TBJIY9XHRV4G_WRAPPER

#include "mod_tbjiy9xhrv4g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tbjiy9xhrv4g_methods[] = {
    {
...
static struct PyModuleDef mod_tbjiy9xhrv4g_module = {
    ...
    0,
    mod_tbjiy9xhrv4g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tbjiy9xhrv4g(void)
{
    PyObject* mod;
    static void* Pymod_tbjiy9xhrv4g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tbjiy9xhrv4g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tbjiy9xhrv4g_API, "mod_tbjiy9xhrv4g._C_API", NULL);
