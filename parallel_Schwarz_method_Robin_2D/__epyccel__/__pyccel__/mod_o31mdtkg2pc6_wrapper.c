...
#define MOD_O31MDTKG2PC6_WRAPPER

#include "mod_o31mdtkg2pc6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_o31mdtkg2pc6_methods[] = {
    {
...
static struct PyModuleDef mod_o31mdtkg2pc6_module = {
    ...
    0,
    mod_o31mdtkg2pc6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_o31mdtkg2pc6(void)
{
    PyObject* mod;
    static void* Pymod_o31mdtkg2pc6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_o31mdtkg2pc6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_o31mdtkg2pc6_API, "mod_o31mdtkg2pc6._C_API", NULL);
