...
#define MOD_RYVDY9EPZ0HP_WRAPPER

#include "mod_ryvdy9epz0hp_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ryvdy9epz0hp_methods[] = {
    {
...
static struct PyModuleDef mod_ryvdy9epz0hp_module = {
    ...
    0,
    mod_ryvdy9epz0hp_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ryvdy9epz0hp(void)
{
    PyObject* mod;
    static void* Pymod_ryvdy9epz0hp_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ryvdy9epz0hp_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ryvdy9epz0hp_API, "mod_ryvdy9epz0hp._C_API", NULL);
