...
#define MOD_OS73NG966V5L_WRAPPER

#include "mod_os73ng966v5l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_os73ng966v5l_methods[] = {
    {
...
static struct PyModuleDef mod_os73ng966v5l_module = {
    ...
    0,
    mod_os73ng966v5l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_os73ng966v5l(void)
{
    PyObject* mod;
    static void* Pymod_os73ng966v5l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_os73ng966v5l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_os73ng966v5l_API, "mod_os73ng966v5l._C_API", NULL);
