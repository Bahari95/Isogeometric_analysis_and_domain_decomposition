...
#define MOD_P8Y8JLIXHEUQ_WRAPPER

#include "mod_p8y8jlixheuq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_p8y8jlixheuq_methods[] = {
    {
...
static struct PyModuleDef mod_p8y8jlixheuq_module = {
    ...
    0,
    mod_p8y8jlixheuq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_p8y8jlixheuq(void)
{
    PyObject* mod;
    static void* Pymod_p8y8jlixheuq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_p8y8jlixheuq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_p8y8jlixheuq_API, "mod_p8y8jlixheuq._C_API", NULL);
