...
#define MOD_DH51C74034BW_WRAPPER

#include "mod_dh51c74034bw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dh51c74034bw_methods[] = {
    {
...
static struct PyModuleDef mod_dh51c74034bw_module = {
    ...
    0,
    mod_dh51c74034bw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dh51c74034bw(void)
{
    PyObject* mod;
    static void* Pymod_dh51c74034bw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dh51c74034bw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dh51c74034bw_API, "mod_dh51c74034bw._C_API", NULL);
