...
#define MOD_R9NGXSST7BYY_WRAPPER

#include "mod_r9ngxsst7byy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_r9ngxsst7byy_methods[] = {
    {
...
static struct PyModuleDef mod_r9ngxsst7byy_module = {
    ...
    0,
    mod_r9ngxsst7byy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_r9ngxsst7byy(void)
{
    PyObject* mod;
    static void* Pymod_r9ngxsst7byy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_r9ngxsst7byy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_r9ngxsst7byy_API, "mod_r9ngxsst7byy._C_API", NULL);
