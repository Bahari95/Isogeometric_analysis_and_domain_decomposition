...
#define MOD_05LPDM8OFIAJ_WRAPPER

#include "mod_05lpdm8ofiaj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_05lpdm8ofiaj_methods[] = {
    {
...
static struct PyModuleDef mod_05lpdm8ofiaj_module = {
    ...
    0,
    mod_05lpdm8ofiaj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_05lpdm8ofiaj(void)
{
    PyObject* mod;
    static void* Pymod_05lpdm8ofiaj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_05lpdm8ofiaj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_05lpdm8ofiaj_API, "mod_05lpdm8ofiaj._C_API", NULL);
