...
#define MOD_370PG51MS2X9_WRAPPER

#include "mod_370pg51ms2x9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_370pg51ms2x9_methods[] = {
    {
...
static struct PyModuleDef mod_370pg51ms2x9_module = {
    ...
    0,
    mod_370pg51ms2x9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_370pg51ms2x9(void)
{
    PyObject* mod;
    static void* Pymod_370pg51ms2x9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_370pg51ms2x9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_370pg51ms2x9_API, "mod_370pg51ms2x9._C_API", NULL);
