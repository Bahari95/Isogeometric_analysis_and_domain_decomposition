module bind_c_mod_fury0zhmbvo5

  use mod_fury0zhmbvo5
  ...
  !........................................
  subroutine bind_c_assemble_vector_un_ex01(ne1, ne2, ne3, ne4, p1, p2, &
        p3, p4, bound_spans_1, bound_spans_1_shape_1, &
        ...
        bound_points_4_stride_1, bound_points_4_stride_2, domain_nb, &
        S_DDM, ovlp_value, bound_knots_1, bound_knots_1_shape_1, &
        bound_knots_1_stride_1, bound_knots_2, bound_knots_2_shape_1, &
        bound_knots_2_stride_1, bound_knots_3, bound_knots_3_shape_1, &
        bound_knots_3_stride_1, bound_knots_4, bound_knots_4_shape_1, &
        bound_knots_4_stride_1, bound_vector_m1, &
        ...
        bound_vector_m2_stride_2, bound_vector_d, &
    ...
    call assemble_vector_un_ex01(ne1 = ne1, ne2 = ne2, ne3 = ne3, ne4 = &
          ne4, p1 = p1, p2 = p2, p3 = p3, p4 = p4, spans_1 = spans_1( &
          1_i64::bound_spans_1_stride_1), spans_2 = spans_2(1_i64:: &
          ...
          bound_points_4_stride_1), domain_nb = domain_nb, S_DDM = &
          S_DDM, ovlp_value = ovlp_value, knots_1 = knots_1(1_i64:: &
