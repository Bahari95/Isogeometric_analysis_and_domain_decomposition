...
#define MOD_D96IJUVJFD96_WRAPPER

#include "mod_d96ijuvjfd96_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d96ijuvjfd96_methods[] = {
    {
...
static struct PyModuleDef mod_d96ijuvjfd96_module = {
    ...
    0,
    mod_d96ijuvjfd96_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d96ijuvjfd96(void)
{
    PyObject* mod;
    static void* Pymod_d96ijuvjfd96_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d96ijuvjfd96_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d96ijuvjfd96_API, "mod_d96ijuvjfd96._C_API", NULL);
