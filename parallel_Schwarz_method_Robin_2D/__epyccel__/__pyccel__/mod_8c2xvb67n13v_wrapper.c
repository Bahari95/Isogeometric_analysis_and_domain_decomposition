...
#define MOD_8C2XVB67N13V_WRAPPER

#include "mod_8c2xvb67n13v_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8c2xvb67n13v_methods[] = {
    {
...
static struct PyModuleDef mod_8c2xvb67n13v_module = {
    ...
    0,
    mod_8c2xvb67n13v_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8c2xvb67n13v(void)
{
    PyObject* mod;
    static void* Pymod_8c2xvb67n13v_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8c2xvb67n13v_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8c2xvb67n13v_API, "mod_8c2xvb67n13v._C_API", NULL);
