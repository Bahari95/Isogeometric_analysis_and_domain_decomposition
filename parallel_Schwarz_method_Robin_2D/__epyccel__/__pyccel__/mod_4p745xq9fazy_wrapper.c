...
#define MOD_4P745XQ9FAZY_WRAPPER

#include "mod_4p745xq9fazy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4p745xq9fazy_methods[] = {
    {
...
static struct PyModuleDef mod_4p745xq9fazy_module = {
    ...
    0,
    mod_4p745xq9fazy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4p745xq9fazy(void)
{
    PyObject* mod;
    static void* Pymod_4p745xq9fazy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4p745xq9fazy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4p745xq9fazy_API, "mod_4p745xq9fazy._C_API", NULL);
