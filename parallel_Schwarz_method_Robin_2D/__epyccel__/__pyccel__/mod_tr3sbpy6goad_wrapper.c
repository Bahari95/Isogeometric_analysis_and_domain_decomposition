...
#define MOD_TR3SBPY6GOAD_WRAPPER

#include "mod_tr3sbpy6goad_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tr3sbpy6goad_methods[] = {
    {
...
static struct PyModuleDef mod_tr3sbpy6goad_module = {
    ...
    0,
    mod_tr3sbpy6goad_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tr3sbpy6goad(void)
{
    PyObject* mod;
    static void* Pymod_tr3sbpy6goad_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tr3sbpy6goad_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tr3sbpy6goad_API, "mod_tr3sbpy6goad._C_API", NULL);
