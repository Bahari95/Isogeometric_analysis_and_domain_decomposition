...
#define MOD_VR5PIBGW8MG4_WRAPPER

#include "mod_vr5pibgw8mg4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vr5pibgw8mg4_methods[] = {
    {
...
static struct PyModuleDef mod_vr5pibgw8mg4_module = {
    ...
    0,
    mod_vr5pibgw8mg4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vr5pibgw8mg4(void)
{
    PyObject* mod;
    static void* Pymod_vr5pibgw8mg4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vr5pibgw8mg4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vr5pibgw8mg4_API, "mod_vr5pibgw8mg4._C_API", NULL);
