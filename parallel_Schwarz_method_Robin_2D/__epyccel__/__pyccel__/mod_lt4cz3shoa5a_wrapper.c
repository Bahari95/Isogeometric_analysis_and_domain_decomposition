...
#define MOD_LT4CZ3SHOA5A_WRAPPER

#include "mod_lt4cz3shoa5a_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lt4cz3shoa5a_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lt4cz3shoa5a_module = {
    ...
    0,
    mod_lt4cz3shoa5a_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lt4cz3shoa5a(void)
{
    PyObject* mod;
    static void* Pymod_lt4cz3shoa5a_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lt4cz3shoa5a_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lt4cz3shoa5a_API, "mod_lt4cz3shoa5a._C_API", NULL);
