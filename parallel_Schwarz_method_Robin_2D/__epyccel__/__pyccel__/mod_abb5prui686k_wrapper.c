...
#define MOD_ABB5PRUI686K_WRAPPER

#include "mod_abb5prui686k_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_abb5prui686k_methods[] = {
    {
...
static struct PyModuleDef mod_abb5prui686k_module = {
    ...
    0,
    mod_abb5prui686k_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_abb5prui686k(void)
{
    PyObject* mod;
    static void* Pymod_abb5prui686k_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_abb5prui686k_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_abb5prui686k_API, "mod_abb5prui686k._C_API", NULL);
