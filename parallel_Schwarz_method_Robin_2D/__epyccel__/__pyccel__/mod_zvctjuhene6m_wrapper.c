...
#define MOD_ZVCTJUHENE6M_WRAPPER

#include "mod_zvctjuhene6m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zvctjuhene6m_methods[] = {
    {
...
static struct PyModuleDef mod_zvctjuhene6m_module = {
    ...
    0,
    mod_zvctjuhene6m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zvctjuhene6m(void)
{
    PyObject* mod;
    static void* Pymod_zvctjuhene6m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zvctjuhene6m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zvctjuhene6m_API, "mod_zvctjuhene6m._C_API", NULL);
