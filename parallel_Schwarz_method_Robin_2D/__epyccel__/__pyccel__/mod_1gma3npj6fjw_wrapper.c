...
#define MOD_1GMA3NPJ6FJW_WRAPPER

#include "mod_1gma3npj6fjw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1gma3npj6fjw_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1gma3npj6fjw_module = {
    ...
    0,
    mod_1gma3npj6fjw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1gma3npj6fjw(void)
{
    PyObject* mod;
    static void* Pymod_1gma3npj6fjw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1gma3npj6fjw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1gma3npj6fjw_API, "mod_1gma3npj6fjw._C_API", NULL);
