...
#define MOD_ZRXY8YXHIY4L_WRAPPER

#include "mod_zrxy8yxhiy4l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zrxy8yxhiy4l_methods[] = {
    {
...
static struct PyModuleDef mod_zrxy8yxhiy4l_module = {
    ...
    0,
    mod_zrxy8yxhiy4l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zrxy8yxhiy4l(void)
{
    PyObject* mod;
    static void* Pymod_zrxy8yxhiy4l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zrxy8yxhiy4l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zrxy8yxhiy4l_API, "mod_zrxy8yxhiy4l._C_API", NULL);
