...
#define MOD_U4MN8FP2IY8J_WRAPPER

#include "mod_u4mn8fp2iy8j_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u4mn8fp2iy8j_methods[] = {
    {
...
static struct PyModuleDef mod_u4mn8fp2iy8j_module = {
    ...
    0,
    mod_u4mn8fp2iy8j_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u4mn8fp2iy8j(void)
{
    PyObject* mod;
    static void* Pymod_u4mn8fp2iy8j_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u4mn8fp2iy8j_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u4mn8fp2iy8j_API, "mod_u4mn8fp2iy8j._C_API", NULL);
