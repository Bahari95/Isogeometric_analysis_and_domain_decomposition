...
#define MOD_81AAE5PVPNXQ_WRAPPER

#include "mod_81aae5pvpnxq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_81aae5pvpnxq_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_81aae5pvpnxq_module = {
    ...
    0,
    mod_81aae5pvpnxq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_81aae5pvpnxq(void)
{
    PyObject* mod;
    static void* Pymod_81aae5pvpnxq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_81aae5pvpnxq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_81aae5pvpnxq_API, "mod_81aae5pvpnxq._C_API", NULL);
