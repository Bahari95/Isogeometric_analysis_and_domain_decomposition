...
#define MOD_6RYGIZQ3O3I5_WRAPPER

#include "mod_6rygizq3o3i5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6rygizq3o3i5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_6rygizq3o3i5_module = {
    ...
    0,
    mod_6rygizq3o3i5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6rygizq3o3i5(void)
{
    PyObject* mod;
    static void* Pymod_6rygizq3o3i5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6rygizq3o3i5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6rygizq3o3i5_API, "mod_6rygizq3o3i5._C_API", NULL);
