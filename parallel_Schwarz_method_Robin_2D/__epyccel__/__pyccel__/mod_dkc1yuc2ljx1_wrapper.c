...
#define MOD_DKC1YUC2LJX1_WRAPPER

#include "mod_dkc1yuc2ljx1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dkc1yuc2ljx1_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dkc1yuc2ljx1_module = {
    ...
    0,
    mod_dkc1yuc2ljx1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dkc1yuc2ljx1(void)
{
    PyObject* mod;
    static void* Pymod_dkc1yuc2ljx1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dkc1yuc2ljx1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dkc1yuc2ljx1_API, "mod_dkc1yuc2ljx1._C_API", NULL);
