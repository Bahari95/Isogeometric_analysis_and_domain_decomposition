...
#define MOD_CCBY1YCB590K_WRAPPER

#include "mod_ccby1ycb590k_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ccby1ycb590k_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ccby1ycb590k_module = {
    ...
    0,
    mod_ccby1ycb590k_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ccby1ycb590k(void)
{
    PyObject* mod;
    static void* Pymod_ccby1ycb590k_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ccby1ycb590k_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ccby1ycb590k_API, "mod_ccby1ycb590k._C_API", NULL);
