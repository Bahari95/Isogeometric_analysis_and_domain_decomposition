...
#define MOD_NBN7QRKSC649_WRAPPER

#include "mod_nbn7qrksc649_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nbn7qrksc649_methods[] = {
    {
...
static struct PyModuleDef mod_nbn7qrksc649_module = {
    ...
    0,
    mod_nbn7qrksc649_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nbn7qrksc649(void)
{
    PyObject* mod;
    static void* Pymod_nbn7qrksc649_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nbn7qrksc649_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nbn7qrksc649_API, "mod_nbn7qrksc649._C_API", NULL);
