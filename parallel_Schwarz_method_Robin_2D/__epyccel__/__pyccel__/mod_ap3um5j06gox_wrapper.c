...
#define MOD_AP3UM5J06GOX_WRAPPER

#include "mod_ap3um5j06gox_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ap3um5j06gox_methods[] = {
    {
...
static struct PyModuleDef mod_ap3um5j06gox_module = {
    ...
    0,
    mod_ap3um5j06gox_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ap3um5j06gox(void)
{
    PyObject* mod;
    static void* Pymod_ap3um5j06gox_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ap3um5j06gox_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ap3um5j06gox_API, "mod_ap3um5j06gox._C_API", NULL);
