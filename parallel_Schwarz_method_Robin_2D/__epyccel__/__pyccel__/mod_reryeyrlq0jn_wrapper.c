...
#define MOD_RERYEYRLQ0JN_WRAPPER

#include "mod_reryeyrlq0jn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_reryeyrlq0jn_methods[] = {
    {
...
static struct PyModuleDef mod_reryeyrlq0jn_module = {
    ...
    0,
    mod_reryeyrlq0jn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_reryeyrlq0jn(void)
{
    PyObject* mod;
    static void* Pymod_reryeyrlq0jn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_reryeyrlq0jn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_reryeyrlq0jn_API, "mod_reryeyrlq0jn._C_API", NULL);
