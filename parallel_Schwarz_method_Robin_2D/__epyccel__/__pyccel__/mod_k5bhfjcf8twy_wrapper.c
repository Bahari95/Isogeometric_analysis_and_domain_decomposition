...
#define MOD_K5BHFJCF8TWY_WRAPPER

#include "mod_k5bhfjcf8twy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_k5bhfjcf8twy_methods[] = {
    {
...
static struct PyModuleDef mod_k5bhfjcf8twy_module = {
    ...
    0,
    mod_k5bhfjcf8twy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k5bhfjcf8twy(void)
{
    PyObject* mod;
    static void* Pymod_k5bhfjcf8twy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k5bhfjcf8twy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k5bhfjcf8twy_API, "mod_k5bhfjcf8twy._C_API", NULL);
