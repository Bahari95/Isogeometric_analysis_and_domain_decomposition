...
#define MOD_JSKB2B3ZH4D5_WRAPPER

#include "mod_jskb2b3zh4d5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jskb2b3zh4d5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_jskb2b3zh4d5_module = {
    ...
    0,
    mod_jskb2b3zh4d5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jskb2b3zh4d5(void)
{
    PyObject* mod;
    static void* Pymod_jskb2b3zh4d5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jskb2b3zh4d5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jskb2b3zh4d5_API, "mod_jskb2b3zh4d5._C_API", NULL);
