...
#define MOD_TNFSIP5FZ89E_WRAPPER

#include "mod_tnfsip5fz89e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tnfsip5fz89e_methods[] = {
    {
...
static struct PyModuleDef mod_tnfsip5fz89e_module = {
    ...
    0,
    mod_tnfsip5fz89e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tnfsip5fz89e(void)
{
    PyObject* mod;
    static void* Pymod_tnfsip5fz89e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tnfsip5fz89e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tnfsip5fz89e_API, "mod_tnfsip5fz89e._C_API", NULL);
