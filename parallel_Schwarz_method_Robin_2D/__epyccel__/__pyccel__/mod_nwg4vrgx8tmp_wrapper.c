...
#define MOD_NWG4VRGX8TMP_WRAPPER

#include "mod_nwg4vrgx8tmp_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nwg4vrgx8tmp_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_nwg4vrgx8tmp_module = {
    ...
    0,
    mod_nwg4vrgx8tmp_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nwg4vrgx8tmp(void)
{
    PyObject* mod;
    static void* Pymod_nwg4vrgx8tmp_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nwg4vrgx8tmp_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nwg4vrgx8tmp_API, "mod_nwg4vrgx8tmp._C_API", NULL);
