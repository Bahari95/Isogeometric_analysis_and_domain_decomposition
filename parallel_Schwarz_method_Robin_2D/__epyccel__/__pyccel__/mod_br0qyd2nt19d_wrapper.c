...
#define MOD_BR0QYD2NT19D_WRAPPER

#include "mod_br0qyd2nt19d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_br0qyd2nt19d_methods[] = {
    {
...
static struct PyModuleDef mod_br0qyd2nt19d_module = {
    ...
    0,
    mod_br0qyd2nt19d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_br0qyd2nt19d(void)
{
    PyObject* mod;
    static void* Pymod_br0qyd2nt19d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_br0qyd2nt19d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_br0qyd2nt19d_API, "mod_br0qyd2nt19d._C_API", NULL);
