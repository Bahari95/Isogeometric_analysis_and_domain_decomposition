...
#define MOD_LVDFUSTD3CXA_WRAPPER

#include "mod_lvdfustd3cxa_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lvdfustd3cxa_methods[] = {
    {
...
static struct PyModuleDef mod_lvdfustd3cxa_module = {
    ...
    0,
    mod_lvdfustd3cxa_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lvdfustd3cxa(void)
{
    PyObject* mod;
    static void* Pymod_lvdfustd3cxa_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lvdfustd3cxa_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lvdfustd3cxa_API, "mod_lvdfustd3cxa._C_API", NULL);
