...
#define MOD_84HHQD0SKDMN_WRAPPER

#include "mod_84hhqd0skdmn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_84hhqd0skdmn_methods[] = {
    {
...
static struct PyModuleDef mod_84hhqd0skdmn_module = {
    ...
    0,
    mod_84hhqd0skdmn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_84hhqd0skdmn(void)
{
    PyObject* mod;
    static void* Pymod_84hhqd0skdmn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_84hhqd0skdmn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_84hhqd0skdmn_API, "mod_84hhqd0skdmn._C_API", NULL);
