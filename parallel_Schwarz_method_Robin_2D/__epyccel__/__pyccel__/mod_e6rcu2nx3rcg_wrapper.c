...
#define MOD_E6RCU2NX3RCG_WRAPPER

#include "mod_e6rcu2nx3rcg_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e6rcu2nx3rcg_methods[] = {
    {
...
static struct PyModuleDef mod_e6rcu2nx3rcg_module = {
    ...
    0,
    mod_e6rcu2nx3rcg_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e6rcu2nx3rcg(void)
{
    PyObject* mod;
    static void* Pymod_e6rcu2nx3rcg_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e6rcu2nx3rcg_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e6rcu2nx3rcg_API, "mod_e6rcu2nx3rcg._C_API", NULL);
