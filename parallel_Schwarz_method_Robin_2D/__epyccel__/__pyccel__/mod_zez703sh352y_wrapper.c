...
#define MOD_ZEZ703SH352Y_WRAPPER

#include "mod_zez703sh352y_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zez703sh352y_methods[] = {
    {
...
static struct PyModuleDef mod_zez703sh352y_module = {
    ...
    0,
    mod_zez703sh352y_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zez703sh352y(void)
{
    PyObject* mod;
    static void* Pymod_zez703sh352y_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zez703sh352y_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zez703sh352y_API, "mod_zez703sh352y._C_API", NULL);
