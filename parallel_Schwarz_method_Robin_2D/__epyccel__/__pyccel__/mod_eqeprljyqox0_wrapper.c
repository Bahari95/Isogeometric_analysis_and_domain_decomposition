...
#define MOD_EQEPRLJYQOX0_WRAPPER

#include "mod_eqeprljyqox0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eqeprljyqox0_methods[] = {
    {
...
static struct PyModuleDef mod_eqeprljyqox0_module = {
    ...
    0,
    mod_eqeprljyqox0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eqeprljyqox0(void)
{
    PyObject* mod;
    static void* Pymod_eqeprljyqox0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eqeprljyqox0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eqeprljyqox0_API, "mod_eqeprljyqox0._C_API", NULL);
