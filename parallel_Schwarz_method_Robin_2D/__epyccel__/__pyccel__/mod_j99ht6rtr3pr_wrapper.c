...
#define MOD_J99HT6RTR3PR_WRAPPER

#include "mod_j99ht6rtr3pr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_j99ht6rtr3pr_methods[] = {
    {
...
static struct PyModuleDef mod_j99ht6rtr3pr_module = {
    ...
    0,
    mod_j99ht6rtr3pr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_j99ht6rtr3pr(void)
{
    PyObject* mod;
    static void* Pymod_j99ht6rtr3pr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_j99ht6rtr3pr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_j99ht6rtr3pr_API, "mod_j99ht6rtr3pr._C_API", NULL);
