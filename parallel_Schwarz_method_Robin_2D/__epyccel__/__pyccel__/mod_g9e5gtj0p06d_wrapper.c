...
#define MOD_G9E5GTJ0P06D_WRAPPER

#include "mod_g9e5gtj0p06d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_g9e5gtj0p06d_methods[] = {
    {
...
static struct PyModuleDef mod_g9e5gtj0p06d_module = {
    ...
    0,
    mod_g9e5gtj0p06d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_g9e5gtj0p06d(void)
{
    PyObject* mod;
    static void* Pymod_g9e5gtj0p06d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_g9e5gtj0p06d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_g9e5gtj0p06d_API, "mod_g9e5gtj0p06d._C_API", NULL);
