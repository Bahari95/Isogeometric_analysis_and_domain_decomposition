...
#define MOD_I3HHW1BXHL9Q_WRAPPER

#include "mod_i3hhw1bxhl9q_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i3hhw1bxhl9q_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i3hhw1bxhl9q_module = {
    ...
    0,
    mod_i3hhw1bxhl9q_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i3hhw1bxhl9q(void)
{
    PyObject* mod;
    static void* Pymod_i3hhw1bxhl9q_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i3hhw1bxhl9q_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i3hhw1bxhl9q_API, "mod_i3hhw1bxhl9q._C_API", NULL);
