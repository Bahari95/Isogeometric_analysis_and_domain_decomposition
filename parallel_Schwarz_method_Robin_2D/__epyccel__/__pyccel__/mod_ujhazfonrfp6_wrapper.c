...
#define MOD_UJHAZFONRFP6_WRAPPER

#include "mod_ujhazfonrfp6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ujhazfonrfp6_methods[] = {
    {
...
static struct PyModuleDef mod_ujhazfonrfp6_module = {
    ...
    0,
    mod_ujhazfonrfp6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ujhazfonrfp6(void)
{
    PyObject* mod;
    static void* Pymod_ujhazfonrfp6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ujhazfonrfp6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ujhazfonrfp6_API, "mod_ujhazfonrfp6._C_API", NULL);
