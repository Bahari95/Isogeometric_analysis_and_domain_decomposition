...
#define MOD_IK5V0D1KK32S_WRAPPER

#include "mod_ik5v0d1kk32s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ik5v0d1kk32s_methods[] = {
    {
...
static struct PyModuleDef mod_ik5v0d1kk32s_module = {
    ...
    0,
    mod_ik5v0d1kk32s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ik5v0d1kk32s(void)
{
    PyObject* mod;
    static void* Pymod_ik5v0d1kk32s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ik5v0d1kk32s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ik5v0d1kk32s_API, "mod_ik5v0d1kk32s._C_API", NULL);
