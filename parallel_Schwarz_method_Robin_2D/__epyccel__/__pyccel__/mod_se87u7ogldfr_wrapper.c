...
#define MOD_SE87U7OGLDFR_WRAPPER

#include "mod_se87u7ogldfr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_se87u7ogldfr_methods[] = {
    {
...
static struct PyModuleDef mod_se87u7ogldfr_module = {
    ...
    0,
    mod_se87u7ogldfr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_se87u7ogldfr(void)
{
    PyObject* mod;
    static void* Pymod_se87u7ogldfr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_se87u7ogldfr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_se87u7ogldfr_API, "mod_se87u7ogldfr._C_API", NULL);
