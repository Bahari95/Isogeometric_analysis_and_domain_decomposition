...
#define MOD_EVF24X1C7LQ7_WRAPPER

#include "mod_evf24x1c7lq7_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_evf24x1c7lq7_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_evf24x1c7lq7_module = {
    ...
    0,
    mod_evf24x1c7lq7_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_evf24x1c7lq7(void)
{
    PyObject* mod;
    static void* Pymod_evf24x1c7lq7_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_evf24x1c7lq7_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_evf24x1c7lq7_API, "mod_evf24x1c7lq7._C_API", NULL);
