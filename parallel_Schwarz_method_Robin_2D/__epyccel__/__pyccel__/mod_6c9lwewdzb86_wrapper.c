...
#define MOD_6C9LWEWDZB86_WRAPPER

#include "mod_6c9lwewdzb86_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6c9lwewdzb86_methods[] = {
    {
...
static struct PyModuleDef mod_6c9lwewdzb86_module = {
    ...
    0,
    mod_6c9lwewdzb86_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6c9lwewdzb86(void)
{
    PyObject* mod;
    static void* Pymod_6c9lwewdzb86_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6c9lwewdzb86_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6c9lwewdzb86_API, "mod_6c9lwewdzb86._C_API", NULL);
