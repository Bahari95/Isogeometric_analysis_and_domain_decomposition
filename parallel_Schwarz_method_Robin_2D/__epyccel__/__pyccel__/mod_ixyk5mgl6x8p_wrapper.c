...
#define MOD_IXYK5MGL6X8P_WRAPPER

#include "mod_ixyk5mgl6x8p_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ixyk5mgl6x8p_methods[] = {
    {
...
static struct PyModuleDef mod_ixyk5mgl6x8p_module = {
    ...
    0,
    mod_ixyk5mgl6x8p_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ixyk5mgl6x8p(void)
{
    PyObject* mod;
    static void* Pymod_ixyk5mgl6x8p_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ixyk5mgl6x8p_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ixyk5mgl6x8p_API, "mod_ixyk5mgl6x8p._C_API", NULL);
