...
#define MOD_JDJRONFXADUY_WRAPPER

#include "mod_jdjronfxaduy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jdjronfxaduy_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_jdjronfxaduy_module = {
    ...
    0,
    mod_jdjronfxaduy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jdjronfxaduy(void)
{
    PyObject* mod;
    static void* Pymod_jdjronfxaduy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jdjronfxaduy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jdjronfxaduy_API, "mod_jdjronfxaduy._C_API", NULL);
