...
#define MOD_S0EXAHET754F_WRAPPER

#include "mod_s0exahet754f_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_s0exahet754f_methods[] = {
    {
...
static struct PyModuleDef mod_s0exahet754f_module = {
    ...
    0,
    mod_s0exahet754f_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_s0exahet754f(void)
{
    PyObject* mod;
    static void* Pymod_s0exahet754f_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_s0exahet754f_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_s0exahet754f_API, "mod_s0exahet754f._C_API", NULL);
