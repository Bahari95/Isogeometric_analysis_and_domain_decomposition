...
#define MOD_K82Q7SCV5WP4_WRAPPER

#include "mod_k82q7scv5wp4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_k82q7scv5wp4_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_k82q7scv5wp4_module = {
    ...
    0,
    mod_k82q7scv5wp4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k82q7scv5wp4(void)
{
    PyObject* mod;
    static void* Pymod_k82q7scv5wp4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k82q7scv5wp4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k82q7scv5wp4_API, "mod_k82q7scv5wp4._C_API", NULL);
