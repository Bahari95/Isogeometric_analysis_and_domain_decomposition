...
#define MOD_8T0S994JEXWE_WRAPPER

#include "mod_8t0s994jexwe_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8t0s994jexwe_methods[] = {
    {
...
static struct PyModuleDef mod_8t0s994jexwe_module = {
    ...
    0,
    mod_8t0s994jexwe_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8t0s994jexwe(void)
{
    PyObject* mod;
    static void* Pymod_8t0s994jexwe_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8t0s994jexwe_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8t0s994jexwe_API, "mod_8t0s994jexwe._C_API", NULL);
