...
#define MOD_7VQBAB2HTTL8_WRAPPER

#include "mod_7vqbab2httl8_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7vqbab2httl8_methods[] = {
    {
...
static struct PyModuleDef mod_7vqbab2httl8_module = {
    ...
    0,
    mod_7vqbab2httl8_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7vqbab2httl8(void)
{
    PyObject* mod;
    static void* Pymod_7vqbab2httl8_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7vqbab2httl8_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7vqbab2httl8_API, "mod_7vqbab2httl8._C_API", NULL);
