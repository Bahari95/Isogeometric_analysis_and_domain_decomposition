...
#define MOD_ES9ECNEJADKT_WRAPPER

#include "mod_es9ecnejadkt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_es9ecnejadkt_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_es9ecnejadkt_module = {
    ...
    0,
    mod_es9ecnejadkt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_es9ecnejadkt(void)
{
    PyObject* mod;
    static void* Pymod_es9ecnejadkt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_es9ecnejadkt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_es9ecnejadkt_API, "mod_es9ecnejadkt._C_API", NULL);
