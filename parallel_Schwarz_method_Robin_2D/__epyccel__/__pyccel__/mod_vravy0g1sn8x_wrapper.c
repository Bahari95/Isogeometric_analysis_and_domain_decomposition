...
#define MOD_VRAVY0G1SN8X_WRAPPER

#include "mod_vravy0g1sn8x_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vravy0g1sn8x_methods[] = {
    {
...
static struct PyModuleDef mod_vravy0g1sn8x_module = {
    ...
    0,
    mod_vravy0g1sn8x_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vravy0g1sn8x(void)
{
    PyObject* mod;
    static void* Pymod_vravy0g1sn8x_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vravy0g1sn8x_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vravy0g1sn8x_API, "mod_vravy0g1sn8x._C_API", NULL);
