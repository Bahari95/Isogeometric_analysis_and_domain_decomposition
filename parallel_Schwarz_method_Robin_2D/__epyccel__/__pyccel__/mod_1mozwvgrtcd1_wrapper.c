...
#define MOD_1MOZWVGRTCD1_WRAPPER

#include "mod_1mozwvgrtcd1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1mozwvgrtcd1_methods[] = {
    {
...
static struct PyModuleDef mod_1mozwvgrtcd1_module = {
    ...
    0,
    mod_1mozwvgrtcd1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1mozwvgrtcd1(void)
{
    PyObject* mod;
    static void* Pymod_1mozwvgrtcd1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1mozwvgrtcd1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1mozwvgrtcd1_API, "mod_1mozwvgrtcd1._C_API", NULL);
