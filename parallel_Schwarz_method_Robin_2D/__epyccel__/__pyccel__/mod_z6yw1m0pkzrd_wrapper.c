...
#define MOD_Z6YW1M0PKZRD_WRAPPER

#include "mod_z6yw1m0pkzrd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_z6yw1m0pkzrd_methods[] = {
    {
...
static struct PyModuleDef mod_z6yw1m0pkzrd_module = {
    ...
    0,
    mod_z6yw1m0pkzrd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_z6yw1m0pkzrd(void)
{
    PyObject* mod;
    static void* Pymod_z6yw1m0pkzrd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_z6yw1m0pkzrd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_z6yw1m0pkzrd_API, "mod_z6yw1m0pkzrd._C_API", NULL);
