...
#define MOD_81S4QWV1SP00_WRAPPER

#include "mod_81s4qwv1sp00_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_81s4qwv1sp00_methods[] = {
    {
...
static struct PyModuleDef mod_81s4qwv1sp00_module = {
    ...
    0,
    mod_81s4qwv1sp00_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_81s4qwv1sp00(void)
{
    PyObject* mod;
    static void* Pymod_81s4qwv1sp00_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_81s4qwv1sp00_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_81s4qwv1sp00_API, "mod_81s4qwv1sp00._C_API", NULL);
