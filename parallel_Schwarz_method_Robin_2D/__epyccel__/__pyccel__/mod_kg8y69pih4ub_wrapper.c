...
#define MOD_KG8Y69PIH4UB_WRAPPER

#include "mod_kg8y69pih4ub_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kg8y69pih4ub_methods[] = {
    {
...
static struct PyModuleDef mod_kg8y69pih4ub_module = {
    ...
    0,
    mod_kg8y69pih4ub_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kg8y69pih4ub(void)
{
    PyObject* mod;
    static void* Pymod_kg8y69pih4ub_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kg8y69pih4ub_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kg8y69pih4ub_API, "mod_kg8y69pih4ub._C_API", NULL);
