...
#define MOD_8V2CRHR9SFDC_WRAPPER

#include "mod_8v2crhr9sfdc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8v2crhr9sfdc_methods[] = {
    {
...
static struct PyModuleDef mod_8v2crhr9sfdc_module = {
    ...
    0,
    mod_8v2crhr9sfdc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8v2crhr9sfdc(void)
{
    PyObject* mod;
    static void* Pymod_8v2crhr9sfdc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8v2crhr9sfdc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8v2crhr9sfdc_API, "mod_8v2crhr9sfdc._C_API", NULL);
