...
#define MOD_D2AX1XQOM7O4_WRAPPER

#include "mod_d2ax1xqom7o4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d2ax1xqom7o4_methods[] = {
    {
...
static struct PyModuleDef mod_d2ax1xqom7o4_module = {
    ...
    0,
    mod_d2ax1xqom7o4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d2ax1xqom7o4(void)
{
    PyObject* mod;
    static void* Pymod_d2ax1xqom7o4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d2ax1xqom7o4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d2ax1xqom7o4_API, "mod_d2ax1xqom7o4._C_API", NULL);
