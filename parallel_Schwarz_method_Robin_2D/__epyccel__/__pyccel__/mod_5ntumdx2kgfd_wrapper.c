...
#define MOD_5NTUMDX2KGFD_WRAPPER

#include "mod_5ntumdx2kgfd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5ntumdx2kgfd_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_5ntumdx2kgfd_module = {
    ...
    0,
    mod_5ntumdx2kgfd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5ntumdx2kgfd(void)
{
    PyObject* mod;
    static void* Pymod_5ntumdx2kgfd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5ntumdx2kgfd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5ntumdx2kgfd_API, "mod_5ntumdx2kgfd._C_API", NULL);
