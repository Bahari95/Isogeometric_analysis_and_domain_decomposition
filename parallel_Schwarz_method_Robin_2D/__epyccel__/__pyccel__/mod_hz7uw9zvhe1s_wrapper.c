...
#define MOD_HZ7UW9ZVHE1S_WRAPPER

#include "mod_hz7uw9zvhe1s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hz7uw9zvhe1s_methods[] = {
    {
...
static struct PyModuleDef mod_hz7uw9zvhe1s_module = {
    ...
    0,
    mod_hz7uw9zvhe1s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hz7uw9zvhe1s(void)
{
    PyObject* mod;
    static void* Pymod_hz7uw9zvhe1s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hz7uw9zvhe1s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hz7uw9zvhe1s_API, "mod_hz7uw9zvhe1s._C_API", NULL);
