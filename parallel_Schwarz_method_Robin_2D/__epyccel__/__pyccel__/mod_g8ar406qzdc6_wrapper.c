...
#define MOD_G8AR406QZDC6_WRAPPER

#include "mod_g8ar406qzdc6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_g8ar406qzdc6_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_g8ar406qzdc6_module = {
    ...
    0,
    mod_g8ar406qzdc6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_g8ar406qzdc6(void)
{
    PyObject* mod;
    static void* Pymod_g8ar406qzdc6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_g8ar406qzdc6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_g8ar406qzdc6_API, "mod_g8ar406qzdc6._C_API", NULL);
