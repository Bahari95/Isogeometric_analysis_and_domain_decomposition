...
#define MOD_GOH6O0NCP8YD_WRAPPER

#include "mod_goh6o0ncp8yd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_goh6o0ncp8yd_methods[] = {
    {
...
static struct PyModuleDef mod_goh6o0ncp8yd_module = {
    ...
    0,
    mod_goh6o0ncp8yd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_goh6o0ncp8yd(void)
{
    PyObject* mod;
    static void* Pymod_goh6o0ncp8yd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_goh6o0ncp8yd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_goh6o0ncp8yd_API, "mod_goh6o0ncp8yd._C_API", NULL);
