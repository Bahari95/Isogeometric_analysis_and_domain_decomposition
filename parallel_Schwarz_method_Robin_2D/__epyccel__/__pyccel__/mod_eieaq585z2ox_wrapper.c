...
#define MOD_EIEAQ585Z2OX_WRAPPER

#include "mod_eieaq585z2ox_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eieaq585z2ox_methods[] = {
    {
...
static struct PyModuleDef mod_eieaq585z2ox_module = {
    ...
    0,
    mod_eieaq585z2ox_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eieaq585z2ox(void)
{
    PyObject* mod;
    static void* Pymod_eieaq585z2ox_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eieaq585z2ox_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eieaq585z2ox_API, "mod_eieaq585z2ox._C_API", NULL);
