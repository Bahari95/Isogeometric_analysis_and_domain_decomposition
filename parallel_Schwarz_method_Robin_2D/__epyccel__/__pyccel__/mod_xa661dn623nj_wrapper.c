...
#define MOD_XA661DN623NJ_WRAPPER

#include "mod_xa661dn623nj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xa661dn623nj_methods[] = {
    {
...
static struct PyModuleDef mod_xa661dn623nj_module = {
    ...
    0,
    mod_xa661dn623nj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xa661dn623nj(void)
{
    PyObject* mod;
    static void* Pymod_xa661dn623nj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xa661dn623nj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xa661dn623nj_API, "mod_xa661dn623nj._C_API", NULL);
