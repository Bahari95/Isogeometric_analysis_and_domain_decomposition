...
#define MOD_SC9MJQJ8MSON_WRAPPER

#include "mod_sc9mjqj8mson_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sc9mjqj8mson_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_sc9mjqj8mson_module = {
    ...
    0,
    mod_sc9mjqj8mson_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sc9mjqj8mson(void)
{
    PyObject* mod;
    static void* Pymod_sc9mjqj8mson_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sc9mjqj8mson_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sc9mjqj8mson_API, "mod_sc9mjqj8mson._C_API", NULL);
