...
#define MOD_KMPLFGF6J72X_WRAPPER

#include "mod_kmplfgf6j72x_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kmplfgf6j72x_methods[] = {
    {
...
static struct PyModuleDef mod_kmplfgf6j72x_module = {
    ...
    0,
    mod_kmplfgf6j72x_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kmplfgf6j72x(void)
{
    PyObject* mod;
    static void* Pymod_kmplfgf6j72x_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kmplfgf6j72x_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kmplfgf6j72x_API, "mod_kmplfgf6j72x._C_API", NULL);
