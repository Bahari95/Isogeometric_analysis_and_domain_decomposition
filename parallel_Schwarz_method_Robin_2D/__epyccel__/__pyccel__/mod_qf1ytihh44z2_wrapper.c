...
#define MOD_QF1YTIHH44Z2_WRAPPER

#include "mod_qf1ytihh44z2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qf1ytihh44z2_methods[] = {
    {
...
static struct PyModuleDef mod_qf1ytihh44z2_module = {
    ...
    0,
    mod_qf1ytihh44z2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qf1ytihh44z2(void)
{
    PyObject* mod;
    static void* Pymod_qf1ytihh44z2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qf1ytihh44z2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qf1ytihh44z2_API, "mod_qf1ytihh44z2._C_API", NULL);
