...
#define MOD_RIEEJ1CB2YT6_WRAPPER

#include "mod_rieej1cb2yt6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rieej1cb2yt6_methods[] = {
    {
...
static struct PyModuleDef mod_rieej1cb2yt6_module = {
    ...
    0,
    mod_rieej1cb2yt6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rieej1cb2yt6(void)
{
    PyObject* mod;
    static void* Pymod_rieej1cb2yt6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rieej1cb2yt6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rieej1cb2yt6_API, "mod_rieej1cb2yt6._C_API", NULL);
