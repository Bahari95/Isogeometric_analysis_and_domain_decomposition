...
#define MOD_Z942L3KDUACK_WRAPPER

#include "mod_z942l3kduack_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_z942l3kduack_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_z942l3kduack_module = {
    ...
    0,
    mod_z942l3kduack_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_z942l3kduack(void)
{
    PyObject* mod;
    static void* Pymod_z942l3kduack_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_z942l3kduack_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_z942l3kduack_API, "mod_z942l3kduack._C_API", NULL);
