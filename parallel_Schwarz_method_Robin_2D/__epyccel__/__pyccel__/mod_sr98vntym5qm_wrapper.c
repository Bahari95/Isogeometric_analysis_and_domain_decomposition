...
#define MOD_SR98VNTYM5QM_WRAPPER

#include "mod_sr98vntym5qm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sr98vntym5qm_methods[] = {
    {
...
static struct PyModuleDef mod_sr98vntym5qm_module = {
    ...
    0,
    mod_sr98vntym5qm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sr98vntym5qm(void)
{
    PyObject* mod;
    static void* Pymod_sr98vntym5qm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sr98vntym5qm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sr98vntym5qm_API, "mod_sr98vntym5qm._C_API", NULL);
