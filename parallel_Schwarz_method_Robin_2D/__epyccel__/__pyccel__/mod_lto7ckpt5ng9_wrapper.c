...
#define MOD_LTO7CKPT5NG9_WRAPPER

#include "mod_lto7ckpt5ng9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lto7ckpt5ng9_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lto7ckpt5ng9_module = {
    ...
    0,
    mod_lto7ckpt5ng9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lto7ckpt5ng9(void)
{
    PyObject* mod;
    static void* Pymod_lto7ckpt5ng9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lto7ckpt5ng9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lto7ckpt5ng9_API, "mod_lto7ckpt5ng9._C_API", NULL);
