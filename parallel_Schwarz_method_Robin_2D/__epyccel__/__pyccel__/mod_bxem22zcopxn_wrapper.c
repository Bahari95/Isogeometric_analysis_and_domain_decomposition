...
#define MOD_BXEM22ZCOPXN_WRAPPER

#include "mod_bxem22zcopxn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bxem22zcopxn_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_bxem22zcopxn_module = {
    ...
    0,
    mod_bxem22zcopxn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bxem22zcopxn(void)
{
    PyObject* mod;
    static void* Pymod_bxem22zcopxn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bxem22zcopxn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bxem22zcopxn_API, "mod_bxem22zcopxn._C_API", NULL);
