...
#define MOD_BHPCXC087VIY_WRAPPER

#include "mod_bhpcxc087viy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bhpcxc087viy_methods[] = {
    {
...
static struct PyModuleDef mod_bhpcxc087viy_module = {
    ...
    0,
    mod_bhpcxc087viy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bhpcxc087viy(void)
{
    PyObject* mod;
    static void* Pymod_bhpcxc087viy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bhpcxc087viy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bhpcxc087viy_API, "mod_bhpcxc087viy._C_API", NULL);
