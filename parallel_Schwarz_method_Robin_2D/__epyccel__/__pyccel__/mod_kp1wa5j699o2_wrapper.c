...
#define MOD_KP1WA5J699O2_WRAPPER

#include "mod_kp1wa5j699o2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kp1wa5j699o2_methods[] = {
    {
...
static struct PyModuleDef mod_kp1wa5j699o2_module = {
    ...
    0,
    mod_kp1wa5j699o2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kp1wa5j699o2(void)
{
    PyObject* mod;
    static void* Pymod_kp1wa5j699o2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kp1wa5j699o2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kp1wa5j699o2_API, "mod_kp1wa5j699o2._C_API", NULL);
