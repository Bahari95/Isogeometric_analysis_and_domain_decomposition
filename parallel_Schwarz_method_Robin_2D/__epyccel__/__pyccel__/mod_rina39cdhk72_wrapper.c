...
#define MOD_RINA39CDHK72_WRAPPER

#include "mod_rina39cdhk72_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rina39cdhk72_methods[] = {
    {
...
static struct PyModuleDef mod_rina39cdhk72_module = {
    ...
    0,
    mod_rina39cdhk72_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rina39cdhk72(void)
{
    PyObject* mod;
    static void* Pymod_rina39cdhk72_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rina39cdhk72_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rina39cdhk72_API, "mod_rina39cdhk72._C_API", NULL);
