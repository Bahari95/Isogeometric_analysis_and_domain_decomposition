...
#define MOD_PBVASOO15J8M_WRAPPER

#include "mod_pbvasoo15j8m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pbvasoo15j8m_methods[] = {
    {
...
static struct PyModuleDef mod_pbvasoo15j8m_module = {
    ...
    0,
    mod_pbvasoo15j8m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pbvasoo15j8m(void)
{
    PyObject* mod;
    static void* Pymod_pbvasoo15j8m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pbvasoo15j8m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pbvasoo15j8m_API, "mod_pbvasoo15j8m._C_API", NULL);
