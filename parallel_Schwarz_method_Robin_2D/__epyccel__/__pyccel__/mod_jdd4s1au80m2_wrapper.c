...
#define MOD_JDD4S1AU80M2_WRAPPER

#include "mod_jdd4s1au80m2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jdd4s1au80m2_methods[] = {
    {
...
static struct PyModuleDef mod_jdd4s1au80m2_module = {
    ...
    0,
    mod_jdd4s1au80m2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jdd4s1au80m2(void)
{
    PyObject* mod;
    static void* Pymod_jdd4s1au80m2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jdd4s1au80m2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jdd4s1au80m2_API, "mod_jdd4s1au80m2._C_API", NULL);
