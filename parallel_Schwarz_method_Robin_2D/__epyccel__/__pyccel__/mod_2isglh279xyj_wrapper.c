...
#define MOD_2ISGLH279XYJ_WRAPPER

#include "mod_2isglh279xyj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_2isglh279xyj_methods[] = {
    {
...
static struct PyModuleDef mod_2isglh279xyj_module = {
    ...
    0,
    mod_2isglh279xyj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_2isglh279xyj(void)
{
    PyObject* mod;
    static void* Pymod_2isglh279xyj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_2isglh279xyj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_2isglh279xyj_API, "mod_2isglh279xyj._C_API", NULL);
