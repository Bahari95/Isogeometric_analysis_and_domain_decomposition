...
#define MOD_SM2NOUUY41UP_WRAPPER

#include "mod_sm2nouuy41up_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sm2nouuy41up_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_sm2nouuy41up_module = {
    ...
    0,
    mod_sm2nouuy41up_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sm2nouuy41up(void)
{
    PyObject* mod;
    static void* Pymod_sm2nouuy41up_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sm2nouuy41up_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sm2nouuy41up_API, "mod_sm2nouuy41up._C_API", NULL);
