...
#define MOD_9ALFXQHXZAGE_WRAPPER

#include "mod_9alfxqhxzage_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9alfxqhxzage_methods[] = {
    {
...
static struct PyModuleDef mod_9alfxqhxzage_module = {
    ...
    0,
    mod_9alfxqhxzage_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9alfxqhxzage(void)
{
    PyObject* mod;
    static void* Pymod_9alfxqhxzage_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9alfxqhxzage_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9alfxqhxzage_API, "mod_9alfxqhxzage._C_API", NULL);
