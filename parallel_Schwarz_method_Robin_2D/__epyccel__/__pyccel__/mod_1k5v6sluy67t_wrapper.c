...
#define MOD_1K5V6SLUY67T_WRAPPER

#include "mod_1k5v6sluy67t_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1k5v6sluy67t_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1k5v6sluy67t_module = {
    ...
    0,
    mod_1k5v6sluy67t_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1k5v6sluy67t(void)
{
    PyObject* mod;
    static void* Pymod_1k5v6sluy67t_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1k5v6sluy67t_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1k5v6sluy67t_API, "mod_1k5v6sluy67t._C_API", NULL);
