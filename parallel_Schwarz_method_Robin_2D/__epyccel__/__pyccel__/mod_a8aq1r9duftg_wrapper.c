...
#define MOD_A8AQ1R9DUFTG_WRAPPER

#include "mod_a8aq1r9duftg_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a8aq1r9duftg_methods[] = {
    {
...
static struct PyModuleDef mod_a8aq1r9duftg_module = {
    ...
    0,
    mod_a8aq1r9duftg_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a8aq1r9duftg(void)
{
    PyObject* mod;
    static void* Pymod_a8aq1r9duftg_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a8aq1r9duftg_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a8aq1r9duftg_API, "mod_a8aq1r9duftg._C_API", NULL);
