...
#define MOD_FKRPJORKEJZJ_WRAPPER

#include "mod_fkrpjorkejzj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fkrpjorkejzj_methods[] = {
    {
...
static struct PyModuleDef mod_fkrpjorkejzj_module = {
    ...
    0,
    mod_fkrpjorkejzj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fkrpjorkejzj(void)
{
    PyObject* mod;
    static void* Pymod_fkrpjorkejzj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fkrpjorkejzj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fkrpjorkejzj_API, "mod_fkrpjorkejzj._C_API", NULL);
