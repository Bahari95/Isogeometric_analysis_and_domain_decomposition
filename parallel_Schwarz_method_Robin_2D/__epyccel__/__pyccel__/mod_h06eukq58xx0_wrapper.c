...
#define MOD_H06EUKQ58XX0_WRAPPER

#include "mod_h06eukq58xx0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_h06eukq58xx0_methods[] = {
    {
...
static struct PyModuleDef mod_h06eukq58xx0_module = {
    ...
    0,
    mod_h06eukq58xx0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_h06eukq58xx0(void)
{
    PyObject* mod;
    static void* Pymod_h06eukq58xx0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_h06eukq58xx0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_h06eukq58xx0_API, "mod_h06eukq58xx0._C_API", NULL);
