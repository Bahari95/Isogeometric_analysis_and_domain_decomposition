...
#define MOD_PRA366JW9910_WRAPPER

#include "mod_pra366jw9910_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pra366jw9910_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_pra366jw9910_module = {
    ...
    0,
    mod_pra366jw9910_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pra366jw9910(void)
{
    PyObject* mod;
    static void* Pymod_pra366jw9910_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pra366jw9910_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pra366jw9910_API, "mod_pra366jw9910._C_API", NULL);
