...
#define MOD_FURY0ZHMBVO5_WRAPPER

#include "mod_fury0zhmbvo5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fury0zhmbvo5_methods[] = {
    {
...
static struct PyModuleDef mod_fury0zhmbvo5_module = {
    ...
    0,
    mod_fury0zhmbvo5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fury0zhmbvo5(void)
{
    PyObject* mod;
    static void* Pymod_fury0zhmbvo5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fury0zhmbvo5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fury0zhmbvo5_API, "mod_fury0zhmbvo5._C_API", NULL);
