...
#define MOD_Q4MVBOEC4LGV_WRAPPER

#include "mod_q4mvboec4lgv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_q4mvboec4lgv_methods[] = {
    {
...
static struct PyModuleDef mod_q4mvboec4lgv_module = {
    ...
    0,
    mod_q4mvboec4lgv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_q4mvboec4lgv(void)
{
    PyObject* mod;
    static void* Pymod_q4mvboec4lgv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_q4mvboec4lgv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_q4mvboec4lgv_API, "mod_q4mvboec4lgv._C_API", NULL);
