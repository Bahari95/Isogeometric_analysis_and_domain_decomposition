...
#define MOD_BADH96N5E0D9_WRAPPER

#include "mod_badh96n5e0d9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_badh96n5e0d9_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_badh96n5e0d9_module = {
    ...
    0,
    mod_badh96n5e0d9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_badh96n5e0d9(void)
{
    PyObject* mod;
    static void* Pymod_badh96n5e0d9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_badh96n5e0d9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_badh96n5e0d9_API, "mod_badh96n5e0d9._C_API", NULL);
