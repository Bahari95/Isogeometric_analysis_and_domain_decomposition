...
#define MOD_IIIYALG95RQV_WRAPPER

#include "mod_iiiyalg95rqv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iiiyalg95rqv_methods[] = {
    {
...
static struct PyModuleDef mod_iiiyalg95rqv_module = {
    ...
    0,
    mod_iiiyalg95rqv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iiiyalg95rqv(void)
{
    PyObject* mod;
    static void* Pymod_iiiyalg95rqv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iiiyalg95rqv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iiiyalg95rqv_API, "mod_iiiyalg95rqv._C_API", NULL);
