...
#define MOD_SRRPQBLJYZ99_WRAPPER

#include "mod_srrpqbljyz99_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_srrpqbljyz99_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_srrpqbljyz99_module = {
    ...
    0,
    mod_srrpqbljyz99_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_srrpqbljyz99(void)
{
    PyObject* mod;
    static void* Pymod_srrpqbljyz99_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_srrpqbljyz99_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_srrpqbljyz99_API, "mod_srrpqbljyz99._C_API", NULL);
