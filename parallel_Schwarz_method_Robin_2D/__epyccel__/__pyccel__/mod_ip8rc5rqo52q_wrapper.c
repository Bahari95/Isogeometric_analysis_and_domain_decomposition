...
#define MOD_IP8RC5RQO52Q_WRAPPER

#include "mod_ip8rc5rqo52q_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ip8rc5rqo52q_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ip8rc5rqo52q_module = {
    ...
    0,
    mod_ip8rc5rqo52q_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ip8rc5rqo52q(void)
{
    PyObject* mod;
    static void* Pymod_ip8rc5rqo52q_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ip8rc5rqo52q_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ip8rc5rqo52q_API, "mod_ip8rc5rqo52q._C_API", NULL);
