...
#define MOD_ZU58BWVYTEIY_WRAPPER

#include "mod_zu58bwvyteiy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zu58bwvyteiy_methods[] = {
    {
...
static struct PyModuleDef mod_zu58bwvyteiy_module = {
    ...
    0,
    mod_zu58bwvyteiy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zu58bwvyteiy(void)
{
    PyObject* mod;
    static void* Pymod_zu58bwvyteiy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zu58bwvyteiy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zu58bwvyteiy_API, "mod_zu58bwvyteiy._C_API", NULL);
