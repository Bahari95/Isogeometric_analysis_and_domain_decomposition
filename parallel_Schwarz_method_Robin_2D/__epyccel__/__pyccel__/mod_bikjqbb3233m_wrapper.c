...
#define MOD_BIKJQBB3233M_WRAPPER

#include "mod_bikjqbb3233m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bikjqbb3233m_methods[] = {
    {
...
static struct PyModuleDef mod_bikjqbb3233m_module = {
    ...
    0,
    mod_bikjqbb3233m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bikjqbb3233m(void)
{
    PyObject* mod;
    static void* Pymod_bikjqbb3233m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bikjqbb3233m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bikjqbb3233m_API, "mod_bikjqbb3233m._C_API", NULL);
