...
#define MOD_21G5C5TKES3N_WRAPPER

#include "mod_21g5c5tkes3n_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_21g5c5tkes3n_methods[] = {
    {
...
static struct PyModuleDef mod_21g5c5tkes3n_module = {
    ...
    0,
    mod_21g5c5tkes3n_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_21g5c5tkes3n(void)
{
    PyObject* mod;
    static void* Pymod_21g5c5tkes3n_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_21g5c5tkes3n_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_21g5c5tkes3n_API, "mod_21g5c5tkes3n._C_API", NULL);
