...
#define MOD_3Y4AKN47Y8CG_WRAPPER

#include "mod_3y4akn47y8cg_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3y4akn47y8cg_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_3y4akn47y8cg_module = {
    ...
    0,
    mod_3y4akn47y8cg_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3y4akn47y8cg(void)
{
    PyObject* mod;
    static void* Pymod_3y4akn47y8cg_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3y4akn47y8cg_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3y4akn47y8cg_API, "mod_3y4akn47y8cg._C_API", NULL);
