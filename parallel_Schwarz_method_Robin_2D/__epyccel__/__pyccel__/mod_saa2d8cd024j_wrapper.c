...
#define MOD_SAA2D8CD024J_WRAPPER

#include "mod_saa2d8cd024j_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_saa2d8cd024j_methods[] = {
    {
...
static struct PyModuleDef mod_saa2d8cd024j_module = {
    ...
    0,
    mod_saa2d8cd024j_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_saa2d8cd024j(void)
{
    PyObject* mod;
    static void* Pymod_saa2d8cd024j_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_saa2d8cd024j_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_saa2d8cd024j_API, "mod_saa2d8cd024j._C_API", NULL);
