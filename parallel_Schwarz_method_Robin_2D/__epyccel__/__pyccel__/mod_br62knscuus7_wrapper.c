...
#define MOD_BR62KNSCUUS7_WRAPPER

#include "mod_br62knscuus7_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_br62knscuus7_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_br62knscuus7_module = {
    ...
    0,
    mod_br62knscuus7_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_br62knscuus7(void)
{
    PyObject* mod;
    static void* Pymod_br62knscuus7_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_br62knscuus7_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_br62knscuus7_API, "mod_br62knscuus7._C_API", NULL);
