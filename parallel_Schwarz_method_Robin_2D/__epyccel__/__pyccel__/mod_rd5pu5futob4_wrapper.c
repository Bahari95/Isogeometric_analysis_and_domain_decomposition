...
#define MOD_RD5PU5FUTOB4_WRAPPER

#include "mod_rd5pu5futob4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rd5pu5futob4_methods[] = {
    {
...
static struct PyModuleDef mod_rd5pu5futob4_module = {
    ...
    0,
    mod_rd5pu5futob4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rd5pu5futob4(void)
{
    PyObject* mod;
    static void* Pymod_rd5pu5futob4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rd5pu5futob4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rd5pu5futob4_API, "mod_rd5pu5futob4._C_API", NULL);
