...
#define MOD_UMH0CHG74R2M_WRAPPER

#include "mod_umh0chg74r2m_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_umh0chg74r2m_methods[] = {
    {
...
static struct PyModuleDef mod_umh0chg74r2m_module = {
    ...
    0,
    mod_umh0chg74r2m_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_umh0chg74r2m(void)
{
    PyObject* mod;
    static void* Pymod_umh0chg74r2m_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_umh0chg74r2m_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_umh0chg74r2m_API, "mod_umh0chg74r2m._C_API", NULL);
