...
#define MOD_MWUU2W0DBQ85_WRAPPER

#include "mod_mwuu2w0dbq85_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mwuu2w0dbq85_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_mwuu2w0dbq85_module = {
    ...
    0,
    mod_mwuu2w0dbq85_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mwuu2w0dbq85(void)
{
    PyObject* mod;
    static void* Pymod_mwuu2w0dbq85_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mwuu2w0dbq85_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mwuu2w0dbq85_API, "mod_mwuu2w0dbq85._C_API", NULL);
