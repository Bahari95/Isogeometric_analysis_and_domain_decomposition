...
#define MOD_M33HENZFNWJJ_WRAPPER

#include "mod_m33henzfnwjj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m33henzfnwjj_methods[] = {
    {
...
static struct PyModuleDef mod_m33henzfnwjj_module = {
    ...
    0,
    mod_m33henzfnwjj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m33henzfnwjj(void)
{
    PyObject* mod;
    static void* Pymod_m33henzfnwjj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m33henzfnwjj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m33henzfnwjj_API, "mod_m33henzfnwjj._C_API", NULL);
