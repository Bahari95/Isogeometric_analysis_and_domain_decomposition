...
#define MOD_VFJKRHPC0IV8_WRAPPER

#include "mod_vfjkrhpc0iv8_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vfjkrhpc0iv8_methods[] = {
    {
...
static struct PyModuleDef mod_vfjkrhpc0iv8_module = {
    ...
    0,
    mod_vfjkrhpc0iv8_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vfjkrhpc0iv8(void)
{
    PyObject* mod;
    static void* Pymod_vfjkrhpc0iv8_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vfjkrhpc0iv8_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vfjkrhpc0iv8_API, "mod_vfjkrhpc0iv8._C_API", NULL);
