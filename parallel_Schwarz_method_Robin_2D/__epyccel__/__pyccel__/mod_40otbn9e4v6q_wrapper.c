...
#define MOD_40OTBN9E4V6Q_WRAPPER

#include "mod_40otbn9e4v6q_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_40otbn9e4v6q_methods[] = {
    {
...
static struct PyModuleDef mod_40otbn9e4v6q_module = {
    ...
    0,
    mod_40otbn9e4v6q_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_40otbn9e4v6q(void)
{
    PyObject* mod;
    static void* Pymod_40otbn9e4v6q_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_40otbn9e4v6q_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_40otbn9e4v6q_API, "mod_40otbn9e4v6q._C_API", NULL);
