...
#define MOD_SSS53QJUC40N_WRAPPER

#include "mod_sss53qjuc40n_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sss53qjuc40n_methods[] = {
    {
...
static struct PyModuleDef mod_sss53qjuc40n_module = {
    ...
    0,
    mod_sss53qjuc40n_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sss53qjuc40n(void)
{
    PyObject* mod;
    static void* Pymod_sss53qjuc40n_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sss53qjuc40n_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sss53qjuc40n_API, "mod_sss53qjuc40n._C_API", NULL);
