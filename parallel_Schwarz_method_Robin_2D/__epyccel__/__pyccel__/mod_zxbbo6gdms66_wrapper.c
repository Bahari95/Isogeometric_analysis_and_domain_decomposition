...
#define MOD_ZXBBO6GDMS66_WRAPPER

#include "mod_zxbbo6gdms66_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zxbbo6gdms66_methods[] = {
    {
...
static struct PyModuleDef mod_zxbbo6gdms66_module = {
    ...
    0,
    mod_zxbbo6gdms66_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zxbbo6gdms66(void)
{
    PyObject* mod;
    static void* Pymod_zxbbo6gdms66_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zxbbo6gdms66_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zxbbo6gdms66_API, "mod_zxbbo6gdms66._C_API", NULL);
