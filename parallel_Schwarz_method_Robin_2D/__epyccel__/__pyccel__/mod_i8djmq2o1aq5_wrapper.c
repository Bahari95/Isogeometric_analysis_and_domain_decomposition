...
#define MOD_I8DJMQ2O1AQ5_WRAPPER

#include "mod_i8djmq2o1aq5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i8djmq2o1aq5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i8djmq2o1aq5_module = {
    ...
    0,
    mod_i8djmq2o1aq5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i8djmq2o1aq5(void)
{
    PyObject* mod;
    static void* Pymod_i8djmq2o1aq5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i8djmq2o1aq5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i8djmq2o1aq5_API, "mod_i8djmq2o1aq5._C_API", NULL);
