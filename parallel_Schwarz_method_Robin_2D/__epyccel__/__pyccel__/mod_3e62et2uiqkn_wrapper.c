...
#define MOD_3E62ET2UIQKN_WRAPPER

#include "mod_3e62et2uiqkn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3e62et2uiqkn_methods[] = {
    {
...
static struct PyModuleDef mod_3e62et2uiqkn_module = {
    ...
    0,
    mod_3e62et2uiqkn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3e62et2uiqkn(void)
{
    PyObject* mod;
    static void* Pymod_3e62et2uiqkn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3e62et2uiqkn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3e62et2uiqkn_API, "mod_3e62et2uiqkn._C_API", NULL);
