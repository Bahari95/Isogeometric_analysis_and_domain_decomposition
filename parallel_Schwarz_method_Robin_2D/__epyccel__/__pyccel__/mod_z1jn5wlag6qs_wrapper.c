...
#define MOD_Z1JN5WLAG6QS_WRAPPER

#include "mod_z1jn5wlag6qs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_z1jn5wlag6qs_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_z1jn5wlag6qs_module = {
    ...
    0,
    mod_z1jn5wlag6qs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_z1jn5wlag6qs(void)
{
    PyObject* mod;
    static void* Pymod_z1jn5wlag6qs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_z1jn5wlag6qs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_z1jn5wlag6qs_API, "mod_z1jn5wlag6qs._C_API", NULL);
