...
#define MOD_RNSQ4I4IIZGE_WRAPPER

#include "mod_rnsq4i4iizge_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rnsq4i4iizge_methods[] = {
    {
...
static struct PyModuleDef mod_rnsq4i4iizge_module = {
    ...
    0,
    mod_rnsq4i4iizge_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rnsq4i4iizge(void)
{
    PyObject* mod;
    static void* Pymod_rnsq4i4iizge_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rnsq4i4iizge_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rnsq4i4iizge_API, "mod_rnsq4i4iizge._C_API", NULL);
