...
#define MOD_0OMX51D8B51X_WRAPPER

#include "mod_0omx51d8b51x_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0omx51d8b51x_methods[] = {
    {
...
static struct PyModuleDef mod_0omx51d8b51x_module = {
    ...
    0,
    mod_0omx51d8b51x_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0omx51d8b51x(void)
{
    PyObject* mod;
    static void* Pymod_0omx51d8b51x_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0omx51d8b51x_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0omx51d8b51x_API, "mod_0omx51d8b51x._C_API", NULL);
