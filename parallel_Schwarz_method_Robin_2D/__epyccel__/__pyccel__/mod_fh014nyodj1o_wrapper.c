...
#define MOD_FH014NYODJ1O_WRAPPER

#include "mod_fh014nyodj1o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fh014nyodj1o_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_fh014nyodj1o_module = {
    ...
    0,
    mod_fh014nyodj1o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fh014nyodj1o(void)
{
    PyObject* mod;
    static void* Pymod_fh014nyodj1o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fh014nyodj1o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fh014nyodj1o_API, "mod_fh014nyodj1o._C_API", NULL);
