...
#define MOD_9UXE3G88AUEM_WRAPPER

#include "mod_9uxe3g88auem_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9uxe3g88auem_methods[] = {
    {
...
static struct PyModuleDef mod_9uxe3g88auem_module = {
    ...
    0,
    mod_9uxe3g88auem_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9uxe3g88auem(void)
{
    PyObject* mod;
    static void* Pymod_9uxe3g88auem_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9uxe3g88auem_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9uxe3g88auem_API, "mod_9uxe3g88auem._C_API", NULL);
