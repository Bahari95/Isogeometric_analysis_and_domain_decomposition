...
#define MOD_XLKNYHSGPYPK_WRAPPER

#include "mod_xlknyhsgpypk_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xlknyhsgpypk_methods[] = {
    {
...
static struct PyModuleDef mod_xlknyhsgpypk_module = {
    ...
    0,
    mod_xlknyhsgpypk_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xlknyhsgpypk(void)
{
    PyObject* mod;
    static void* Pymod_xlknyhsgpypk_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xlknyhsgpypk_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xlknyhsgpypk_API, "mod_xlknyhsgpypk._C_API", NULL);
