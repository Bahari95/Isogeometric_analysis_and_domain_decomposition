...
#define MOD_KKU0CBXGC0X9_WRAPPER

#include "mod_kku0cbxgc0x9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kku0cbxgc0x9_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_kku0cbxgc0x9_module = {
    ...
    0,
    mod_kku0cbxgc0x9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kku0cbxgc0x9(void)
{
    PyObject* mod;
    static void* Pymod_kku0cbxgc0x9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kku0cbxgc0x9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kku0cbxgc0x9_API, "mod_kku0cbxgc0x9._C_API", NULL);
