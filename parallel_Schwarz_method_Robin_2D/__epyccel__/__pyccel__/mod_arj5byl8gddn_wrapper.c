...
#define MOD_ARJ5BYL8GDDN_WRAPPER

#include "mod_arj5byl8gddn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_arj5byl8gddn_methods[] = {
    {
...
static struct PyModuleDef mod_arj5byl8gddn_module = {
    ...
    0,
    mod_arj5byl8gddn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_arj5byl8gddn(void)
{
    PyObject* mod;
    static void* Pymod_arj5byl8gddn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_arj5byl8gddn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_arj5byl8gddn_API, "mod_arj5byl8gddn._C_API", NULL);
