...
#define MOD_MFFOAIGSTR1B_WRAPPER

#include "mod_mffoaigstr1b_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mffoaigstr1b_methods[] = {
    {
...
static struct PyModuleDef mod_mffoaigstr1b_module = {
    ...
    0,
    mod_mffoaigstr1b_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mffoaigstr1b(void)
{
    PyObject* mod;
    static void* Pymod_mffoaigstr1b_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mffoaigstr1b_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mffoaigstr1b_API, "mod_mffoaigstr1b._C_API", NULL);
