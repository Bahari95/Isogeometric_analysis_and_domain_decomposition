...
#define MOD_JRSN2GHEJH5N_WRAPPER

#include "mod_jrsn2ghejh5n_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jrsn2ghejh5n_methods[] = {
    {
...
static struct PyModuleDef mod_jrsn2ghejh5n_module = {
    ...
    0,
    mod_jrsn2ghejh5n_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jrsn2ghejh5n(void)
{
    PyObject* mod;
    static void* Pymod_jrsn2ghejh5n_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jrsn2ghejh5n_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jrsn2ghejh5n_API, "mod_jrsn2ghejh5n._C_API", NULL);
