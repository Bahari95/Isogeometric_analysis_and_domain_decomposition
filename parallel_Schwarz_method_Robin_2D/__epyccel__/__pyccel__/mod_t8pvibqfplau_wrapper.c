...
#define MOD_T8PVIBQFPLAU_WRAPPER

#include "mod_t8pvibqfplau_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_t8pvibqfplau_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_t8pvibqfplau_module = {
    ...
    0,
    mod_t8pvibqfplau_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_t8pvibqfplau(void)
{
    PyObject* mod;
    static void* Pymod_t8pvibqfplau_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_t8pvibqfplau_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_t8pvibqfplau_API, "mod_t8pvibqfplau._C_API", NULL);
