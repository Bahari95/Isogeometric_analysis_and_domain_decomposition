...
#define MOD_S5Y6HWZ4MYBI_WRAPPER

#include "mod_s5y6hwz4mybi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_s5y6hwz4mybi_methods[] = {
    {
...
static struct PyModuleDef mod_s5y6hwz4mybi_module = {
    ...
    0,
    mod_s5y6hwz4mybi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_s5y6hwz4mybi(void)
{
    PyObject* mod;
    static void* Pymod_s5y6hwz4mybi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_s5y6hwz4mybi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_s5y6hwz4mybi_API, "mod_s5y6hwz4mybi._C_API", NULL);
