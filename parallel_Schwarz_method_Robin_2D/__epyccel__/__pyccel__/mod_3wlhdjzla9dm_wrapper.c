...
#define MOD_3WLHDJZLA9DM_WRAPPER

#include "mod_3wlhdjzla9dm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3wlhdjzla9dm_methods[] = {
    {
...
static struct PyModuleDef mod_3wlhdjzla9dm_module = {
    ...
    0,
    mod_3wlhdjzla9dm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3wlhdjzla9dm(void)
{
    PyObject* mod;
    static void* Pymod_3wlhdjzla9dm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3wlhdjzla9dm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3wlhdjzla9dm_API, "mod_3wlhdjzla9dm._C_API", NULL);
