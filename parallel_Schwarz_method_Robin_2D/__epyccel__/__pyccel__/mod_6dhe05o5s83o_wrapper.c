...
#define MOD_6DHE05O5S83O_WRAPPER

#include "mod_6dhe05o5s83o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6dhe05o5s83o_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_6dhe05o5s83o_module = {
    ...
    0,
    mod_6dhe05o5s83o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6dhe05o5s83o(void)
{
    PyObject* mod;
    static void* Pymod_6dhe05o5s83o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6dhe05o5s83o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6dhe05o5s83o_API, "mod_6dhe05o5s83o._C_API", NULL);
