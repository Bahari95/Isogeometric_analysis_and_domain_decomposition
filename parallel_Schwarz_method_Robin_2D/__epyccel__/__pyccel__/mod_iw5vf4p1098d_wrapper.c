...
#define MOD_IW5VF4P1098D_WRAPPER

#include "mod_iw5vf4p1098d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iw5vf4p1098d_methods[] = {
    {
...
static struct PyModuleDef mod_iw5vf4p1098d_module = {
    ...
    0,
    mod_iw5vf4p1098d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iw5vf4p1098d(void)
{
    PyObject* mod;
    static void* Pymod_iw5vf4p1098d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iw5vf4p1098d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iw5vf4p1098d_API, "mod_iw5vf4p1098d._C_API", NULL);
