...
#define MOD_XMCW0SYUOEFM_WRAPPER

#include "mod_xmcw0syuoefm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xmcw0syuoefm_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_xmcw0syuoefm_module = {
    ...
    0,
    mod_xmcw0syuoefm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xmcw0syuoefm(void)
{
    PyObject* mod;
    static void* Pymod_xmcw0syuoefm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xmcw0syuoefm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xmcw0syuoefm_API, "mod_xmcw0syuoefm._C_API", NULL);
