...
#define MOD_LJ8K3QVZVJJM_WRAPPER

#include "mod_lj8k3qvzvjjm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lj8k3qvzvjjm_methods[] = {
    {
...
static struct PyModuleDef mod_lj8k3qvzvjjm_module = {
    ...
    0,
    mod_lj8k3qvzvjjm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lj8k3qvzvjjm(void)
{
    PyObject* mod;
    static void* Pymod_lj8k3qvzvjjm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lj8k3qvzvjjm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lj8k3qvzvjjm_API, "mod_lj8k3qvzvjjm._C_API", NULL);
