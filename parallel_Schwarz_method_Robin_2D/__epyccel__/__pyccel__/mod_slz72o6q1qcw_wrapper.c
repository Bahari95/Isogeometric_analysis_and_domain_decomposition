...
#define MOD_SLZ72O6Q1QCW_WRAPPER

#include "mod_slz72o6q1qcw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_slz72o6q1qcw_methods[] = {
    {
...
static struct PyModuleDef mod_slz72o6q1qcw_module = {
    ...
    0,
    mod_slz72o6q1qcw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_slz72o6q1qcw(void)
{
    PyObject* mod;
    static void* Pymod_slz72o6q1qcw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_slz72o6q1qcw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_slz72o6q1qcw_API, "mod_slz72o6q1qcw._C_API", NULL);
