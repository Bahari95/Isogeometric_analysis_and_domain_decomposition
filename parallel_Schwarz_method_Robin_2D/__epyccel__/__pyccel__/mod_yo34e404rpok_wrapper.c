...
#define MOD_YO34E404RPOK_WRAPPER

#include "mod_yo34e404rpok_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yo34e404rpok_methods[] = {
    {
...
static struct PyModuleDef mod_yo34e404rpok_module = {
    ...
    0,
    mod_yo34e404rpok_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yo34e404rpok(void)
{
    PyObject* mod;
    static void* Pymod_yo34e404rpok_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yo34e404rpok_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yo34e404rpok_API, "mod_yo34e404rpok._C_API", NULL);
