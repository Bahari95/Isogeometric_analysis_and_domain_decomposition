...
#define MOD_RC9FFL9E1NV1_WRAPPER

#include "mod_rc9ffl9e1nv1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_rc9ffl9e1nv1_methods[] = {
    {
...
static struct PyModuleDef mod_rc9ffl9e1nv1_module = {
    ...
    0,
    mod_rc9ffl9e1nv1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rc9ffl9e1nv1(void)
{
    PyObject* mod;
    static void* Pymod_rc9ffl9e1nv1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_rc9ffl9e1nv1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_rc9ffl9e1nv1_API, "mod_rc9ffl9e1nv1._C_API", NULL);
