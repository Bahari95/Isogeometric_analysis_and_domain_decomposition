...
#define MOD_GZSQTDFMJLU6_WRAPPER

#include "mod_gzsqtdfmjlu6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gzsqtdfmjlu6_methods[] = {
    {
...
static struct PyModuleDef mod_gzsqtdfmjlu6_module = {
    ...
    0,
    mod_gzsqtdfmjlu6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gzsqtdfmjlu6(void)
{
    PyObject* mod;
    static void* Pymod_gzsqtdfmjlu6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gzsqtdfmjlu6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gzsqtdfmjlu6_API, "mod_gzsqtdfmjlu6._C_API", NULL);
