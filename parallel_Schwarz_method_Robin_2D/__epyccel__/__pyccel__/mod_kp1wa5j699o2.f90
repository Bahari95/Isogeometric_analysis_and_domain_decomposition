module mod_kp1wa5j699o2
  ...
  subroutine assemble_matrix_un_ex01(ne1, ne2, p1, p2, spans_1, spans_2, &
        ...
        domain_nb, S_DDM, ovlp_value, vector_m1, vector_m2, matrix)
    ...
    write(stdout, '(A, A, I0, A, A, A, A)', advance="yes") 'Inside &
    &assemble_stiffness2D, domain_nb:' , ' ' , domain_nb , ' ' , '&
    &Type:' , ' ' , '<class ' // ACHAR(39) // 'int' // ACHAR(39) &
          // '>'
    !...
    ...
    if (domain_nb == 0_i64) then
      ...
      do ie2 = 0_i64, ne2 - 1_i64
        ...
        do g2 = 0_i64, k2 - 1_i64
          ...
          F2y = 0.0_f64
          do il_2 = 0_i64, p2 + 1_i64 - 1_i64
            bj_x = basis_1(g1, 1_i64, p1, ie1) * basis_2(g2, 0_i64, il_2 &
                  , ie2)
            bj_y = basis_1(g1, 0_i64, p1, ie1) * basis_2(g2, 1_i64, il_2 &
                  , ie2)
            coeff_m1 = lcoeffs_m1(p2, p1)
            F1x = F1x + coeff_m1 * bj_x
            F1y = F1y + coeff_m1 * bj_y
            coeff_m2 = lcoeffs_m2(il_2, p1)
            F2x = F2x + coeff_m2 * bj_x
            F2y = F2y + coeff_m2 * bj_y
          end do
          J_mat(g2, 0_i64) = sqrt(F1y * F1y + F2y * F2y)
        end do
        do il_2 = 0_i64, p2 + 1_i64 - 1_i64
          do jl_2 = 0_i64, p2 + 1_i64 - 1_i64
            i2 = i_span_2 - p2 + il_2
            ...
            do g2 = 0_i64, k2 - 1_i64
              ...
              bj_0 = basis_2(g2, 0_i64, jl_2, ie2)
              wvol = weights_2(g2, ie2) * J_mat(g2, 0_i64)
              !...
              v = v + S_DDM * bi_0 * bj_0 * wvol
            end do
            matrix(p2 + j2 - i2, p1, p2 + i2, i_span_1 + p1) = matrix(p2 &
                  + j2 - i2, p1, p2 + i2, i_span_1 + p1) + v
          end do
        end do
      end do
    else
      ...
      do ie2 = 0_i64, ne2 - 1_i64
        ...
        do g2 = 0_i64, k2 - 1_i64
          ...
          F2y = 0.0_f64
          do il_2 = 0_i64, p2 + 1_i64 - 1_i64
            bj_x = basis_1(g1, 1_i64, 0_i64, ie1) * basis_2(g2, 0_i64, &
                  il_2, ie2)
            bj_y = basis_1(g1, 0_i64, 0_i64, ie1) * basis_2(g2, 1_i64, &
                  il_2, ie2)
            coeff_m1 = lcoeffs_m1(p2, 0_i64)
            F1x = F1x + coeff_m1 * bj_x
            F1y = F1y + coeff_m1 * bj_y
            coeff_m2 = lcoeffs_m2(il_2, 0_i64)
            F2x = F2x + coeff_m2 * bj_x
            F2y = F2y + coeff_m2 * bj_y
          end do
          J_mat(g2, 0_i64) = sqrt(F1y * F1y + F2y * F2y)
        ...
        do il_2 = 0_i64, p2 + 1_i64 - 1_i64
          do jl_2 = 0_i64, p2 + 1_i64 - 1_i64
            ...
            matrix(p2 + j2 - i2, p1, p2 + i2, p1) = matrix(p2 + j2 - i2, &
                  p1, p2 + i2, p1) + v
          end do
        end do
      end do
