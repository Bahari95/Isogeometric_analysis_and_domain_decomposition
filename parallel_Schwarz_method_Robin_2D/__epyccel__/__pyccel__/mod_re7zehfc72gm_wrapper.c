...
#define MOD_RE7ZEHFC72GM_WRAPPER

#include "mod_re7zehfc72gm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_re7zehfc72gm_methods[] = {
    {
...
static struct PyModuleDef mod_re7zehfc72gm_module = {
    ...
    0,
    mod_re7zehfc72gm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_re7zehfc72gm(void)
{
    PyObject* mod;
    static void* Pymod_re7zehfc72gm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_re7zehfc72gm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_re7zehfc72gm_API, "mod_re7zehfc72gm._C_API", NULL);
