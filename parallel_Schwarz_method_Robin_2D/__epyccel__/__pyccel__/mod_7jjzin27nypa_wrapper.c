...
#define MOD_7JJZIN27NYPA_WRAPPER

#include "mod_7jjzin27nypa_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7jjzin27nypa_methods[] = {
    {
...
static struct PyModuleDef mod_7jjzin27nypa_module = {
    ...
    0,
    mod_7jjzin27nypa_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7jjzin27nypa(void)
{
    PyObject* mod;
    static void* Pymod_7jjzin27nypa_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7jjzin27nypa_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7jjzin27nypa_API, "mod_7jjzin27nypa._C_API", NULL);
