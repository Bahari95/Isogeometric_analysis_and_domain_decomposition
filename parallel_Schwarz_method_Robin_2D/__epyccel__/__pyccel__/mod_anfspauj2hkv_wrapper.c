...
#define MOD_ANFSPAUJ2HKV_WRAPPER

#include "mod_anfspauj2hkv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_anfspauj2hkv_methods[] = {
    {
...
static struct PyModuleDef mod_anfspauj2hkv_module = {
    ...
    0,
    mod_anfspauj2hkv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_anfspauj2hkv(void)
{
    PyObject* mod;
    static void* Pymod_anfspauj2hkv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_anfspauj2hkv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_anfspauj2hkv_API, "mod_anfspauj2hkv._C_API", NULL);
