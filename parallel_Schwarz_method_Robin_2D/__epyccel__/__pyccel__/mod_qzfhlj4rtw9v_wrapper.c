...
#define MOD_QZFHLJ4RTW9V_WRAPPER

#include "mod_qzfhlj4rtw9v_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qzfhlj4rtw9v_methods[] = {
    {
...
static struct PyModuleDef mod_qzfhlj4rtw9v_module = {
    ...
    0,
    mod_qzfhlj4rtw9v_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qzfhlj4rtw9v(void)
{
    PyObject* mod;
    static void* Pymod_qzfhlj4rtw9v_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qzfhlj4rtw9v_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qzfhlj4rtw9v_API, "mod_qzfhlj4rtw9v._C_API", NULL);
