...
#define MOD_EXTO7EX7NAC3_WRAPPER

#include "mod_exto7ex7nac3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_exto7ex7nac3_methods[] = {
    {
...
static struct PyModuleDef mod_exto7ex7nac3_module = {
    ...
    0,
    mod_exto7ex7nac3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_exto7ex7nac3(void)
{
    PyObject* mod;
    static void* Pymod_exto7ex7nac3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_exto7ex7nac3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_exto7ex7nac3_API, "mod_exto7ex7nac3._C_API", NULL);
