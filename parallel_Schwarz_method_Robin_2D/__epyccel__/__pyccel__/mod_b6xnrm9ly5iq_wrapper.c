...
#define MOD_B6XNRM9LY5IQ_WRAPPER

#include "mod_b6xnrm9ly5iq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_b6xnrm9ly5iq_methods[] = {
    {
...
static struct PyModuleDef mod_b6xnrm9ly5iq_module = {
    ...
    0,
    mod_b6xnrm9ly5iq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_b6xnrm9ly5iq(void)
{
    PyObject* mod;
    static void* Pymod_b6xnrm9ly5iq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_b6xnrm9ly5iq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_b6xnrm9ly5iq_API, "mod_b6xnrm9ly5iq._C_API", NULL);
