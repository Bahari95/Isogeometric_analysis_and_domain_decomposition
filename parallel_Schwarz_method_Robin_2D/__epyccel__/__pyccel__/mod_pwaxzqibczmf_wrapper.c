...
#define MOD_PWAXZQIBCZMF_WRAPPER

#include "mod_pwaxzqibczmf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pwaxzqibczmf_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_pwaxzqibczmf_module = {
    ...
    0,
    mod_pwaxzqibczmf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pwaxzqibczmf(void)
{
    PyObject* mod;
    static void* Pymod_pwaxzqibczmf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pwaxzqibczmf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pwaxzqibczmf_API, "mod_pwaxzqibczmf._C_API", NULL);
