...
#define MOD_4TKGH7QQ4G8D_WRAPPER

#include "mod_4tkgh7qq4g8d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4tkgh7qq4g8d_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_4tkgh7qq4g8d_module = {
    ...
    0,
    mod_4tkgh7qq4g8d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4tkgh7qq4g8d(void)
{
    PyObject* mod;
    static void* Pymod_4tkgh7qq4g8d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4tkgh7qq4g8d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4tkgh7qq4g8d_API, "mod_4tkgh7qq4g8d._C_API", NULL);
