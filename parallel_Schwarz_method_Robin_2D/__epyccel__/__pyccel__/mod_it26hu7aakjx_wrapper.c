...
#define MOD_IT26HU7AAKJX_WRAPPER

#include "mod_it26hu7aakjx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_it26hu7aakjx_methods[] = {
    {
...
static struct PyModuleDef mod_it26hu7aakjx_module = {
    ...
    0,
    mod_it26hu7aakjx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_it26hu7aakjx(void)
{
    PyObject* mod;
    static void* Pymod_it26hu7aakjx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_it26hu7aakjx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_it26hu7aakjx_API, "mod_it26hu7aakjx._C_API", NULL);
