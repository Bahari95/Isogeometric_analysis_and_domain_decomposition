...
#define MOD_LLI4UECN7AKD_WRAPPER

#include "mod_lli4uecn7akd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lli4uecn7akd_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lli4uecn7akd_module = {
    ...
    0,
    mod_lli4uecn7akd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lli4uecn7akd(void)
{
    PyObject* mod;
    static void* Pymod_lli4uecn7akd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lli4uecn7akd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lli4uecn7akd_API, "mod_lli4uecn7akd._C_API", NULL);
