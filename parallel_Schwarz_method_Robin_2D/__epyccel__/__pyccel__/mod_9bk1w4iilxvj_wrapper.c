...
#define MOD_9BK1W4IILXVJ_WRAPPER

#include "mod_9bk1w4iilxvj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9bk1w4iilxvj_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9bk1w4iilxvj_module = {
    ...
    0,
    mod_9bk1w4iilxvj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9bk1w4iilxvj(void)
{
    PyObject* mod;
    static void* Pymod_9bk1w4iilxvj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9bk1w4iilxvj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9bk1w4iilxvj_API, "mod_9bk1w4iilxvj._C_API", NULL);
