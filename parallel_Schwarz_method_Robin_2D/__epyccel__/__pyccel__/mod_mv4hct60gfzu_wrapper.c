...
#define MOD_MV4HCT60GFZU_WRAPPER

#include "mod_mv4hct60gfzu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mv4hct60gfzu_methods[] = {
    {
...
static struct PyModuleDef mod_mv4hct60gfzu_module = {
    ...
    0,
    mod_mv4hct60gfzu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mv4hct60gfzu(void)
{
    PyObject* mod;
    static void* Pymod_mv4hct60gfzu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mv4hct60gfzu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mv4hct60gfzu_API, "mod_mv4hct60gfzu._C_API", NULL);
