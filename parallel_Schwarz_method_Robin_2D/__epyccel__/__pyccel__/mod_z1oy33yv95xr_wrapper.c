...
#define MOD_Z1OY33YV95XR_WRAPPER

#include "mod_z1oy33yv95xr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_z1oy33yv95xr_methods[] = {
    {
...
static struct PyModuleDef mod_z1oy33yv95xr_module = {
    ...
    0,
    mod_z1oy33yv95xr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_z1oy33yv95xr(void)
{
    PyObject* mod;
    static void* Pymod_z1oy33yv95xr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_z1oy33yv95xr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_z1oy33yv95xr_API, "mod_z1oy33yv95xr._C_API", NULL);
