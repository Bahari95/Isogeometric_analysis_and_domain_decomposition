...
#define MOD_5N2B7PHCIYNM_WRAPPER

#include "mod_5n2b7phciynm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5n2b7phciynm_methods[] = {
    {
...
static struct PyModuleDef mod_5n2b7phciynm_module = {
    ...
    0,
    mod_5n2b7phciynm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5n2b7phciynm(void)
{
    PyObject* mod;
    static void* Pymod_5n2b7phciynm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5n2b7phciynm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5n2b7phciynm_API, "mod_5n2b7phciynm._C_API", NULL);
