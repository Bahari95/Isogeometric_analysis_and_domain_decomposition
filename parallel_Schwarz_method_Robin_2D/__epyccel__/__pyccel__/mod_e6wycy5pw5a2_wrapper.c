...
#define MOD_E6WYCY5PW5A2_WRAPPER

#include "mod_e6wycy5pw5a2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e6wycy5pw5a2_methods[] = {
    {
...
static struct PyModuleDef mod_e6wycy5pw5a2_module = {
    ...
    0,
    mod_e6wycy5pw5a2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e6wycy5pw5a2(void)
{
    PyObject* mod;
    static void* Pymod_e6wycy5pw5a2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e6wycy5pw5a2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e6wycy5pw5a2_API, "mod_e6wycy5pw5a2._C_API", NULL);
