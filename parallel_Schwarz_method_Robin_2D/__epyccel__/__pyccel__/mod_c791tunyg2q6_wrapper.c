...
#define MOD_C791TUNYG2Q6_WRAPPER

#include "mod_c791tunyg2q6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_c791tunyg2q6_methods[] = {
    {
...
static struct PyModuleDef mod_c791tunyg2q6_module = {
    ...
    0,
    mod_c791tunyg2q6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_c791tunyg2q6(void)
{
    PyObject* mod;
    static void* Pymod_c791tunyg2q6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_c791tunyg2q6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_c791tunyg2q6_API, "mod_c791tunyg2q6._C_API", NULL);
