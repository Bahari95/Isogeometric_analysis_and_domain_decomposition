...
#define MOD_ZUCWAI99PXXS_WRAPPER

#include "mod_zucwai99pxxs_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zucwai99pxxs_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_zucwai99pxxs_module = {
    ...
    0,
    mod_zucwai99pxxs_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zucwai99pxxs(void)
{
    PyObject* mod;
    static void* Pymod_zucwai99pxxs_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zucwai99pxxs_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zucwai99pxxs_API, "mod_zucwai99pxxs._C_API", NULL);
