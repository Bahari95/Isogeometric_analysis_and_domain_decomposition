...
#define MOD_U07Z8JFR6YSD_WRAPPER

#include "mod_u07z8jfr6ysd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_u07z8jfr6ysd_methods[] = {
    {
...
static struct PyModuleDef mod_u07z8jfr6ysd_module = {
    ...
    0,
    mod_u07z8jfr6ysd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u07z8jfr6ysd(void)
{
    PyObject* mod;
    static void* Pymod_u07z8jfr6ysd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_u07z8jfr6ysd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_u07z8jfr6ysd_API, "mod_u07z8jfr6ysd._C_API", NULL);
