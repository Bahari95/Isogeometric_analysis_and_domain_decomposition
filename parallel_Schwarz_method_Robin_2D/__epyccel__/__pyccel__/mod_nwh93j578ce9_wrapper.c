...
#define MOD_NWH93J578CE9_WRAPPER

#include "mod_nwh93j578ce9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_nwh93j578ce9_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_nwh93j578ce9_module = {
    ...
    0,
    mod_nwh93j578ce9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_nwh93j578ce9(void)
{
    PyObject* mod;
    static void* Pymod_nwh93j578ce9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_nwh93j578ce9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_nwh93j578ce9_API, "mod_nwh93j578ce9._C_API", NULL);
