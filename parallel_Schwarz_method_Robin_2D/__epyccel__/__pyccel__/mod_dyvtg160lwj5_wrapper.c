...
#define MOD_DYVTG160LWJ5_WRAPPER

#include "mod_dyvtg160lwj5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dyvtg160lwj5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dyvtg160lwj5_module = {
    ...
    0,
    mod_dyvtg160lwj5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dyvtg160lwj5(void)
{
    PyObject* mod;
    static void* Pymod_dyvtg160lwj5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dyvtg160lwj5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dyvtg160lwj5_API, "mod_dyvtg160lwj5._C_API", NULL);
