...
#define MOD_JPROZZXZZJMN_WRAPPER

#include "mod_jprozzxzzjmn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jprozzxzzjmn_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_jprozzxzzjmn_module = {
    ...
    0,
    mod_jprozzxzzjmn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jprozzxzzjmn(void)
{
    PyObject* mod;
    static void* Pymod_jprozzxzzjmn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jprozzxzzjmn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jprozzxzzjmn_API, "mod_jprozzxzzjmn._C_API", NULL);
