...
#define MOD_JXRFV9AJBG20_WRAPPER

#include "mod_jxrfv9ajbg20_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jxrfv9ajbg20_methods[] = {
    {
...
static struct PyModuleDef mod_jxrfv9ajbg20_module = {
    ...
    0,
    mod_jxrfv9ajbg20_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jxrfv9ajbg20(void)
{
    PyObject* mod;
    static void* Pymod_jxrfv9ajbg20_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jxrfv9ajbg20_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jxrfv9ajbg20_API, "mod_jxrfv9ajbg20._C_API", NULL);
