...
#define MOD_VHF24G7JP7WE_WRAPPER

#include "mod_vhf24g7jp7we_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vhf24g7jp7we_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_vhf24g7jp7we_module = {
    ...
    0,
    mod_vhf24g7jp7we_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vhf24g7jp7we(void)
{
    PyObject* mod;
    static void* Pymod_vhf24g7jp7we_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vhf24g7jp7we_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vhf24g7jp7we_API, "mod_vhf24g7jp7we._C_API", NULL);
