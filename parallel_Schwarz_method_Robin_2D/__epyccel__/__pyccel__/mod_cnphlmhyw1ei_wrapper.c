...
#define MOD_CNPHLMHYW1EI_WRAPPER

#include "mod_cnphlmhyw1ei_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_cnphlmhyw1ei_methods[] = {
    {
...
static struct PyModuleDef mod_cnphlmhyw1ei_module = {
    ...
    0,
    mod_cnphlmhyw1ei_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_cnphlmhyw1ei(void)
{
    PyObject* mod;
    static void* Pymod_cnphlmhyw1ei_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_cnphlmhyw1ei_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_cnphlmhyw1ei_API, "mod_cnphlmhyw1ei._C_API", NULL);
