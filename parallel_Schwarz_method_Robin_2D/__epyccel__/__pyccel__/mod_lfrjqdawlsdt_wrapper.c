...
#define MOD_LFRJQDAWLSDT_WRAPPER

#include "mod_lfrjqdawlsdt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lfrjqdawlsdt_methods[] = {
    {
...
static struct PyModuleDef mod_lfrjqdawlsdt_module = {
    ...
    0,
    mod_lfrjqdawlsdt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lfrjqdawlsdt(void)
{
    PyObject* mod;
    static void* Pymod_lfrjqdawlsdt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lfrjqdawlsdt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lfrjqdawlsdt_API, "mod_lfrjqdawlsdt._C_API", NULL);
