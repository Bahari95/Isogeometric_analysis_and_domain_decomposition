...
#define MOD_ZNZ7HCTTPLVX_WRAPPER

#include "mod_znz7hcttplvx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_znz7hcttplvx_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_znz7hcttplvx_module = {
    ...
    0,
    mod_znz7hcttplvx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_znz7hcttplvx(void)
{
    PyObject* mod;
    static void* Pymod_znz7hcttplvx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_znz7hcttplvx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_znz7hcttplvx_API, "mod_znz7hcttplvx._C_API", NULL);
