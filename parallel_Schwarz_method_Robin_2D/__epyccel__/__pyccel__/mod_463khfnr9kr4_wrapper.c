...
#define MOD_463KHFNR9KR4_WRAPPER

#include "mod_463khfnr9kr4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_463khfnr9kr4_methods[] = {
    {
...
static struct PyModuleDef mod_463khfnr9kr4_module = {
    ...
    0,
    mod_463khfnr9kr4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_463khfnr9kr4(void)
{
    PyObject* mod;
    static void* Pymod_463khfnr9kr4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_463khfnr9kr4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_463khfnr9kr4_API, "mod_463khfnr9kr4._C_API", NULL);
