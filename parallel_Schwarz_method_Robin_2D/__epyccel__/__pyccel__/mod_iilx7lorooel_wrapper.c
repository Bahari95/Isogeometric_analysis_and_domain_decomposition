...
#define MOD_IILX7LOROOEL_WRAPPER

#include "mod_iilx7lorooel_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iilx7lorooel_methods[] = {
    {
...
static struct PyModuleDef mod_iilx7lorooel_module = {
    ...
    0,
    mod_iilx7lorooel_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iilx7lorooel(void)
{
    PyObject* mod;
    static void* Pymod_iilx7lorooel_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iilx7lorooel_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iilx7lorooel_API, "mod_iilx7lorooel._C_API", NULL);
