...
#define MOD_GWKVN1GE4M0F_WRAPPER

#include "mod_gwkvn1ge4m0f_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gwkvn1ge4m0f_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_gwkvn1ge4m0f_module = {
    ...
    0,
    mod_gwkvn1ge4m0f_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gwkvn1ge4m0f(void)
{
    PyObject* mod;
    static void* Pymod_gwkvn1ge4m0f_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gwkvn1ge4m0f_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gwkvn1ge4m0f_API, "mod_gwkvn1ge4m0f._C_API", NULL);
