...
#define MOD_KE7UD1CJXTBL_WRAPPER

#include "mod_ke7ud1cjxtbl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ke7ud1cjxtbl_methods[] = {
    {
...
static struct PyModuleDef mod_ke7ud1cjxtbl_module = {
    ...
    0,
    mod_ke7ud1cjxtbl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ke7ud1cjxtbl(void)
{
    PyObject* mod;
    static void* Pymod_ke7ud1cjxtbl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ke7ud1cjxtbl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ke7ud1cjxtbl_API, "mod_ke7ud1cjxtbl._C_API", NULL);
