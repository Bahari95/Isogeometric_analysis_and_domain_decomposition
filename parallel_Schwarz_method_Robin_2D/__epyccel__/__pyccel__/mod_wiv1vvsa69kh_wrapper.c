...
#define MOD_WIV1VVSA69KH_WRAPPER

#include "mod_wiv1vvsa69kh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wiv1vvsa69kh_methods[] = {
    {
...
static struct PyModuleDef mod_wiv1vvsa69kh_module = {
    ...
    0,
    mod_wiv1vvsa69kh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wiv1vvsa69kh(void)
{
    PyObject* mod;
    static void* Pymod_wiv1vvsa69kh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wiv1vvsa69kh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wiv1vvsa69kh_API, "mod_wiv1vvsa69kh._C_API", NULL);
