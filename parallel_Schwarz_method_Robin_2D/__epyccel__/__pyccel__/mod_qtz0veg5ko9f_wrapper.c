...
#define MOD_QTZ0VEG5KO9F_WRAPPER

#include "mod_qtz0veg5ko9f_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qtz0veg5ko9f_methods[] = {
    {
...
static struct PyModuleDef mod_qtz0veg5ko9f_module = {
    ...
    0,
    mod_qtz0veg5ko9f_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qtz0veg5ko9f(void)
{
    PyObject* mod;
    static void* Pymod_qtz0veg5ko9f_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qtz0veg5ko9f_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qtz0veg5ko9f_API, "mod_qtz0veg5ko9f._C_API", NULL);
