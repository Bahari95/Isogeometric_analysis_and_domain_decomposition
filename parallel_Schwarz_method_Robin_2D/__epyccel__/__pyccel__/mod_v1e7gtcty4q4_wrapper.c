...
#define MOD_V1E7GTCTY4Q4_WRAPPER

#include "mod_v1e7gtcty4q4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_v1e7gtcty4q4_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_v1e7gtcty4q4_module = {
    ...
    0,
    mod_v1e7gtcty4q4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_v1e7gtcty4q4(void)
{
    PyObject* mod;
    static void* Pymod_v1e7gtcty4q4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_v1e7gtcty4q4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_v1e7gtcty4q4_API, "mod_v1e7gtcty4q4._C_API", NULL);
