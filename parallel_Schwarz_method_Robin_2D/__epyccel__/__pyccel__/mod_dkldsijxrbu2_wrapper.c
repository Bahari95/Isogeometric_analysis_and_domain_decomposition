...
#define MOD_DKLDSIJXRBU2_WRAPPER

#include "mod_dkldsijxrbu2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dkldsijxrbu2_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dkldsijxrbu2_module = {
    ...
    0,
    mod_dkldsijxrbu2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dkldsijxrbu2(void)
{
    PyObject* mod;
    static void* Pymod_dkldsijxrbu2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dkldsijxrbu2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dkldsijxrbu2_API, "mod_dkldsijxrbu2._C_API", NULL);
