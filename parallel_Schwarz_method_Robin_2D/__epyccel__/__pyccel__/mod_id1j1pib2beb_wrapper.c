...
#define MOD_ID1J1PIB2BEB_WRAPPER

#include "mod_id1j1pib2beb_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_id1j1pib2beb_methods[] = {
    {
...
static struct PyModuleDef mod_id1j1pib2beb_module = {
    ...
    0,
    mod_id1j1pib2beb_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_id1j1pib2beb(void)
{
    PyObject* mod;
    static void* Pymod_id1j1pib2beb_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_id1j1pib2beb_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_id1j1pib2beb_API, "mod_id1j1pib2beb._C_API", NULL);
