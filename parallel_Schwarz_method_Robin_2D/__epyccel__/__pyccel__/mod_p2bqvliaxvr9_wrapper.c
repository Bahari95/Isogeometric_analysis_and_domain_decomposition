...
#define MOD_P2BQVLIAXVR9_WRAPPER

#include "mod_p2bqvliaxvr9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_p2bqvliaxvr9_methods[] = {
    {
...
static struct PyModuleDef mod_p2bqvliaxvr9_module = {
    ...
    0,
    mod_p2bqvliaxvr9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_p2bqvliaxvr9(void)
{
    PyObject* mod;
    static void* Pymod_p2bqvliaxvr9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_p2bqvliaxvr9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_p2bqvliaxvr9_API, "mod_p2bqvliaxvr9._C_API", NULL);
