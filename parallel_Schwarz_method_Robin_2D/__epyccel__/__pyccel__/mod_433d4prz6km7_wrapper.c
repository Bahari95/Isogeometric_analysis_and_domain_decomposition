...
#define MOD_433D4PRZ6KM7_WRAPPER

#include "mod_433d4prz6km7_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_433d4prz6km7_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_433d4prz6km7_module = {
    ...
    0,
    mod_433d4prz6km7_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_433d4prz6km7(void)
{
    PyObject* mod;
    static void* Pymod_433d4prz6km7_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_433d4prz6km7_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_433d4prz6km7_API, "mod_433d4prz6km7._C_API", NULL);
