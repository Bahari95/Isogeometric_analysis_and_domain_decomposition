...
#define MOD_CAPFTJBDG5UC_WRAPPER

#include "mod_capftjbdg5uc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_capftjbdg5uc_methods[] = {
    {
...
static struct PyModuleDef mod_capftjbdg5uc_module = {
    ...
    0,
    mod_capftjbdg5uc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_capftjbdg5uc(void)
{
    PyObject* mod;
    static void* Pymod_capftjbdg5uc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_capftjbdg5uc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_capftjbdg5uc_API, "mod_capftjbdg5uc._C_API", NULL);
