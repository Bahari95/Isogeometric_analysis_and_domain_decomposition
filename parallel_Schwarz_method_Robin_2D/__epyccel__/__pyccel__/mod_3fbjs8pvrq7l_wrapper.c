...
#define MOD_3FBJS8PVRQ7L_WRAPPER

#include "mod_3fbjs8pvrq7l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3fbjs8pvrq7l_methods[] = {
    {
...
static struct PyModuleDef mod_3fbjs8pvrq7l_module = {
    ...
    0,
    mod_3fbjs8pvrq7l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3fbjs8pvrq7l(void)
{
    PyObject* mod;
    static void* Pymod_3fbjs8pvrq7l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3fbjs8pvrq7l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3fbjs8pvrq7l_API, "mod_3fbjs8pvrq7l._C_API", NULL);
