...
#define MOD_VKM8AHTZXK23_WRAPPER

#include "mod_vkm8ahtzxk23_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vkm8ahtzxk23_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_vkm8ahtzxk23_module = {
    ...
    0,
    mod_vkm8ahtzxk23_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vkm8ahtzxk23(void)
{
    PyObject* mod;
    static void* Pymod_vkm8ahtzxk23_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vkm8ahtzxk23_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vkm8ahtzxk23_API, "mod_vkm8ahtzxk23._C_API", NULL);
