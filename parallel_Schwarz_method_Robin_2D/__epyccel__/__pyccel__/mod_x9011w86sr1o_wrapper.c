...
#define MOD_X9011W86SR1O_WRAPPER

#include "mod_x9011w86sr1o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_x9011w86sr1o_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_x9011w86sr1o_module = {
    ...
    0,
    mod_x9011w86sr1o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_x9011w86sr1o(void)
{
    PyObject* mod;
    static void* Pymod_x9011w86sr1o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_x9011w86sr1o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_x9011w86sr1o_API, "mod_x9011w86sr1o._C_API", NULL);
