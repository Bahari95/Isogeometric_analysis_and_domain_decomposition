...
#define MOD_I0ZUHIAVQS6S_WRAPPER

#include "mod_i0zuhiavqs6s_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i0zuhiavqs6s_methods[] = {
    {
...
static struct PyModuleDef mod_i0zuhiavqs6s_module = {
    ...
    0,
    mod_i0zuhiavqs6s_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i0zuhiavqs6s(void)
{
    PyObject* mod;
    static void* Pymod_i0zuhiavqs6s_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i0zuhiavqs6s_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i0zuhiavqs6s_API, "mod_i0zuhiavqs6s._C_API", NULL);
