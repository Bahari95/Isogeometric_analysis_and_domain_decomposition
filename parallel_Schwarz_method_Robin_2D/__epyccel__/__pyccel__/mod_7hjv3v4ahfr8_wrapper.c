...
#define MOD_7HJV3V4AHFR8_WRAPPER

#include "mod_7hjv3v4ahfr8_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7hjv3v4ahfr8_methods[] = {
    {
...
static struct PyModuleDef mod_7hjv3v4ahfr8_module = {
    ...
    0,
    mod_7hjv3v4ahfr8_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7hjv3v4ahfr8(void)
{
    PyObject* mod;
    static void* Pymod_7hjv3v4ahfr8_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7hjv3v4ahfr8_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7hjv3v4ahfr8_API, "mod_7hjv3v4ahfr8._C_API", NULL);
