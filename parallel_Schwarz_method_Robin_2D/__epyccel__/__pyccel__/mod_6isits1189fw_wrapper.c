...
#define MOD_6ISITS1189FW_WRAPPER

#include "mod_6isits1189fw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6isits1189fw_methods[] = {
    {
...
static struct PyModuleDef mod_6isits1189fw_module = {
    ...
    0,
    mod_6isits1189fw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6isits1189fw(void)
{
    PyObject* mod;
    static void* Pymod_6isits1189fw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6isits1189fw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6isits1189fw_API, "mod_6isits1189fw._C_API", NULL);
