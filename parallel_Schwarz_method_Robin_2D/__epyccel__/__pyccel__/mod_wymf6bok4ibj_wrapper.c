...
#define MOD_WYMF6BOK4IBJ_WRAPPER

#include "mod_wymf6bok4ibj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wymf6bok4ibj_methods[] = {
    {
...
static struct PyModuleDef mod_wymf6bok4ibj_module = {
    ...
    0,
    mod_wymf6bok4ibj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wymf6bok4ibj(void)
{
    PyObject* mod;
    static void* Pymod_wymf6bok4ibj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wymf6bok4ibj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wymf6bok4ibj_API, "mod_wymf6bok4ibj._C_API", NULL);
