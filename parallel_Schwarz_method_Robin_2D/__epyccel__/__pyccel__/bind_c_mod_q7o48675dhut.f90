module bind_c_mod_q7o48675dhut

  use mod_q7o48675dhut
  ...
  subroutine bind_c_assemble_matrix_un_ex01(ne1, ne2, p1, p2, &
        ...
        S_DDM, ovlp_value, bound_vector_m1, bound_vector_m1_shape_1, &
    ...
    call assemble_matrix_un_ex01(ne1 = ne1, ne2 = ne2, p1 = p1, p2 = p2, &
          ...
          S_DDM, ovlp_value = ovlp_value, vector_m1 = vector_m1(1_i64:: &
...
end module bind_c_mod_q7o48675dhut
