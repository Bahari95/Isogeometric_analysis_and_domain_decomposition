...
#define MOD_ULBUNNS95TIU_WRAPPER

#include "mod_ulbunns95tiu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ulbunns95tiu_methods[] = {
    {
...
static struct PyModuleDef mod_ulbunns95tiu_module = {
    ...
    0,
    mod_ulbunns95tiu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ulbunns95tiu(void)
{
    PyObject* mod;
    static void* Pymod_ulbunns95tiu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ulbunns95tiu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ulbunns95tiu_API, "mod_ulbunns95tiu._C_API", NULL);
