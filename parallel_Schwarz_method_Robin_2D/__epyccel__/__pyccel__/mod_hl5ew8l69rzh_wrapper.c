...
#define MOD_HL5EW8L69RZH_WRAPPER

#include "mod_hl5ew8l69rzh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hl5ew8l69rzh_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hl5ew8l69rzh_module = {
    ...
    0,
    mod_hl5ew8l69rzh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hl5ew8l69rzh(void)
{
    PyObject* mod;
    static void* Pymod_hl5ew8l69rzh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hl5ew8l69rzh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hl5ew8l69rzh_API, "mod_hl5ew8l69rzh._C_API", NULL);
