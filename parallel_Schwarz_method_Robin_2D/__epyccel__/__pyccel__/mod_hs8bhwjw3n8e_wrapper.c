...
#define MOD_HS8BHWJW3N8E_WRAPPER

#include "mod_hs8bhwjw3n8e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hs8bhwjw3n8e_methods[] = {
    {
...
static struct PyModuleDef mod_hs8bhwjw3n8e_module = {
    ...
    0,
    mod_hs8bhwjw3n8e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hs8bhwjw3n8e(void)
{
    PyObject* mod;
    static void* Pymod_hs8bhwjw3n8e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hs8bhwjw3n8e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hs8bhwjw3n8e_API, "mod_hs8bhwjw3n8e._C_API", NULL);
