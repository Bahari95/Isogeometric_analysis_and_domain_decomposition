...
#define MOD_LAUGISTZLPQF_WRAPPER

#include "mod_laugistzlpqf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_laugistzlpqf_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_laugistzlpqf_module = {
    ...
    0,
    mod_laugistzlpqf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_laugistzlpqf(void)
{
    PyObject* mod;
    static void* Pymod_laugistzlpqf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_laugistzlpqf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_laugistzlpqf_API, "mod_laugistzlpqf._C_API", NULL);
