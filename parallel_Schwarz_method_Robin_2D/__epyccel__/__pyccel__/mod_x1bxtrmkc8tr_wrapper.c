...
#define MOD_X1BXTRMKC8TR_WRAPPER

#include "mod_x1bxtrmkc8tr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_x1bxtrmkc8tr_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_x1bxtrmkc8tr_module = {
    ...
    0,
    mod_x1bxtrmkc8tr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_x1bxtrmkc8tr(void)
{
    PyObject* mod;
    static void* Pymod_x1bxtrmkc8tr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_x1bxtrmkc8tr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_x1bxtrmkc8tr_API, "mod_x1bxtrmkc8tr._C_API", NULL);
