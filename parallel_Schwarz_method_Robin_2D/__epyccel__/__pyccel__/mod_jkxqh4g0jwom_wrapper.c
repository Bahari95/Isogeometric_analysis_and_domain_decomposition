...
#define MOD_JKXQH4G0JWOM_WRAPPER

#include "mod_jkxqh4g0jwom_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_jkxqh4g0jwom_methods[] = {
    {
...
static struct PyModuleDef mod_jkxqh4g0jwom_module = {
    ...
    0,
    mod_jkxqh4g0jwom_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_jkxqh4g0jwom(void)
{
    PyObject* mod;
    static void* Pymod_jkxqh4g0jwom_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_jkxqh4g0jwom_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_jkxqh4g0jwom_API, "mod_jkxqh4g0jwom._C_API", NULL);
