...
#define MOD_0RTRR5WEV80E_WRAPPER

#include "mod_0rtrr5wev80e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0rtrr5wev80e_methods[] = {
    {
...
static struct PyModuleDef mod_0rtrr5wev80e_module = {
    ...
    0,
    mod_0rtrr5wev80e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0rtrr5wev80e(void)
{
    PyObject* mod;
    static void* Pymod_0rtrr5wev80e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0rtrr5wev80e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0rtrr5wev80e_API, "mod_0rtrr5wev80e._C_API", NULL);
