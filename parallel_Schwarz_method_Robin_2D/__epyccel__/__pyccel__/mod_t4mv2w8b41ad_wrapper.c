...
#define MOD_T4MV2W8B41AD_WRAPPER

#include "mod_t4mv2w8b41ad_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_t4mv2w8b41ad_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_t4mv2w8b41ad_module = {
    ...
    0,
    mod_t4mv2w8b41ad_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_t4mv2w8b41ad(void)
{
    PyObject* mod;
    static void* Pymod_t4mv2w8b41ad_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_t4mv2w8b41ad_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_t4mv2w8b41ad_API, "mod_t4mv2w8b41ad._C_API", NULL);
