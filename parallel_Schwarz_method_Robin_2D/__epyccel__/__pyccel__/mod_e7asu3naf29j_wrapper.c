...
#define MOD_E7ASU3NAF29J_WRAPPER

#include "mod_e7asu3naf29j_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e7asu3naf29j_methods[] = {
    {
...
static struct PyModuleDef mod_e7asu3naf29j_module = {
    ...
    0,
    mod_e7asu3naf29j_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e7asu3naf29j(void)
{
    PyObject* mod;
    static void* Pymod_e7asu3naf29j_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e7asu3naf29j_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e7asu3naf29j_API, "mod_e7asu3naf29j._C_API", NULL);
