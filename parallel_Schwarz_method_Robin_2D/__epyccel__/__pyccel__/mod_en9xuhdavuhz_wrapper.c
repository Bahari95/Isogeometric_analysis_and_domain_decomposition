...
#define MOD_EN9XUHDAVUHZ_WRAPPER

#include "mod_en9xuhdavuhz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_en9xuhdavuhz_methods[] = {
    {
...
static struct PyModuleDef mod_en9xuhdavuhz_module = {
    ...
    0,
    mod_en9xuhdavuhz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_en9xuhdavuhz(void)
{
    PyObject* mod;
    static void* Pymod_en9xuhdavuhz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_en9xuhdavuhz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_en9xuhdavuhz_API, "mod_en9xuhdavuhz._C_API", NULL);
