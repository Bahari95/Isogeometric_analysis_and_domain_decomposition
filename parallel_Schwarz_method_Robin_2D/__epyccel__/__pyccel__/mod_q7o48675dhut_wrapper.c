...
#define MOD_Q7O48675DHUT_WRAPPER

#include "mod_q7o48675dhut_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_q7o48675dhut_methods[] = {
    {
...
static struct PyModuleDef mod_q7o48675dhut_module = {
    ...
    0,
    mod_q7o48675dhut_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_q7o48675dhut(void)
{
    PyObject* mod;
    static void* Pymod_q7o48675dhut_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_q7o48675dhut_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_q7o48675dhut_API, "mod_q7o48675dhut._C_API", NULL);
