...
#define MOD_XDCVVYXDGZKT_WRAPPER

#include "mod_xdcvvyxdgzkt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xdcvvyxdgzkt_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_xdcvvyxdgzkt_module = {
    ...
    0,
    mod_xdcvvyxdgzkt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xdcvvyxdgzkt(void)
{
    PyObject* mod;
    static void* Pymod_xdcvvyxdgzkt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xdcvvyxdgzkt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xdcvvyxdgzkt_API, "mod_xdcvvyxdgzkt._C_API", NULL);
