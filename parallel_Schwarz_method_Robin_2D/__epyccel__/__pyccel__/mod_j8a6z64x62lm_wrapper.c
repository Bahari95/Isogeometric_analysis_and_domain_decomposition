...
#define MOD_J8A6Z64X62LM_WRAPPER

#include "mod_j8a6z64x62lm_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_j8a6z64x62lm_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_j8a6z64x62lm_module = {
    ...
    0,
    mod_j8a6z64x62lm_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_j8a6z64x62lm(void)
{
    PyObject* mod;
    static void* Pymod_j8a6z64x62lm_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_j8a6z64x62lm_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_j8a6z64x62lm_API, "mod_j8a6z64x62lm._C_API", NULL);
