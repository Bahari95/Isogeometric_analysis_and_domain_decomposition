...
#define MOD_I8BWKYQPLXXH_WRAPPER

#include "mod_i8bwkyqplxxh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i8bwkyqplxxh_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i8bwkyqplxxh_module = {
    ...
    0,
    mod_i8bwkyqplxxh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i8bwkyqplxxh(void)
{
    PyObject* mod;
    static void* Pymod_i8bwkyqplxxh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i8bwkyqplxxh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i8bwkyqplxxh_API, "mod_i8bwkyqplxxh._C_API", NULL);
