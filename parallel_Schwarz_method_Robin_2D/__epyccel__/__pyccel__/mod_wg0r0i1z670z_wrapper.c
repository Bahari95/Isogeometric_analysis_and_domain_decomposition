...
#define MOD_WG0R0I1Z670Z_WRAPPER

#include "mod_wg0r0i1z670z_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wg0r0i1z670z_methods[] = {
    {
...
static struct PyModuleDef mod_wg0r0i1z670z_module = {
    ...
    0,
    mod_wg0r0i1z670z_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wg0r0i1z670z(void)
{
    PyObject* mod;
    static void* Pymod_wg0r0i1z670z_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wg0r0i1z670z_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wg0r0i1z670z_API, "mod_wg0r0i1z670z._C_API", NULL);
