...
#define MOD_HIZOJ88XE2GI_WRAPPER

#include "mod_hizoj88xe2gi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hizoj88xe2gi_methods[] = {
    {
...
static struct PyModuleDef mod_hizoj88xe2gi_module = {
    ...
    0,
    mod_hizoj88xe2gi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hizoj88xe2gi(void)
{
    PyObject* mod;
    static void* Pymod_hizoj88xe2gi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hizoj88xe2gi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hizoj88xe2gi_API, "mod_hizoj88xe2gi._C_API", NULL);
