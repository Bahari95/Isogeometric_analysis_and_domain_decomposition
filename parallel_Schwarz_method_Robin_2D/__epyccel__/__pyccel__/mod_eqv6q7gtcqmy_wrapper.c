...
#define MOD_EQV6Q7GTCQMY_WRAPPER

#include "mod_eqv6q7gtcqmy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eqv6q7gtcqmy_methods[] = {
    {
...
static struct PyModuleDef mod_eqv6q7gtcqmy_module = {
    ...
    0,
    mod_eqv6q7gtcqmy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eqv6q7gtcqmy(void)
{
    PyObject* mod;
    static void* Pymod_eqv6q7gtcqmy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eqv6q7gtcqmy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eqv6q7gtcqmy_API, "mod_eqv6q7gtcqmy._C_API", NULL);
