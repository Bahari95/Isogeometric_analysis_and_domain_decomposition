...
#define MOD_TT99UF5STKPN_WRAPPER

#include "mod_tt99uf5stkpn_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tt99uf5stkpn_methods[] = {
    {
...
static struct PyModuleDef mod_tt99uf5stkpn_module = {
    ...
    0,
    mod_tt99uf5stkpn_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tt99uf5stkpn(void)
{
    PyObject* mod;
    static void* Pymod_tt99uf5stkpn_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tt99uf5stkpn_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tt99uf5stkpn_API, "mod_tt99uf5stkpn._C_API", NULL);
