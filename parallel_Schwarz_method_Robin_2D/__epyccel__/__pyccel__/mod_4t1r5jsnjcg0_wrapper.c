...
#define MOD_4T1R5JSNJCG0_WRAPPER

#include "mod_4t1r5jsnjcg0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4t1r5jsnjcg0_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_4t1r5jsnjcg0_module = {
    ...
    0,
    mod_4t1r5jsnjcg0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4t1r5jsnjcg0(void)
{
    PyObject* mod;
    static void* Pymod_4t1r5jsnjcg0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4t1r5jsnjcg0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4t1r5jsnjcg0_API, "mod_4t1r5jsnjcg0._C_API", NULL);
