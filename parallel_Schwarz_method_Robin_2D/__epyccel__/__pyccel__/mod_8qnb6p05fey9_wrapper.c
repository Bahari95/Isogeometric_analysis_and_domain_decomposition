...
#define MOD_8QNB6P05FEY9_WRAPPER

#include "mod_8qnb6p05fey9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_8qnb6p05fey9_methods[] = {
    {
...
static struct PyModuleDef mod_8qnb6p05fey9_module = {
    ...
    0,
    mod_8qnb6p05fey9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_8qnb6p05fey9(void)
{
    PyObject* mod;
    static void* Pymod_8qnb6p05fey9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_8qnb6p05fey9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_8qnb6p05fey9_API, "mod_8qnb6p05fey9._C_API", NULL);
