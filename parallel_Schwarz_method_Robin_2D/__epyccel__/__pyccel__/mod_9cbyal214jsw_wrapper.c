...
#define MOD_9CBYAL214JSW_WRAPPER

#include "mod_9cbyal214jsw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9cbyal214jsw_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9cbyal214jsw_module = {
    ...
    0,
    mod_9cbyal214jsw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9cbyal214jsw(void)
{
    PyObject* mod;
    static void* Pymod_9cbyal214jsw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9cbyal214jsw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9cbyal214jsw_API, "mod_9cbyal214jsw._C_API", NULL);
