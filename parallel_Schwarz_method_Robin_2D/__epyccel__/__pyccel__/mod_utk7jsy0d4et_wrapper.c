...
#define MOD_UTK7JSY0D4ET_WRAPPER

#include "mod_utk7jsy0d4et_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_utk7jsy0d4et_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_utk7jsy0d4et_module = {
    ...
    0,
    mod_utk7jsy0d4et_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_utk7jsy0d4et(void)
{
    PyObject* mod;
    static void* Pymod_utk7jsy0d4et_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_utk7jsy0d4et_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_utk7jsy0d4et_API, "mod_utk7jsy0d4et._C_API", NULL);
