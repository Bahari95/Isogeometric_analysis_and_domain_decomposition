...
#define MOD_M41XZ247YJ6P_WRAPPER

#include "mod_m41xz247yj6p_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m41xz247yj6p_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_m41xz247yj6p_module = {
    ...
    0,
    mod_m41xz247yj6p_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m41xz247yj6p(void)
{
    PyObject* mod;
    static void* Pymod_m41xz247yj6p_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m41xz247yj6p_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m41xz247yj6p_API, "mod_m41xz247yj6p._C_API", NULL);
