...
#define MOD_4OLRW88LPSKV_WRAPPER

#include "mod_4olrw88lpskv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4olrw88lpskv_methods[] = {
    {
...
static struct PyModuleDef mod_4olrw88lpskv_module = {
    ...
    0,
    mod_4olrw88lpskv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4olrw88lpskv(void)
{
    PyObject* mod;
    static void* Pymod_4olrw88lpskv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4olrw88lpskv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4olrw88lpskv_API, "mod_4olrw88lpskv._C_API", NULL);
