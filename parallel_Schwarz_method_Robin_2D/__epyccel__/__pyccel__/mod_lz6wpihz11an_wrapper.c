...
#define MOD_LZ6WPIHZ11AN_WRAPPER

#include "mod_lz6wpihz11an_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lz6wpihz11an_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lz6wpihz11an_module = {
    ...
    0,
    mod_lz6wpihz11an_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lz6wpihz11an(void)
{
    PyObject* mod;
    static void* Pymod_lz6wpihz11an_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lz6wpihz11an_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lz6wpihz11an_API, "mod_lz6wpihz11an._C_API", NULL);
