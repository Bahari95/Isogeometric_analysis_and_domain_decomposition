...
#define MOD_K5CCRKECSDZR_WRAPPER

#include "mod_k5ccrkecsdzr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_k5ccrkecsdzr_methods[] = {
    {
...
static struct PyModuleDef mod_k5ccrkecsdzr_module = {
    ...
    0,
    mod_k5ccrkecsdzr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k5ccrkecsdzr(void)
{
    PyObject* mod;
    static void* Pymod_k5ccrkecsdzr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k5ccrkecsdzr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k5ccrkecsdzr_API, "mod_k5ccrkecsdzr._C_API", NULL);
