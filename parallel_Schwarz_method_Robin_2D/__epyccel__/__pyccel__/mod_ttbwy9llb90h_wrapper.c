...
#define MOD_TTBWY9LLB90H_WRAPPER

#include "mod_ttbwy9llb90h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ttbwy9llb90h_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ttbwy9llb90h_module = {
    ...
    0,
    mod_ttbwy9llb90h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ttbwy9llb90h(void)
{
    PyObject* mod;
    static void* Pymod_ttbwy9llb90h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ttbwy9llb90h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ttbwy9llb90h_API, "mod_ttbwy9llb90h._C_API", NULL);
