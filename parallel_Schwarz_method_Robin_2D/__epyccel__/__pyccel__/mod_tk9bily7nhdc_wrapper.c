...
#define MOD_TK9BILY7NHDC_WRAPPER

#include "mod_tk9bily7nhdc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tk9bily7nhdc_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_tk9bily7nhdc_module = {
    ...
    0,
    mod_tk9bily7nhdc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tk9bily7nhdc(void)
{
    PyObject* mod;
    static void* Pymod_tk9bily7nhdc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tk9bily7nhdc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tk9bily7nhdc_API, "mod_tk9bily7nhdc._C_API", NULL);
