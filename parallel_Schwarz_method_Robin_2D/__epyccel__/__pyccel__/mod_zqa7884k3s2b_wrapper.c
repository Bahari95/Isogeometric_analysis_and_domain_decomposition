...
#define MOD_ZQA7884K3S2B_WRAPPER

#include "mod_zqa7884k3s2b_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zqa7884k3s2b_methods[] = {
    {
...
static struct PyModuleDef mod_zqa7884k3s2b_module = {
    ...
    0,
    mod_zqa7884k3s2b_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zqa7884k3s2b(void)
{
    PyObject* mod;
    static void* Pymod_zqa7884k3s2b_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zqa7884k3s2b_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zqa7884k3s2b_API, "mod_zqa7884k3s2b._C_API", NULL);
