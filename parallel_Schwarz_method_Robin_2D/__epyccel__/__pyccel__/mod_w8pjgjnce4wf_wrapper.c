...
#define MOD_W8PJGJNCE4WF_WRAPPER

#include "mod_w8pjgjnce4wf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_w8pjgjnce4wf_methods[] = {
    {
...
static struct PyModuleDef mod_w8pjgjnce4wf_module = {
    ...
    0,
    mod_w8pjgjnce4wf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_w8pjgjnce4wf(void)
{
    PyObject* mod;
    static void* Pymod_w8pjgjnce4wf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_w8pjgjnce4wf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_w8pjgjnce4wf_API, "mod_w8pjgjnce4wf._C_API", NULL);
