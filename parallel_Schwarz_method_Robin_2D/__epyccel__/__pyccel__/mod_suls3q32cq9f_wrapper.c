...
#define MOD_SULS3Q32CQ9F_WRAPPER

#include "mod_suls3q32cq9f_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_suls3q32cq9f_methods[] = {
    {
...
static struct PyModuleDef mod_suls3q32cq9f_module = {
    ...
    0,
    mod_suls3q32cq9f_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_suls3q32cq9f(void)
{
    PyObject* mod;
    static void* Pymod_suls3q32cq9f_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_suls3q32cq9f_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_suls3q32cq9f_API, "mod_suls3q32cq9f._C_API", NULL);
