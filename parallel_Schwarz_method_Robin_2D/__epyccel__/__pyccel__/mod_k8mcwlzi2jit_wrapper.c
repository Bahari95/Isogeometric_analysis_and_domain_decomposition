...
#define MOD_K8MCWLZI2JIT_WRAPPER

#include "mod_k8mcwlzi2jit_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_k8mcwlzi2jit_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_k8mcwlzi2jit_module = {
    ...
    0,
    mod_k8mcwlzi2jit_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k8mcwlzi2jit(void)
{
    PyObject* mod;
    static void* Pymod_k8mcwlzi2jit_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k8mcwlzi2jit_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k8mcwlzi2jit_API, "mod_k8mcwlzi2jit._C_API", NULL);
