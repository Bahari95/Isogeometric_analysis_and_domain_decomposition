...
#define MOD_NI0GPZ21JU7G_WRAPPER

#include "mod_ni0gpz21ju7g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ni0gpz21ju7g_methods[] = {
    {
...
static struct PyModuleDef mod_ni0gpz21ju7g_module = {
    ...
    0,
    mod_ni0gpz21ju7g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ni0gpz21ju7g(void)
{
    PyObject* mod;
    static void* Pymod_ni0gpz21ju7g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ni0gpz21ju7g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ni0gpz21ju7g_API, "mod_ni0gpz21ju7g._C_API", NULL);
