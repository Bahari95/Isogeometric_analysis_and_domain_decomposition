...
#define MOD_0R5LQ6WOQYPZ_WRAPPER

#include "mod_0r5lq6woqypz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0r5lq6woqypz_methods[] = {
    {
...
static struct PyModuleDef mod_0r5lq6woqypz_module = {
    ...
    0,
    mod_0r5lq6woqypz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0r5lq6woqypz(void)
{
    PyObject* mod;
    static void* Pymod_0r5lq6woqypz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0r5lq6woqypz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0r5lq6woqypz_API, "mod_0r5lq6woqypz._C_API", NULL);
