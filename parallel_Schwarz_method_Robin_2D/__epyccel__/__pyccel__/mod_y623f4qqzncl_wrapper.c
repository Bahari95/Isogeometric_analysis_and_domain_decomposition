...
#define MOD_Y623F4QQZNCL_WRAPPER

#include "mod_y623f4qqzncl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_y623f4qqzncl_methods[] = {
    {
...
static struct PyModuleDef mod_y623f4qqzncl_module = {
    ...
    0,
    mod_y623f4qqzncl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_y623f4qqzncl(void)
{
    PyObject* mod;
    static void* Pymod_y623f4qqzncl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_y623f4qqzncl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_y623f4qqzncl_API, "mod_y623f4qqzncl._C_API", NULL);
