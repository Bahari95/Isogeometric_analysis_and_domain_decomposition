...
#define MOD_A4Q7ZE420WCX_WRAPPER

#include "mod_a4q7ze420wcx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a4q7ze420wcx_methods[] = {
    {
...
static struct PyModuleDef mod_a4q7ze420wcx_module = {
    ...
    0,
    mod_a4q7ze420wcx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a4q7ze420wcx(void)
{
    PyObject* mod;
    static void* Pymod_a4q7ze420wcx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a4q7ze420wcx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a4q7ze420wcx_API, "mod_a4q7ze420wcx._C_API", NULL);
