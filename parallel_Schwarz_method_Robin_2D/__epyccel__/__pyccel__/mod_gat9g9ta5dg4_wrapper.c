...
#define MOD_GAT9G9TA5DG4_WRAPPER

#include "mod_gat9g9ta5dg4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gat9g9ta5dg4_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_gat9g9ta5dg4_module = {
    ...
    0,
    mod_gat9g9ta5dg4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gat9g9ta5dg4(void)
{
    PyObject* mod;
    static void* Pymod_gat9g9ta5dg4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gat9g9ta5dg4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gat9g9ta5dg4_API, "mod_gat9g9ta5dg4._C_API", NULL);
