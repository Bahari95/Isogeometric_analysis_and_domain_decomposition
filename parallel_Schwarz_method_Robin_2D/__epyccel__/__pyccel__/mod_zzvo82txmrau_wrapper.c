...
#define MOD_ZZVO82TXMRAU_WRAPPER

#include "mod_zzvo82txmrau_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zzvo82txmrau_methods[] = {
    {
...
static struct PyModuleDef mod_zzvo82txmrau_module = {
    ...
    0,
    mod_zzvo82txmrau_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zzvo82txmrau(void)
{
    PyObject* mod;
    static void* Pymod_zzvo82txmrau_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zzvo82txmrau_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zzvo82txmrau_API, "mod_zzvo82txmrau._C_API", NULL);
