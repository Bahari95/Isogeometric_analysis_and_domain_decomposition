...
#define MOD_EGP0VT9BEHCU_WRAPPER

#include "mod_egp0vt9behcu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_egp0vt9behcu_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_egp0vt9behcu_module = {
    ...
    0,
    mod_egp0vt9behcu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_egp0vt9behcu(void)
{
    PyObject* mod;
    static void* Pymod_egp0vt9behcu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_egp0vt9behcu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_egp0vt9behcu_API, "mod_egp0vt9behcu._C_API", NULL);
