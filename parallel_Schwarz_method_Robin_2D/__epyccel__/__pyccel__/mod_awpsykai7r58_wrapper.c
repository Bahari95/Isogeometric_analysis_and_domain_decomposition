...
#define MOD_AWPSYKAI7R58_WRAPPER

#include "mod_awpsykai7r58_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_awpsykai7r58_methods[] = {
    {
...
static struct PyModuleDef mod_awpsykai7r58_module = {
    ...
    0,
    mod_awpsykai7r58_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_awpsykai7r58(void)
{
    PyObject* mod;
    static void* Pymod_awpsykai7r58_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_awpsykai7r58_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_awpsykai7r58_API, "mod_awpsykai7r58._C_API", NULL);
