...
#define MOD_GJAOGAM6WXJ0_WRAPPER

#include "mod_gjaogam6wxj0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_gjaogam6wxj0_methods[] = {
    {
...
static struct PyModuleDef mod_gjaogam6wxj0_module = {
    ...
    0,
    mod_gjaogam6wxj0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_gjaogam6wxj0(void)
{
    PyObject* mod;
    static void* Pymod_gjaogam6wxj0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_gjaogam6wxj0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_gjaogam6wxj0_API, "mod_gjaogam6wxj0._C_API", NULL);
