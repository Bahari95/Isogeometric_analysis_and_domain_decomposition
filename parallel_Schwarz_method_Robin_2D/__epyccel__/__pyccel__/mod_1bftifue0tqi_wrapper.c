...
#define MOD_1BFTIFUE0TQI_WRAPPER

#include "mod_1bftifue0tqi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1bftifue0tqi_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_1bftifue0tqi_module = {
    ...
    0,
    mod_1bftifue0tqi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1bftifue0tqi(void)
{
    PyObject* mod;
    static void* Pymod_1bftifue0tqi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1bftifue0tqi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1bftifue0tqi_API, "mod_1bftifue0tqi._C_API", NULL);
