...
#define MOD_DZZWMB5V0MR9_WRAPPER

#include "mod_dzzwmb5v0mr9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dzzwmb5v0mr9_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dzzwmb5v0mr9_module = {
    ...
    0,
    mod_dzzwmb5v0mr9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dzzwmb5v0mr9(void)
{
    PyObject* mod;
    static void* Pymod_dzzwmb5v0mr9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dzzwmb5v0mr9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dzzwmb5v0mr9_API, "mod_dzzwmb5v0mr9._C_API", NULL);
