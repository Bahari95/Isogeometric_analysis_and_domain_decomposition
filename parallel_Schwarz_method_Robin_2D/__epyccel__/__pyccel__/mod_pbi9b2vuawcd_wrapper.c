...
#define MOD_PBI9B2VUAWCD_WRAPPER

#include "mod_pbi9b2vuawcd_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pbi9b2vuawcd_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_pbi9b2vuawcd_module = {
    ...
    0,
    mod_pbi9b2vuawcd_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pbi9b2vuawcd(void)
{
    PyObject* mod;
    static void* Pymod_pbi9b2vuawcd_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pbi9b2vuawcd_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pbi9b2vuawcd_API, "mod_pbi9b2vuawcd._C_API", NULL);
