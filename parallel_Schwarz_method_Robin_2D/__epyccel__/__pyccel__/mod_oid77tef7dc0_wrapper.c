...
#define MOD_OID77TEF7DC0_WRAPPER

#include "mod_oid77tef7dc0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_oid77tef7dc0_methods[] = {
    {
...
static struct PyModuleDef mod_oid77tef7dc0_module = {
    ...
    0,
    mod_oid77tef7dc0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_oid77tef7dc0(void)
{
    PyObject* mod;
    static void* Pymod_oid77tef7dc0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_oid77tef7dc0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_oid77tef7dc0_API, "mod_oid77tef7dc0._C_API", NULL);
