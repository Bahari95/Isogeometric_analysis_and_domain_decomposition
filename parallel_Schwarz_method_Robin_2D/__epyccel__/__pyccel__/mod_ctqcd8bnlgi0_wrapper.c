...
#define MOD_CTQCD8BNLGI0_WRAPPER

#include "mod_ctqcd8bnlgi0_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ctqcd8bnlgi0_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ctqcd8bnlgi0_module = {
    ...
    0,
    mod_ctqcd8bnlgi0_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ctqcd8bnlgi0(void)
{
    PyObject* mod;
    static void* Pymod_ctqcd8bnlgi0_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ctqcd8bnlgi0_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ctqcd8bnlgi0_API, "mod_ctqcd8bnlgi0._C_API", NULL);
