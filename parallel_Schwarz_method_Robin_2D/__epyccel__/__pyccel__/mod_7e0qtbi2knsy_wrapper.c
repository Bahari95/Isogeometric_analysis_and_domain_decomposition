...
#define MOD_7E0QTBI2KNSY_WRAPPER

#include "mod_7e0qtbi2knsy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7e0qtbi2knsy_methods[] = {
    {
...
static struct PyModuleDef mod_7e0qtbi2knsy_module = {
    ...
    0,
    mod_7e0qtbi2knsy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7e0qtbi2knsy(void)
{
    PyObject* mod;
    static void* Pymod_7e0qtbi2knsy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7e0qtbi2knsy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7e0qtbi2knsy_API, "mod_7e0qtbi2knsy._C_API", NULL);
