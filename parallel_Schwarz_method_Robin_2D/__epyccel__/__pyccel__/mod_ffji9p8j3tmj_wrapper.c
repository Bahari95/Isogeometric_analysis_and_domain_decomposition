...
#define MOD_FFJI9P8J3TMJ_WRAPPER

#include "mod_ffji9p8j3tmj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ffji9p8j3tmj_methods[] = {
    {
...
static struct PyModuleDef mod_ffji9p8j3tmj_module = {
    ...
    0,
    mod_ffji9p8j3tmj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ffji9p8j3tmj(void)
{
    PyObject* mod;
    static void* Pymod_ffji9p8j3tmj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ffji9p8j3tmj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ffji9p8j3tmj_API, "mod_ffji9p8j3tmj._C_API", NULL);
