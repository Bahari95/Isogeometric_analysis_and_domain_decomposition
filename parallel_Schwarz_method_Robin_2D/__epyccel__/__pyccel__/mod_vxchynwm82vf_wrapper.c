...
#define MOD_VXCHYNWM82VF_WRAPPER

#include "mod_vxchynwm82vf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vxchynwm82vf_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_vxchynwm82vf_module = {
    ...
    0,
    mod_vxchynwm82vf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vxchynwm82vf(void)
{
    PyObject* mod;
    static void* Pymod_vxchynwm82vf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vxchynwm82vf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vxchynwm82vf_API, "mod_vxchynwm82vf._C_API", NULL);
