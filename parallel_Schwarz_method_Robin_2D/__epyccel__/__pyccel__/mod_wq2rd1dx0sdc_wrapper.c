...
#define MOD_WQ2RD1DX0SDC_WRAPPER

#include "mod_wq2rd1dx0sdc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wq2rd1dx0sdc_methods[] = {
    {
...
static struct PyModuleDef mod_wq2rd1dx0sdc_module = {
    ...
    0,
    mod_wq2rd1dx0sdc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wq2rd1dx0sdc(void)
{
    PyObject* mod;
    static void* Pymod_wq2rd1dx0sdc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wq2rd1dx0sdc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wq2rd1dx0sdc_API, "mod_wq2rd1dx0sdc._C_API", NULL);
