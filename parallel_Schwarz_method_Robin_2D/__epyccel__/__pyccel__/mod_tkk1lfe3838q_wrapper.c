...
#define MOD_TKK1LFE3838Q_WRAPPER

#include "mod_tkk1lfe3838q_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tkk1lfe3838q_methods[] = {
    {
...
static struct PyModuleDef mod_tkk1lfe3838q_module = {
    ...
    0,
    mod_tkk1lfe3838q_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tkk1lfe3838q(void)
{
    PyObject* mod;
    static void* Pymod_tkk1lfe3838q_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tkk1lfe3838q_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tkk1lfe3838q_API, "mod_tkk1lfe3838q._C_API", NULL);
