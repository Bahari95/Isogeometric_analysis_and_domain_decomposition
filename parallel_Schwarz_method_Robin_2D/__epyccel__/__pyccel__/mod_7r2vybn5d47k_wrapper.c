...
#define MOD_7R2VYBN5D47K_WRAPPER

#include "mod_7r2vybn5d47k_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7r2vybn5d47k_methods[] = {
    {
...
static struct PyModuleDef mod_7r2vybn5d47k_module = {
    ...
    0,
    mod_7r2vybn5d47k_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7r2vybn5d47k(void)
{
    PyObject* mod;
    static void* Pymod_7r2vybn5d47k_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7r2vybn5d47k_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7r2vybn5d47k_API, "mod_7r2vybn5d47k._C_API", NULL);
