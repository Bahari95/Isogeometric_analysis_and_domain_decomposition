...
#define MOD_26WL7YIB38TI_WRAPPER

#include "mod_26wl7yib38ti_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_26wl7yib38ti_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_26wl7yib38ti_module = {
    ...
    0,
    mod_26wl7yib38ti_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_26wl7yib38ti(void)
{
    PyObject* mod;
    static void* Pymod_26wl7yib38ti_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_26wl7yib38ti_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_26wl7yib38ti_API, "mod_26wl7yib38ti._C_API", NULL);
