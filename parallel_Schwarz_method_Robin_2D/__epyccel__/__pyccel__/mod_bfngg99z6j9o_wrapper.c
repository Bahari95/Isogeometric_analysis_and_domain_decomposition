...
#define MOD_BFNGG99Z6J9O_WRAPPER

#include "mod_bfngg99z6j9o_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_bfngg99z6j9o_methods[] = {
    {
...
static struct PyModuleDef mod_bfngg99z6j9o_module = {
    ...
    0,
    mod_bfngg99z6j9o_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_bfngg99z6j9o(void)
{
    PyObject* mod;
    static void* Pymod_bfngg99z6j9o_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_bfngg99z6j9o_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_bfngg99z6j9o_API, "mod_bfngg99z6j9o._C_API", NULL);
