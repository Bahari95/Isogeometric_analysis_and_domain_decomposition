...
#define MOD_ZXZ0VFKLBLC4_WRAPPER

#include "mod_zxz0vfklblc4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zxz0vfklblc4_methods[] = {
    {
...
static struct PyModuleDef mod_zxz0vfklblc4_module = {
    ...
    0,
    mod_zxz0vfklblc4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zxz0vfklblc4(void)
{
    PyObject* mod;
    static void* Pymod_zxz0vfklblc4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zxz0vfklblc4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zxz0vfklblc4_API, "mod_zxz0vfklblc4._C_API", NULL);
