...
#define MOD_LYCKD8EHWJ05_WRAPPER

#include "mod_lyckd8ehwj05_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lyckd8ehwj05_methods[] = {
    {
...
static struct PyModuleDef mod_lyckd8ehwj05_module = {
    ...
    0,
    mod_lyckd8ehwj05_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lyckd8ehwj05(void)
{
    PyObject* mod;
    static void* Pymod_lyckd8ehwj05_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lyckd8ehwj05_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lyckd8ehwj05_API, "mod_lyckd8ehwj05._C_API", NULL);
