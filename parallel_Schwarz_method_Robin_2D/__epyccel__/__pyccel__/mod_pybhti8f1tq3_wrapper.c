...
#define MOD_PYBHTI8F1TQ3_WRAPPER

#include "mod_pybhti8f1tq3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pybhti8f1tq3_methods[] = {
    {
...
static struct PyModuleDef mod_pybhti8f1tq3_module = {
    ...
    0,
    mod_pybhti8f1tq3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pybhti8f1tq3(void)
{
    PyObject* mod;
    static void* Pymod_pybhti8f1tq3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pybhti8f1tq3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pybhti8f1tq3_API, "mod_pybhti8f1tq3._C_API", NULL);
