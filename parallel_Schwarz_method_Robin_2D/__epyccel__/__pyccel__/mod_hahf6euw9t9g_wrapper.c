...
#define MOD_HAHF6EUW9T9G_WRAPPER

#include "mod_hahf6euw9t9g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hahf6euw9t9g_methods[] = {
    {
...
static struct PyModuleDef mod_hahf6euw9t9g_module = {
    ...
    0,
    mod_hahf6euw9t9g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hahf6euw9t9g(void)
{
    PyObject* mod;
    static void* Pymod_hahf6euw9t9g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hahf6euw9t9g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hahf6euw9t9g_API, "mod_hahf6euw9t9g._C_API", NULL);
