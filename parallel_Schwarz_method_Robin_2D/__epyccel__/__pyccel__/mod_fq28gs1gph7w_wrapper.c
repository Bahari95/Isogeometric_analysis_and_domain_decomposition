...
#define MOD_FQ28GS1GPH7W_WRAPPER

#include "mod_fq28gs1gph7w_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fq28gs1gph7w_methods[] = {
    {
...
static struct PyModuleDef mod_fq28gs1gph7w_module = {
    ...
    0,
    mod_fq28gs1gph7w_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fq28gs1gph7w(void)
{
    PyObject* mod;
    static void* Pymod_fq28gs1gph7w_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fq28gs1gph7w_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fq28gs1gph7w_API, "mod_fq28gs1gph7w._C_API", NULL);
