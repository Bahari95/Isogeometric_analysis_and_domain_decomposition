...
#define MOD_VA7A8WVD2W4E_WRAPPER

#include "mod_va7a8wvd2w4e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_va7a8wvd2w4e_methods[] = {
    {
...
static struct PyModuleDef mod_va7a8wvd2w4e_module = {
    ...
    0,
    mod_va7a8wvd2w4e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_va7a8wvd2w4e(void)
{
    PyObject* mod;
    static void* Pymod_va7a8wvd2w4e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_va7a8wvd2w4e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_va7a8wvd2w4e_API, "mod_va7a8wvd2w4e._C_API", NULL);
