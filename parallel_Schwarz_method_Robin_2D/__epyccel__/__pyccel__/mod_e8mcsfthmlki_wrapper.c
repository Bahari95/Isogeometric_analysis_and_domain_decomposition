...
#define MOD_E8MCSFTHMLKI_WRAPPER

#include "mod_e8mcsfthmlki_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e8mcsfthmlki_methods[] = {
    {
...
static struct PyModuleDef mod_e8mcsfthmlki_module = {
    ...
    0,
    mod_e8mcsfthmlki_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e8mcsfthmlki(void)
{
    PyObject* mod;
    static void* Pymod_e8mcsfthmlki_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e8mcsfthmlki_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e8mcsfthmlki_API, "mod_e8mcsfthmlki._C_API", NULL);
