...
#define MOD_WI3C3ITN7JWZ_WRAPPER

#include "mod_wi3c3itn7jwz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wi3c3itn7jwz_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_wi3c3itn7jwz_module = {
    ...
    0,
    mod_wi3c3itn7jwz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wi3c3itn7jwz(void)
{
    PyObject* mod;
    static void* Pymod_wi3c3itn7jwz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wi3c3itn7jwz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wi3c3itn7jwz_API, "mod_wi3c3itn7jwz._C_API", NULL);
