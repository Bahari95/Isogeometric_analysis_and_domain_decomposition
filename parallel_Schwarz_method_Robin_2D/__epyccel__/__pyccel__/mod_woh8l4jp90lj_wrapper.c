...
#define MOD_WOH8L4JP90LJ_WRAPPER

#include "mod_woh8l4jp90lj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_woh8l4jp90lj_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_woh8l4jp90lj_module = {
    ...
    0,
    mod_woh8l4jp90lj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_woh8l4jp90lj(void)
{
    PyObject* mod;
    static void* Pymod_woh8l4jp90lj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_woh8l4jp90lj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_woh8l4jp90lj_API, "mod_woh8l4jp90lj._C_API", NULL);
