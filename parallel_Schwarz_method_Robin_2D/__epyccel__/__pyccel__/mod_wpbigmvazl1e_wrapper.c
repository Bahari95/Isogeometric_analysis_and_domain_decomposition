...
#define MOD_WPBIGMVAZL1E_WRAPPER

#include "mod_wpbigmvazl1e_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wpbigmvazl1e_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_wpbigmvazl1e_module = {
    ...
    0,
    mod_wpbigmvazl1e_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wpbigmvazl1e(void)
{
    PyObject* mod;
    static void* Pymod_wpbigmvazl1e_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wpbigmvazl1e_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wpbigmvazl1e_API, "mod_wpbigmvazl1e._C_API", NULL);
