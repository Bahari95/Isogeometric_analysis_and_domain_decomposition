...
#define MOD_DMBGMULMQ710_WRAPPER

#include "mod_dmbgmulmq710_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dmbgmulmq710_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dmbgmulmq710_module = {
    ...
    0,
    mod_dmbgmulmq710_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dmbgmulmq710(void)
{
    PyObject* mod;
    static void* Pymod_dmbgmulmq710_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dmbgmulmq710_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dmbgmulmq710_API, "mod_dmbgmulmq710._C_API", NULL);
