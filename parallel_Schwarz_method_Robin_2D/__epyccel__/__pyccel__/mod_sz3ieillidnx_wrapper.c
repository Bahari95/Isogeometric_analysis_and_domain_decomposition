...
#define MOD_SZ3IEILLIDNX_WRAPPER

#include "mod_sz3ieillidnx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sz3ieillidnx_methods[] = {
    {
...
static struct PyModuleDef mod_sz3ieillidnx_module = {
    ...
    0,
    mod_sz3ieillidnx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sz3ieillidnx(void)
{
    PyObject* mod;
    static void* Pymod_sz3ieillidnx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sz3ieillidnx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sz3ieillidnx_API, "mod_sz3ieillidnx._C_API", NULL);
