...
#define MOD_E7MIIN7OP2KY_WRAPPER

#include "mod_e7miin7op2ky_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e7miin7op2ky_methods[] = {
    {
...
static struct PyModuleDef mod_e7miin7op2ky_module = {
    ...
    0,
    mod_e7miin7op2ky_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e7miin7op2ky(void)
{
    PyObject* mod;
    static void* Pymod_e7miin7op2ky_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e7miin7op2ky_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e7miin7op2ky_API, "mod_e7miin7op2ky._C_API", NULL);
