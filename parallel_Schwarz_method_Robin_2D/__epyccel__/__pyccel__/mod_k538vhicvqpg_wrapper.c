...
#define MOD_K538VHICVQPG_WRAPPER

#include "mod_k538vhicvqpg_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_k538vhicvqpg_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_k538vhicvqpg_module = {
    ...
    0,
    mod_k538vhicvqpg_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k538vhicvqpg(void)
{
    PyObject* mod;
    static void* Pymod_k538vhicvqpg_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k538vhicvqpg_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k538vhicvqpg_API, "mod_k538vhicvqpg._C_API", NULL);
