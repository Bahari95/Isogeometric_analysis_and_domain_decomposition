...
#define MOD_ZLKS2NWEBLMT_WRAPPER

#include "mod_zlks2nweblmt_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_zlks2nweblmt_methods[] = {
    {
...
static struct PyModuleDef mod_zlks2nweblmt_module = {
    ...
    0,
    mod_zlks2nweblmt_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_zlks2nweblmt(void)
{
    PyObject* mod;
    static void* Pymod_zlks2nweblmt_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_zlks2nweblmt_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_zlks2nweblmt_API, "mod_zlks2nweblmt._C_API", NULL);
