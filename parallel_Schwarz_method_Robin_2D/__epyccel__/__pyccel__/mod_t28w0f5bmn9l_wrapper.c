...
#define MOD_T28W0F5BMN9L_WRAPPER

#include "mod_t28w0f5bmn9l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_t28w0f5bmn9l_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_t28w0f5bmn9l_module = {
    ...
    0,
    mod_t28w0f5bmn9l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_t28w0f5bmn9l(void)
{
    PyObject* mod;
    static void* Pymod_t28w0f5bmn9l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_t28w0f5bmn9l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_t28w0f5bmn9l_API, "mod_t28w0f5bmn9l._C_API", NULL);
