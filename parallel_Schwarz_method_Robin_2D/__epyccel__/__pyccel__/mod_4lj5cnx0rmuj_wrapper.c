...
#define MOD_4LJ5CNX0RMUJ_WRAPPER

#include "mod_4lj5cnx0rmuj_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4lj5cnx0rmuj_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_4lj5cnx0rmuj_module = {
    ...
    0,
    mod_4lj5cnx0rmuj_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4lj5cnx0rmuj(void)
{
    PyObject* mod;
    static void* Pymod_4lj5cnx0rmuj_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4lj5cnx0rmuj_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4lj5cnx0rmuj_API, "mod_4lj5cnx0rmuj._C_API", NULL);
