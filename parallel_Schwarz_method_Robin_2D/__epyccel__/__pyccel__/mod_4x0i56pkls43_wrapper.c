...
#define MOD_4X0I56PKLS43_WRAPPER

#include "mod_4x0i56pkls43_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_4x0i56pkls43_methods[] = {
    {
...
static struct PyModuleDef mod_4x0i56pkls43_module = {
    ...
    0,
    mod_4x0i56pkls43_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_4x0i56pkls43(void)
{
    PyObject* mod;
    static void* Pymod_4x0i56pkls43_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_4x0i56pkls43_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_4x0i56pkls43_API, "mod_4x0i56pkls43._C_API", NULL);
