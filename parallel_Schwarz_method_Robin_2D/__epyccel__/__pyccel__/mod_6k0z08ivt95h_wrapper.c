...
#define MOD_6K0Z08IVT95H_WRAPPER

#include "mod_6k0z08ivt95h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6k0z08ivt95h_methods[] = {
    {
...
static struct PyModuleDef mod_6k0z08ivt95h_module = {
    ...
    0,
    mod_6k0z08ivt95h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6k0z08ivt95h(void)
{
    PyObject* mod;
    static void* Pymod_6k0z08ivt95h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6k0z08ivt95h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6k0z08ivt95h_API, "mod_6k0z08ivt95h._C_API", NULL);
