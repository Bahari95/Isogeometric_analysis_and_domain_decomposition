...
#define MOD_5EEGNNW9SRGG_WRAPPER

#include "mod_5eegnnw9srgg_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_5eegnnw9srgg_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_5eegnnw9srgg_module = {
    ...
    0,
    mod_5eegnnw9srgg_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_5eegnnw9srgg(void)
{
    PyObject* mod;
    static void* Pymod_5eegnnw9srgg_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_5eegnnw9srgg_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_5eegnnw9srgg_API, "mod_5eegnnw9srgg._C_API", NULL);
