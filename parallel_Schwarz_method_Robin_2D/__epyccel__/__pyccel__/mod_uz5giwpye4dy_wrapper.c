...
#define MOD_UZ5GIWPYE4DY_WRAPPER

#include "mod_uz5giwpye4dy_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_uz5giwpye4dy_methods[] = {
    {
...
static struct PyModuleDef mod_uz5giwpye4dy_module = {
    ...
    0,
    mod_uz5giwpye4dy_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uz5giwpye4dy(void)
{
    PyObject* mod;
    static void* Pymod_uz5giwpye4dy_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_uz5giwpye4dy_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_uz5giwpye4dy_API, "mod_uz5giwpye4dy._C_API", NULL);
