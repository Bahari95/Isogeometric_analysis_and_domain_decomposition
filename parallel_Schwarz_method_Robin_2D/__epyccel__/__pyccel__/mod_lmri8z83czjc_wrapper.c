...
#define MOD_LMRI8Z83CZJC_WRAPPER

#include "mod_lmri8z83czjc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_lmri8z83czjc_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_lmri8z83czjc_module = {
    ...
    0,
    mod_lmri8z83czjc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_lmri8z83czjc(void)
{
    PyObject* mod;
    static void* Pymod_lmri8z83czjc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_lmri8z83czjc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_lmri8z83czjc_API, "mod_lmri8z83czjc._C_API", NULL);
