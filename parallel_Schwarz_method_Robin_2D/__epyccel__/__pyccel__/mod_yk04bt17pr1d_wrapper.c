...
#define MOD_YK04BT17PR1D_WRAPPER

#include "mod_yk04bt17pr1d_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yk04bt17pr1d_methods[] = {
    {
...
static struct PyModuleDef mod_yk04bt17pr1d_module = {
    ...
    0,
    mod_yk04bt17pr1d_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yk04bt17pr1d(void)
{
    PyObject* mod;
    static void* Pymod_yk04bt17pr1d_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yk04bt17pr1d_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yk04bt17pr1d_API, "mod_yk04bt17pr1d._C_API", NULL);
