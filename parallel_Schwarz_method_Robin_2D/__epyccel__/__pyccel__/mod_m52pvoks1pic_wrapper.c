...
#define MOD_M52PVOKS1PIC_WRAPPER

#include "mod_m52pvoks1pic_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_m52pvoks1pic_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_m52pvoks1pic_module = {
    ...
    0,
    mod_m52pvoks1pic_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_m52pvoks1pic(void)
{
    PyObject* mod;
    static void* Pymod_m52pvoks1pic_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_m52pvoks1pic_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_m52pvoks1pic_API, "mod_m52pvoks1pic._C_API", NULL);
