...
#define MOD_E9IUHXFPVBQ1_WRAPPER

#include "mod_e9iuhxfpvbq1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_e9iuhxfpvbq1_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_e9iuhxfpvbq1_module = {
    ...
    0,
    mod_e9iuhxfpvbq1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_e9iuhxfpvbq1(void)
{
    PyObject* mod;
    static void* Pymod_e9iuhxfpvbq1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_e9iuhxfpvbq1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_e9iuhxfpvbq1_API, "mod_e9iuhxfpvbq1._C_API", NULL);
