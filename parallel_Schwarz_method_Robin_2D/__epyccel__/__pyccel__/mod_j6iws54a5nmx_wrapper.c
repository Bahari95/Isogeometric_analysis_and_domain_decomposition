...
#define MOD_J6IWS54A5NMX_WRAPPER

#include "mod_j6iws54a5nmx_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_j6iws54a5nmx_methods[] = {
    {
...
static struct PyModuleDef mod_j6iws54a5nmx_module = {
    ...
    0,
    mod_j6iws54a5nmx_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_j6iws54a5nmx(void)
{
    PyObject* mod;
    static void* Pymod_j6iws54a5nmx_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_j6iws54a5nmx_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_j6iws54a5nmx_API, "mod_j6iws54a5nmx._C_API", NULL);
