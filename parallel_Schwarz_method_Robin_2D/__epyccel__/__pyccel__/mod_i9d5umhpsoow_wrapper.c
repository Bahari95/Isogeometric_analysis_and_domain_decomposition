...
#define MOD_I9D5UMHPSOOW_WRAPPER

#include "mod_i9d5umhpsoow_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i9d5umhpsoow_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i9d5umhpsoow_module = {
    ...
    0,
    mod_i9d5umhpsoow_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i9d5umhpsoow(void)
{
    PyObject* mod;
    static void* Pymod_i9d5umhpsoow_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i9d5umhpsoow_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i9d5umhpsoow_API, "mod_i9d5umhpsoow._C_API", NULL);
