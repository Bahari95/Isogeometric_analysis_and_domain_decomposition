...
#define MOD_HP56AH8N822G_WRAPPER

#include "mod_hp56ah8n822g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hp56ah8n822g_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hp56ah8n822g_module = {
    ...
    0,
    mod_hp56ah8n822g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hp56ah8n822g(void)
{
    PyObject* mod;
    static void* Pymod_hp56ah8n822g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hp56ah8n822g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hp56ah8n822g_API, "mod_hp56ah8n822g._C_API", NULL);
