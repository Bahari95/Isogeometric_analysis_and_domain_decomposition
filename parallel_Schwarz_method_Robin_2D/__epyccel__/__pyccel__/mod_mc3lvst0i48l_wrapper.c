...
#define MOD_MC3LVST0I48L_WRAPPER

#include "mod_mc3lvst0i48l_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_mc3lvst0i48l_methods[] = {
    {
...
static struct PyModuleDef mod_mc3lvst0i48l_module = {
    ...
    0,
    mod_mc3lvst0i48l_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mc3lvst0i48l(void)
{
    PyObject* mod;
    static void* Pymod_mc3lvst0i48l_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_mc3lvst0i48l_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_mc3lvst0i48l_API, "mod_mc3lvst0i48l._C_API", NULL);
