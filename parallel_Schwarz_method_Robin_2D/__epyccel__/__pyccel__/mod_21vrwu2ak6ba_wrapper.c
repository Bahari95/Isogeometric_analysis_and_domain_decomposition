...
#define MOD_21VRWU2AK6BA_WRAPPER

#include "mod_21vrwu2ak6ba_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_21vrwu2ak6ba_methods[] = {
    {
...
static struct PyModuleDef mod_21vrwu2ak6ba_module = {
    ...
    0,
    mod_21vrwu2ak6ba_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_21vrwu2ak6ba(void)
{
    PyObject* mod;
    static void* Pymod_21vrwu2ak6ba_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_21vrwu2ak6ba_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_21vrwu2ak6ba_API, "mod_21vrwu2ak6ba._C_API", NULL);
