...
#define MOD_KJ3QILBEBDPQ_WRAPPER

#include "mod_kj3qilbebdpq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kj3qilbebdpq_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_kj3qilbebdpq_module = {
    ...
    0,
    mod_kj3qilbebdpq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kj3qilbebdpq(void)
{
    PyObject* mod;
    static void* Pymod_kj3qilbebdpq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kj3qilbebdpq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kj3qilbebdpq_API, "mod_kj3qilbebdpq._C_API", NULL);
