...
#define MOD_NTDKWJANIRT7_WRAPPER

#include "mod_ntdkwjanirt7_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ntdkwjanirt7_methods[] = {
    {
...
static struct PyModuleDef mod_ntdkwjanirt7_module = {
    ...
    0,
    mod_ntdkwjanirt7_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ntdkwjanirt7(void)
{
    PyObject* mod;
    static void* Pymod_ntdkwjanirt7_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ntdkwjanirt7_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ntdkwjanirt7_API, "mod_ntdkwjanirt7._C_API", NULL);
