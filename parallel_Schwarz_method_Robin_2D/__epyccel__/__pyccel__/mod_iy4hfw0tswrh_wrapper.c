...
#define MOD_IY4HFW0TSWRH_WRAPPER

#include "mod_iy4hfw0tswrh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_iy4hfw0tswrh_methods[] = {
    {
...
static struct PyModuleDef mod_iy4hfw0tswrh_module = {
    ...
    0,
    mod_iy4hfw0tswrh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_iy4hfw0tswrh(void)
{
    PyObject* mod;
    static void* Pymod_iy4hfw0tswrh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_iy4hfw0tswrh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_iy4hfw0tswrh_API, "mod_iy4hfw0tswrh._C_API", NULL);
