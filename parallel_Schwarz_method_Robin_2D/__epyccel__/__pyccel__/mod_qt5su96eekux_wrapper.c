...
#define MOD_QT5SU96EEKUX_WRAPPER

#include "mod_qt5su96eekux_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_qt5su96eekux_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_qt5su96eekux_module = {
    ...
    0,
    mod_qt5su96eekux_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qt5su96eekux(void)
{
    PyObject* mod;
    static void* Pymod_qt5su96eekux_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_qt5su96eekux_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_qt5su96eekux_API, "mod_qt5su96eekux._C_API", NULL);
