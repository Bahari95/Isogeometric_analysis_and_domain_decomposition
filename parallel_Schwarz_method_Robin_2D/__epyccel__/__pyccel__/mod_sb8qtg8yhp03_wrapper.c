...
#define MOD_SB8QTG8YHP03_WRAPPER

#include "mod_sb8qtg8yhp03_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_sb8qtg8yhp03_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_sb8qtg8yhp03_module = {
    ...
    0,
    mod_sb8qtg8yhp03_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sb8qtg8yhp03(void)
{
    PyObject* mod;
    static void* Pymod_sb8qtg8yhp03_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_sb8qtg8yhp03_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_sb8qtg8yhp03_API, "mod_sb8qtg8yhp03._C_API", NULL);
