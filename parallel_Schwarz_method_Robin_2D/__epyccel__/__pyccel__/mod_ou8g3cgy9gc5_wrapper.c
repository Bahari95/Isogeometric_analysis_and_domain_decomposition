...
#define MOD_OU8G3CGY9GC5_WRAPPER

#include "mod_ou8g3cgy9gc5_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ou8g3cgy9gc5_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_ou8g3cgy9gc5_module = {
    ...
    0,
    mod_ou8g3cgy9gc5_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ou8g3cgy9gc5(void)
{
    PyObject* mod;
    static void* Pymod_ou8g3cgy9gc5_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ou8g3cgy9gc5_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ou8g3cgy9gc5_API, "mod_ou8g3cgy9gc5._C_API", NULL);
