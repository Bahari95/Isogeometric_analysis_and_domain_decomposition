...
#define MOD_938F4XHZBLR1_WRAPPER

#include "mod_938f4xhzblr1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_938f4xhzblr1_methods[] = {
    {
...
static struct PyModuleDef mod_938f4xhzblr1_module = {
    ...
    0,
    mod_938f4xhzblr1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_938f4xhzblr1(void)
{
    PyObject* mod;
    static void* Pymod_938f4xhzblr1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_938f4xhzblr1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_938f4xhzblr1_API, "mod_938f4xhzblr1._C_API", NULL);
