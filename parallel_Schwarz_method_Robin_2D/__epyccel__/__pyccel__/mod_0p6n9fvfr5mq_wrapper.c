...
#define MOD_0P6N9FVFR5MQ_WRAPPER

#include "mod_0p6n9fvfr5mq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0p6n9fvfr5mq_methods[] = {
    {
...
static struct PyModuleDef mod_0p6n9fvfr5mq_module = {
    ...
    0,
    mod_0p6n9fvfr5mq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0p6n9fvfr5mq(void)
{
    PyObject* mod;
    static void* Pymod_0p6n9fvfr5mq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0p6n9fvfr5mq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0p6n9fvfr5mq_API, "mod_0p6n9fvfr5mq._C_API", NULL);
