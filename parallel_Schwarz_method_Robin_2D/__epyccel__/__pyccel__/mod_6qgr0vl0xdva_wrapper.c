...
#define MOD_6QGR0VL0XDVA_WRAPPER

#include "mod_6qgr0vl0xdva_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6qgr0vl0xdva_methods[] = {
    {
...
static struct PyModuleDef mod_6qgr0vl0xdva_module = {
    ...
    0,
    mod_6qgr0vl0xdva_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6qgr0vl0xdva(void)
{
    PyObject* mod;
    static void* Pymod_6qgr0vl0xdva_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6qgr0vl0xdva_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6qgr0vl0xdva_API, "mod_6qgr0vl0xdva._C_API", NULL);
