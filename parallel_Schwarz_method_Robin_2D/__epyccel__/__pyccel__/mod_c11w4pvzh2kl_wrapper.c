...
#define MOD_C11W4PVZH2KL_WRAPPER

#include "mod_c11w4pvzh2kl_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_c11w4pvzh2kl_methods[] = {
    {
...
static struct PyModuleDef mod_c11w4pvzh2kl_module = {
    ...
    0,
    mod_c11w4pvzh2kl_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_c11w4pvzh2kl(void)
{
    PyObject* mod;
    static void* Pymod_c11w4pvzh2kl_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_c11w4pvzh2kl_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_c11w4pvzh2kl_API, "mod_c11w4pvzh2kl._C_API", NULL);
