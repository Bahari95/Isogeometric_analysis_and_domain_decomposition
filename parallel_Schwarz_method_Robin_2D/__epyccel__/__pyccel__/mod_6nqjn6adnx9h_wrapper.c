...
#define MOD_6NQJN6ADNX9H_WRAPPER

#include "mod_6nqjn6adnx9h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6nqjn6adnx9h_methods[] = {
    {
...
static struct PyModuleDef mod_6nqjn6adnx9h_module = {
    ...
    0,
    mod_6nqjn6adnx9h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6nqjn6adnx9h(void)
{
    PyObject* mod;
    static void* Pymod_6nqjn6adnx9h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6nqjn6adnx9h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6nqjn6adnx9h_API, "mod_6nqjn6adnx9h._C_API", NULL);
