module bind_c_mod_tqynej8225mc

  use mod_tqynej8225mc
  ...
  subroutine bind_c_assemble_matrix_un_ex01(ne1, ne2, p1, p2, &
        ...
        bound_points_1_stride_1, bound_points_1_stride_2, points_2, &
        domain_nb, S_DDM, bound_ovlp_value, bound_ovlp_value_shape_1, &
        bound_ovlp_value_shape_2, bound_ovlp_value_stride_1, &
        bound_ovlp_value_stride_2, bound_vector_m1, &
        bound_vector_m1_shape_1, bound_vector_m1_shape_2, &
        bound_vector_m1_stride_1, bound_vector_m1_stride_2, &
        bound_vector_m2, bound_vector_m2_shape_1, &
        bound_vector_m2_shape_2, bound_vector_m2_stride_1, &
        bound_vector_m2_stride_2, bound_matrix, bound_matrix_shape_1, &
        bound_matrix_shape_2, bound_matrix_shape_3, &
        bound_matrix_shape_4, bound_matrix_stride_1, &
        bound_matrix_stride_2, bound_matrix_stride_3, &
        bound_matrix_stride_4) bind(c)
    ...
    integer(i64), value :: points_2
    real(f64), value :: domain_nb
    real(f64), value :: S_DDM
    type(c_ptr), value :: bound_ovlp_value
    integer(i64), value :: bound_ovlp_value_shape_1
    integer(i64), value :: bound_ovlp_value_shape_2
    integer(i64), value :: bound_ovlp_value_stride_1
    integer(i64), value :: bound_ovlp_value_stride_2
    ...
    call C_F_Pointer(bound_ovlp_value, ovlp_value, [ &
          bound_ovlp_value_shape_2 * bound_ovlp_value_stride_2, &
          bound_ovlp_value_shape_1 * bound_ovlp_value_stride_1])
    ...
    call assemble_matrix_un_ex01(ne1 = ne1, ne2 = ne2, p1 = p1, p2 = p2, &
          ...
          points_2 = points_2, domain_nb = domain_nb, S_DDM = S_DDM, &
          ovlp_value = ovlp_value(1_i64::bound_ovlp_value_stride_2, &
          1_i64::bound_ovlp_value_stride_1), vector_m1 = vector_m1( &
          1_i64::bound_vector_m1_stride_2, 1_i64:: &
          bound_vector_m1_stride_1), vector_m2 = vector_m2(1_i64:: &
          bound_vector_m2_stride_2, 1_i64::bound_vector_m2_stride_1), &
          matrix = matrix(1_i64::bound_matrix_stride_4, 1_i64:: &
          bound_matrix_stride_3, 1_i64::bound_matrix_stride_2, 1_i64:: &
          bound_matrix_stride_1))

  end subroutine bind_c_assemble_matrix_un_ex01
  !........................................

end module bind_c_mod_tqynej8225mc
