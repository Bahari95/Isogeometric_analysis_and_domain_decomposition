...
#define MOD_56YHGYNZUOFZ_WRAPPER

#include "mod_56yhgynzuofz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_56yhgynzuofz_methods[] = {
    {
...
static struct PyModuleDef mod_56yhgynzuofz_module = {
    ...
    0,
    mod_56yhgynzuofz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_56yhgynzuofz(void)
{
    PyObject* mod;
    static void* Pymod_56yhgynzuofz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_56yhgynzuofz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_56yhgynzuofz_API, "mod_56yhgynzuofz._C_API", NULL);
