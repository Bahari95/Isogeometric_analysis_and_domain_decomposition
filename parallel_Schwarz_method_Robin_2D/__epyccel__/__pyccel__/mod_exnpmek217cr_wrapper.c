...
#define MOD_EXNPMEK217CR_WRAPPER

#include "mod_exnpmek217cr_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_exnpmek217cr_methods[] = {
    {
...
static struct PyModuleDef mod_exnpmek217cr_module = {
    ...
    0,
    mod_exnpmek217cr_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_exnpmek217cr(void)
{
    PyObject* mod;
    static void* Pymod_exnpmek217cr_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_exnpmek217cr_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_exnpmek217cr_API, "mod_exnpmek217cr._C_API", NULL);
