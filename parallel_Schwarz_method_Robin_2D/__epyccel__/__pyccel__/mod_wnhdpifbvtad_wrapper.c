...
#define MOD_WNHDPIFBVTAD_WRAPPER

#include "mod_wnhdpifbvtad_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wnhdpifbvtad_methods[] = {
    {
...
static struct PyModuleDef mod_wnhdpifbvtad_module = {
    ...
    0,
    mod_wnhdpifbvtad_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wnhdpifbvtad(void)
{
    PyObject* mod;
    static void* Pymod_wnhdpifbvtad_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wnhdpifbvtad_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wnhdpifbvtad_API, "mod_wnhdpifbvtad._C_API", NULL);
