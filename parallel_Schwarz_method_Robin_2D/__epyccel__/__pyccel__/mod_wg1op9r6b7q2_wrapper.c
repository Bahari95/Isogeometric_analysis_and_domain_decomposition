...
#define MOD_WG1OP9R6B7Q2_WRAPPER

#include "mod_wg1op9r6b7q2_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_wg1op9r6b7q2_methods[] = {
    {
...
static struct PyModuleDef mod_wg1op9r6b7q2_module = {
    ...
    0,
    mod_wg1op9r6b7q2_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_wg1op9r6b7q2(void)
{
    PyObject* mod;
    static void* Pymod_wg1op9r6b7q2_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_wg1op9r6b7q2_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_wg1op9r6b7q2_API, "mod_wg1op9r6b7q2._C_API", NULL);
