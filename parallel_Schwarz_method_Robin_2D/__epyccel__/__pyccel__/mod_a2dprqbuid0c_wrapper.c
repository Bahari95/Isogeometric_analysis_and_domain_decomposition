...
#define MOD_A2DPRQBUID0C_WRAPPER

#include "mod_a2dprqbuid0c_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_a2dprqbuid0c_methods[] = {
    {
...
static struct PyModuleDef mod_a2dprqbuid0c_module = {
    ...
    0,
    mod_a2dprqbuid0c_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_a2dprqbuid0c(void)
{
    PyObject* mod;
    static void* Pymod_a2dprqbuid0c_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_a2dprqbuid0c_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_a2dprqbuid0c_API, "mod_a2dprqbuid0c._C_API", NULL);
