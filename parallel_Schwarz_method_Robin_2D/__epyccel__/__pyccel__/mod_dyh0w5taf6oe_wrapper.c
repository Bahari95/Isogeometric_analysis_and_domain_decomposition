...
#define MOD_DYH0W5TAF6OE_WRAPPER

#include "mod_dyh0w5taf6oe_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dyh0w5taf6oe_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_dyh0w5taf6oe_module = {
    ...
    0,
    mod_dyh0w5taf6oe_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dyh0w5taf6oe(void)
{
    PyObject* mod;
    static void* Pymod_dyh0w5taf6oe_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dyh0w5taf6oe_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dyh0w5taf6oe_API, "mod_dyh0w5taf6oe._C_API", NULL);
