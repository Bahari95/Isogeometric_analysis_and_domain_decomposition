...
#define MOD_9PA5M6RCFN81_WRAPPER

#include "mod_9pa5m6rcfn81_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9pa5m6rcfn81_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9pa5m6rcfn81_module = {
    ...
    0,
    mod_9pa5m6rcfn81_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9pa5m6rcfn81(void)
{
    PyObject* mod;
    static void* Pymod_9pa5m6rcfn81_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9pa5m6rcfn81_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9pa5m6rcfn81_API, "mod_9pa5m6rcfn81._C_API", NULL);
