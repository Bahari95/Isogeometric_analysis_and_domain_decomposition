...
#define MOD_3QJGWMHLPCJZ_WRAPPER

#include "mod_3qjgwmhlpcjz_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_3qjgwmhlpcjz_methods[] = {
    {
...
static struct PyModuleDef mod_3qjgwmhlpcjz_module = {
    ...
    0,
    mod_3qjgwmhlpcjz_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3qjgwmhlpcjz(void)
{
    PyObject* mod;
    static void* Pymod_3qjgwmhlpcjz_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_3qjgwmhlpcjz_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_3qjgwmhlpcjz_API, "mod_3qjgwmhlpcjz._C_API", NULL);
