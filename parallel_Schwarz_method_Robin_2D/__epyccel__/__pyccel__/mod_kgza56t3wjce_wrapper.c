...
#define MOD_KGZA56T3WJCE_WRAPPER

#include "mod_kgza56t3wjce_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_kgza56t3wjce_methods[] = {
    {
...
static struct PyModuleDef mod_kgza56t3wjce_module = {
    ...
    0,
    mod_kgza56t3wjce_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kgza56t3wjce(void)
{
    PyObject* mod;
    static void* Pymod_kgza56t3wjce_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kgza56t3wjce_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kgza56t3wjce_API, "mod_kgza56t3wjce._C_API", NULL);
