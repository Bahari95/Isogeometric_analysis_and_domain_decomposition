...
#define MOD_VMIEIXU33DPQ_WRAPPER

#include "mod_vmieixu33dpq_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_vmieixu33dpq_methods[] = {
    {
...
static struct PyModuleDef mod_vmieixu33dpq_module = {
    ...
    0,
    mod_vmieixu33dpq_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vmieixu33dpq(void)
{
    PyObject* mod;
    static void* Pymod_vmieixu33dpq_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_vmieixu33dpq_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_vmieixu33dpq_API, "mod_vmieixu33dpq._C_API", NULL);
