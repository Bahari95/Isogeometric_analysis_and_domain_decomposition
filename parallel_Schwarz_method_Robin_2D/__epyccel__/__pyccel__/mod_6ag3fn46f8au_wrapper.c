...
#define MOD_6AG3FN46F8AU_WRAPPER

#include "mod_6ag3fn46f8au_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6ag3fn46f8au_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_6ag3fn46f8au_module = {
    ...
    0,
    mod_6ag3fn46f8au_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6ag3fn46f8au(void)
{
    PyObject* mod;
    static void* Pymod_6ag3fn46f8au_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6ag3fn46f8au_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6ag3fn46f8au_API, "mod_6ag3fn46f8au._C_API", NULL);
