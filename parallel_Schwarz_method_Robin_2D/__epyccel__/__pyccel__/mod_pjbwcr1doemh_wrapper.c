...
#define MOD_PJBWCR1DOEMH_WRAPPER

#include "mod_pjbwcr1doemh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pjbwcr1doemh_methods[] = {
    {
...
static struct PyModuleDef mod_pjbwcr1doemh_module = {
    ...
    0,
    mod_pjbwcr1doemh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pjbwcr1doemh(void)
{
    PyObject* mod;
    static void* Pymod_pjbwcr1doemh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pjbwcr1doemh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pjbwcr1doemh_API, "mod_pjbwcr1doemh._C_API", NULL);
