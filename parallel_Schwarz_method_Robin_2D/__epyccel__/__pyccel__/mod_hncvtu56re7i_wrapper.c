...
#define MOD_HNCVTU56RE7I_WRAPPER

#include "mod_hncvtu56re7i_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hncvtu56re7i_methods[] = {
    {
...
static struct PyModuleDef mod_hncvtu56re7i_module = {
    ...
    0,
    mod_hncvtu56re7i_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hncvtu56re7i(void)
{
    PyObject* mod;
    static void* Pymod_hncvtu56re7i_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hncvtu56re7i_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hncvtu56re7i_API, "mod_hncvtu56re7i._C_API", NULL);
