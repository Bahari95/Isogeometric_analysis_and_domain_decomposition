...
#define MOD_TO3FHZEKZRDW_WRAPPER

#include "mod_to3fhzekzrdw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_to3fhzekzrdw_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_to3fhzekzrdw_module = {
    ...
    0,
    mod_to3fhzekzrdw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_to3fhzekzrdw(void)
{
    PyObject* mod;
    static void* Pymod_to3fhzekzrdw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_to3fhzekzrdw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_to3fhzekzrdw_API, "mod_to3fhzekzrdw._C_API", NULL);
