...
#define MOD_AF75C8B391DV_WRAPPER

#include "mod_af75c8b391dv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_af75c8b391dv_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_af75c8b391dv_module = {
    ...
    0,
    mod_af75c8b391dv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_af75c8b391dv(void)
{
    PyObject* mod;
    static void* Pymod_af75c8b391dv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_af75c8b391dv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_af75c8b391dv_API, "mod_af75c8b391dv._C_API", NULL);
