...
#define MOD_O9N9SI974PX3_WRAPPER

#include "mod_o9n9si974px3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_o9n9si974px3_methods[] = {
    {
...
static struct PyModuleDef mod_o9n9si974px3_module = {
    ...
    0,
    mod_o9n9si974px3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_o9n9si974px3(void)
{
    PyObject* mod;
    static void* Pymod_o9n9si974px3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_o9n9si974px3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_o9n9si974px3_API, "mod_o9n9si974px3._C_API", NULL);
