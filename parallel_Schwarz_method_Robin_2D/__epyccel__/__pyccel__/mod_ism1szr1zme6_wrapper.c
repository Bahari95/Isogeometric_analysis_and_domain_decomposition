...
#define MOD_ISM1SZR1ZME6_WRAPPER

#include "mod_ism1szr1zme6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ism1szr1zme6_methods[] = {
    {
...
static struct PyModuleDef mod_ism1szr1zme6_module = {
    ...
    0,
    mod_ism1szr1zme6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ism1szr1zme6(void)
{
    PyObject* mod;
    static void* Pymod_ism1szr1zme6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ism1szr1zme6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ism1szr1zme6_API, "mod_ism1szr1zme6._C_API", NULL);
