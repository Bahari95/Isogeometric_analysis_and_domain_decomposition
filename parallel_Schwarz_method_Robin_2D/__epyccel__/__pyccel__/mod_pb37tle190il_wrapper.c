...
#define MOD_PB37TLE190IL_WRAPPER

#include "mod_pb37tle190il_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pb37tle190il_methods[] = {
    {
...
static struct PyModuleDef mod_pb37tle190il_module = {
    ...
    0,
    mod_pb37tle190il_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pb37tle190il(void)
{
    PyObject* mod;
    static void* Pymod_pb37tle190il_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pb37tle190il_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pb37tle190il_API, "mod_pb37tle190il._C_API", NULL);
