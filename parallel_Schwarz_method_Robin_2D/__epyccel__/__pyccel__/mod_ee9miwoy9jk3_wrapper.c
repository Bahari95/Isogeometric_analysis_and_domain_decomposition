...
#define MOD_EE9MIWOY9JK3_WRAPPER

#include "mod_ee9miwoy9jk3_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ee9miwoy9jk3_methods[] = {
    {
...
static struct PyModuleDef mod_ee9miwoy9jk3_module = {
    ...
    0,
    mod_ee9miwoy9jk3_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ee9miwoy9jk3(void)
{
    PyObject* mod;
    static void* Pymod_ee9miwoy9jk3_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ee9miwoy9jk3_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ee9miwoy9jk3_API, "mod_ee9miwoy9jk3._C_API", NULL);
