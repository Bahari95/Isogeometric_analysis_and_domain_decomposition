...
#define MOD_TQYNEJ8225MC_WRAPPER

#include "mod_tqynej8225mc_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_tqynej8225mc_methods[] = {
    {
...
static struct PyModuleDef mod_tqynej8225mc_module = {
    ...
    0,
    mod_tqynej8225mc_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tqynej8225mc(void)
{
    PyObject* mod;
    static void* Pymod_tqynej8225mc_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_tqynej8225mc_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_tqynej8225mc_API, "mod_tqynej8225mc._C_API", NULL);
