...
#define MOD_FQZGFLD91JK7_WRAPPER

#include "mod_fqzgfld91jk7_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_fqzgfld91jk7_methods[] = {
    {
...
static struct PyModuleDef mod_fqzgfld91jk7_module = {
    ...
    0,
    mod_fqzgfld91jk7_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_fqzgfld91jk7(void)
{
    PyObject* mod;
    static void* Pymod_fqzgfld91jk7_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_fqzgfld91jk7_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_fqzgfld91jk7_API, "mod_fqzgfld91jk7._C_API", NULL);
