        ...
        for ie3 in range(0, ne3):
            ...
            for g1 in range(0, k1):
                for g3 in range(0, k3):
                    ...
                    f    = -pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*x)**2*sin(pi*(y - 0.5)) 
                    f   += 6.0*pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*x)*sin(pi*(3.0 - 3.0*x))*sin(pi*(y - 0.5)) 
                    f   += -9.0*pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*(3.0 - 3.0*x))**2*sin(pi*(y - 0.5)) 
                    f   += pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*(y - 0.5))*cos(pi*x) 
                    f   += 9.0*pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*(y - 0.5))*cos(pi*(3.0 - 3.0*x)) 
                    f   += pi**2*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*(y - 0.5))
                    lvalues_u[g1,g3] = f
        ...
        for ie2 in range(0, ne2):
            ...
            for g1 in range(0, k1):
                for g2 in range(0, k2):
                    ...
                    # ... test 0
                    u   = sin(pi*(y-0.5))*exp(cos(pi*x))*exp(cos(3.*pi*(1.-x)))
                    ux  = -pi*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*x)*sin(pi*(y - 0.5)) + 3.0*pi*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*sin(pi*(3.0 - 3.0*x))*sin(pi*(y - 0.5))
                    uy  = pi*exp(cos(pi*x))*exp(cos(pi*(3.0 - 3.0*x)))*cos(pi*(y - 0.5))
